                        ...
                        <a href="{{ route('service-detail', $otherService->slug) }}" class="block group">
                            <div class="bg-white transition-all duration-300 overflow-hidden">
                                <div class="h-50 overflow-hidden rounded-[16px]">
                                    @php
                                    $imgSrc = $otherService->image
                                    ? (Str::startsWith($otherService->image, 'frontend/') ? asset($otherService->image) : asset('storage/' . $otherService->image))
                                    : asset('frontend/assets/ayurveda-and-panchakarma.png');
                                    @endphp
                                    <img src="{{ $imgSrc }}"
                                ...
                                <div class="pt-5">
                                    ...
                                    <p class="text-gray-500 text-sm leading-relaxed line-clamp-2">
                                        {!! strip_tags($otherService->description) !!}
                                    </p>
                                </div>
                            </div>
                        </a>
