...
@section('content')
  ...
  <div class="container-fluid p-0 overflow-hidden">
    <!-- Leaves Images -->
    <img src="{{ asset('admiro/assets/images/admin-t-r.png') }}" alt="logo" class="img-fluid admin-top-right-img">
    <img src="{{ asset('admiro/assets/images/admin-t-l.png') }}" alt="logo" class="img-fluid admin-top-left-img">
    <img src="{{ asset('admiro/assets/images/admin-b-l.png') }}" alt="logo" class="img-fluid admin-bottom-left-img">
    <img src="{{ asset('admiro/assets/images/admin-b-r.png') }}" alt="logo" class="img-fluid admin-bottom-right-img">
    <!-- Smile image -->
    <img src="{{ asset('admiro/assets/images/zaya-smile-vector.png') }}" alt="logo" class="img-fluid admin-smile-img">
    ...
    <div class="row m-0">
      <div class="col-12 p-0">
        <div class="login-card position-relative z-3">
          <div class="w-100">
            <div class="text-center"><a class="logo" href="{{ route('home') }}"><img
                  class="img-fluid for-dark d-block m-auto"
                  src="{{ asset('admiro/assets/images/logo/zaya-logo-admin.svg') }}" alt="logo"
              ...
              <form class="theme-form" method="POST" action="{{ route('admin.login.submit') }}">
                ...
                <div class="form-group">
                  ...
                  <input class="form-control @error('email') is-invalid @enderror" type="email" name="email"
                    value="{{ old('email') }}" required autocomplete="email" autofocus placeholder="Test@gmail.com">
                  @error('email')
