...
@section('content')
        ...
        <div
            ...
            <div class="relative z-20 text-center px-4 sm:px-16 py-4 max-w-3xl mx-auto animate-on-scroll">
                ...
                <a id="hero_button_text" href="{{ route('about-us') }}"
                    class="bg-white text-primary px-6 py-3 rounded-full text-base md:text-lg font-medium border border-white hover:bg-primary hover:text-white transition-all shadow-lg hover:shadow-xl">{{ $settings['hero_button_text'] ?? 'Discover Our Story' }}</a>
            </div>
        </div>
    </section>
    ...
    <section id="practitioners" class="pt-10 pb-15">
        <div class="container-fluid mx-auto relative mb-16 px-4">
            ...
            <div class="text-center max-w-4xl mx-auto animate-on-scroll">
                ...
                <div class="mb-20">
                    <a id="practitioners_browse_btn" href="{{ route('find-practitioner') }}"
                        ...
                        <div class="swiper-slide h-auto">
                            <div class="group relative">
                                ...
                                <div class="text-center">
                                    <h3 class="text-xl md:text-2xl font-sans! font-medium text-primary mb-3 leading-none">
                                        <a href="{{ route('practitioner-detail', $details->id) }}"
    ...
    <section class="pb-20 md:pb-28 bg-white text-center relative">
        <img src="{{ asset('frontend/assets/green-monstera-leaf.png') }}" alt="Leaf"
        ...
        <div class="container mx-auto px-4 max-w-4xl">
            <h2 id="cta_title"
                ...
                {{ $settings['cta_title'] ?? "Are you a Wellness Practitioner?" }}
            </h2>
            ...
            <div
                ...
                <div class="z-10 animate-on-scroll p-10 lg:p-16 pb-0!">
                    ...
                    <h3 id="blog_title" class="text-xl md:text-2xl lg:text-3xl font-serif text-secondary mb-12">
                        {{ $settings['blog_title'] ?? 'Wisdom Journal' }}
                    </h3>
                    <a id="blog_button_text" href="{{ route('blogs') }}"
                        class="border border-secondary text-secondary px-8 py-3 rounded-full hover:bg-secondary hover:text-white transition-all text-base lg:text-lg">{{ $settings['blog_button_text'] ?? 'Explore Journal' }}</a>
                </div>
                <!-- Plant Image (Bottom) -->
    ...
    <section class="py-20 md:pt-28 md:pb-18 bg-white text-center relative overflow-hidden">
        ...
        <div class="container mx-auto px-6 max-w-4xl relative z-10">
            <h2 id="testimonials_title"
                class="text-3xl md:text-4xl lg:text-5xl font-serif font-bold text-primary mb-6 animate-on-scroll">
                {{ $settings['testimonials_title'] ?? 'Real Stories, Real Experiences' }}
            </h2>
