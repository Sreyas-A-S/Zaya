...
<div class="min-h-[85vh] flex items-center justify-center px-6 bg-[#FDFDFD] relative overflow-hidden">
    ...
    <div class="text-center max-w-2xl relative z-10 mt-12">
        ...
        <div class="mb-6">
            <span class="text-sm font-bold uppercase tracking-[0.3em] text-secondary/40 mb-2 block">System Alert</span>
            <h1 class="text-4xl md:text-5xl font-bold text-secondary mb-6 font-sans! leading-tight">
                Our wellness path is <br><span class="italic font-normal">temporarily paused.</span>
            </h1>
            <p class="text-gray-500 text-lg mb-12 max-w-md mx-auto leading-relaxed">
                We're currently experiencing an unexpected interruption. Our team is already working to restore your experience.
            </p>
        </div>
