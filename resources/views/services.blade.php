...
@else
    ...
    <!-- Specialities Grid Section (From Gallery Branch) -->
                ...
                <form id="filters-form" class="flex flex-col md:flex-row gap-6">
                    ...
                    <div class="flex-1 relative" id="category-dropdown">
                        <button type="button" onclick="toggleDropdown()"
                            ...
                            <i class="ri-arrow-down-s-line text-2xl transition-transform duration-300" id="dropdown-arrow"></i>
                        </button>
                        <input type="hidden" name="category" id="category-input" value="{{ request('category') }}">

                        <!-- Dropdown Menu -->
                        <div id="dropdown-menu" class="absolute top-full left-0 w-full mt-2 bg-white rounded-[2rem] shadow-xl border border-[#efe6e1] overflow-hidden opacity-0 invisible transform -translate-y-2 transition-all duration-300 z-50">
                            <div class="px-2 py-2 my-2 flex flex-col gap-1 max-h-[300px] overflow-y-auto">
                                <a href="javascript:void(0)" onclick="applyCategoryFilter('', 'All Services')" class="block px-6 py-3 text-[#5A3E31] hover:bg-[#FFFBF5] rounded-xl transition-colors text-base font-medium">{{ __('All Services') }}</a>
                                <a href="javascript:void(0)" onclick="applyCategoryFilter('Ayurveda', 'Ayurveda')" class="block px-6 py-3 text-[#5A3E31] hover:bg-[#FFFBF5] rounded-xl transition-colors text-base font-medium">{{ __('Ayurveda') }}</a>
                                <a href="javascript:void(0)" onclick="applyCategoryFilter('Yoga', 'Yoga')" class="block px-6 py-3 text-[#5A3E31] hover:bg-[#FFFBF5] rounded-xl transition-colors text-base font-medium">{{ __('Yoga') }}</a>
                                <a href="javascript:void(0)" onclick="applyCategoryFilter('Counselling', 'Counselling')" class="block px-6 py-3 text-[#5A3E31] hover:bg-[#FFFBF5] rounded-xl transition-colors text-base font-medium">{{ __('Counselling') }}</a>
                                <a href="javascript:void(0)" onclick="applyCategoryFilter('Mindfulness', 'Mindfulness')" class="block px-6 py-3 text-[#5A3E31] hover:bg-[#FFFBF5] rounded-xl transition-colors text-base font-medium">{{ __('Mindfulness') }}</a>
                                <a href="javascript:void(0)" onclick="applyCategoryFilter('Spiritual Guidance', 'Spiritual Guidance')" class="block px-6 py-3 text-[#5A3E31] hover:bg-[#FFFBF5] rounded-xl transition-colors text-base font-medium">{{ __('Spiritual Guidance') }}</a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="flex-1 relative flex items-center border border-[#D4A58E] rounded-full p-2 bg-white shadow-sm hover:shadow-md transition-shadow h-[72px]">
                        ...
                        <button type="submit" class="bg-[#C5896B] hover:bg-[#B07459] cursor-pointer text-white w-14 h-14 rounded-full flex items-center justify-center transition-all shadow-md">
    ...
    <script>
        ...
        function fetchServices() {
            ...
            fetch(`{{ route('services') }}?${params}`, { headers: { 'X-Requested-With': 'XMLHttpRequest' } })
