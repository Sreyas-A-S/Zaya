    ...
    <div class="container mx-auto">
        <div class="flex flex-wrap -mx-2 justify-center">
            ...
            <div class="w-full sm:w-1/2 lg:w-1/3 px-4 mb-8">
                <!-- Service Card -->
                <div class="bg-white rounded-[20px] shadow-sm hover:shadow-xl transition-all duration-300 overflow-hidden group h-full flex flex-col">
                    <!-- Image -->
                    ...
                    <div class="p-8 flex flex-col flex-grow">
                        ...
                        <p class="text-gray-500 text-sm leading-relaxed mb-4">
                            {{ $service->description ?? 'Explore our ' . $service->title . ' services designed for your holistic wellness.' }}
                        </p>
                        <div class="flex items-center justify-between mt-auto">
                            <a href="{{ $service->link ?? '#' }}" class="text-secondary text-sm font-medium hover:underline">Read More...</a>
                            <a href="#"
