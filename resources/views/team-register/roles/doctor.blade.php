...
<div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-10">
    <div>
        ...
        <input type="text" name="ayush_reg_no" value="{{ old('ayush_reg_no') }}"
            ...
            placeholder="{{ __('Enter registration number') }}" autocomplete="off">
    </div>
    <div>
...
<div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
    ...
    <div class="md:col-span-2">
        ...
        <textarea name="key_expertise" rows="4" required
            class="w-full py-4 px-6 bg-white rounded-3xl border border-[#D1D5DB] outline-none text-[0.95rem] text-gray-700">{{ old('key_expertise') }}</textarea>
    </div>
    <div class="md:col-span-2">
        ...
        <textarea name="services_offered" rows="4" required
            class="w-full py-4 px-6 bg-white rounded-3xl border border-[#D1D5DB] outline-none text-[0.95rem] text-gray-700">{{ old('services_offered') }}</textarea>
    </div>
    <div class="md:col-span-2">
        ...
        <textarea name="awards_recognitions" rows="3"
            class="w-full py-4 px-6 bg-white rounded-3xl border border-[#D1D5DB] outline-none text-[0.95rem] text-gray-700">{{ old('awards_recognitions') }}</textarea>
    </div>
</div>
