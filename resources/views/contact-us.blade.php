    ...
    <div class="container mx-auto">
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 lg:gap-8">
            ...
            <div
                ...
                <h3 id="contact-info-location-label" class="text-primary font-bold font-sans! text-sm tracking-wider" data-i18n="contact_info_location_label">
                    {{ $settings['contact_info_location_label'] ?? __('Location') }}
                </h3>
            ...
            <!-- <div
                ...
                <h3 id="contact-info-phone-label" class="text-primary font-bold font-sans! text-sm tracking-wider" data-i18n="contact_info_phone_label">
                    {{ $settings['contact_info_phone_label'] ?? __('Contact') }}
                </h3>
            ...
            <div
                ...
                <h3 id="contact-info-email-label" class="text-primary font-bold font-sans! text-sm tracking-wider" data-i18n="contact_info_email_label">
                    {{ $settings['contact_info_email_label'] ?? __('Email') }}
                </h3>
            ...
            <div
                ...
                <h3 id="contact-info-working-hours-label" class="text-primary font-bold font-sans! text-sm tracking-wider" data-i18n="contact_info_working_hours_label">
                    {{ $settings['contact_info_working_hours_label'] ?? __('Working Hours') }}
                </h3>
           ...
           <div>
            ...
            <div class="flex items-start gap-3 mt-2">
                <input type="checkbox" id="consent" name="consent"
                    ...
                    required>
                <label id="contact-label-consent" for="consent" class="text-secondary text-sm leading-relaxed cursor-pointer font-normal" data-i18n="contact_form_consent_text">
                    {{ $settings['contact_form_consent_text'] ?? __('I give consent to Zaya for processing my personal data in accordance with GDPR') }}
                </label>
            </div>
