    ...
    <div class="container-fluid mx-auto relative z-10">
        ...
        <div class="bg-[#79584B] px-6 py-8 md:px-12 flex flex-col md:flex-row items-center justify-center gap-8">
            <h3 id="footer-newsletter-title"
                class="text-white text-lg md:text-xl font-regular text-center md:text-left font-sans!">
        ...
        <div class="bg-gradient-to-b from-[#FFE7CF] to-[#DFAF7F] ">
            <div
                ...
                <div>
                    <h4 id="footer-quick-links-title" class="font-medium font-sans! mb-6 text-xl text-[#2E2E2E]">
                        {{ __('Quick Links') }}</h4>
                    <ul class="space-y-4 text-base font-regular text-[#2E2E2E]/80">
                        <li><a id="footer-home" href="{{ route('home') }}"
                                class="hover:text-[#79584B] transition-colors">{{ __('Home') }}</a></li>
                        <li><a id="footer-who-we-are" href="#"
                                class="hover:text-[#79584B] transition-colors">{{ __('Who we are') }}</a></li>
                        <li><a id="footer-what-we-do" href="#"
                                class="hover:text-[#79584B] transition-colors">{{ __('What we do') }}</a></li>
                        <li><a id="footer-our-team" href="#"
                                class="hover:text-[#79584B] transition-colors">{{ __('Our Team') }}</a></li>
                        <li><a id="footer-blog" href="{{ route('blogs') }}"
                                class="hover:text-[#79584B] transition-colors">{{ __('Blog') }}</a></li>
                        <li><a id="footer-contact-us" href="{{ route('contact-us') }}"
                                class="hover:text-[#79584B] transition-colors">{{ __('Contact Us') }}</a></li>
                    </ul>
                </div>

                <!-- Column 3: Conditions -->
                <div class="z-1">
                    <h4 id="footer-conditions-title" class="font-medium font-sans! mb-6 text-xl text-[#2E2E2E]">
                        {{ __('Conditions We Support') }}</h4>
                    <ul class="space-y-4 text-base font-regular text-[#2E2E2E]/80">
                        <li><a id="footer-life-transitions" href="#"
                                class="hover:text-[#79584B] transition-colors">{{ __('Life Transitions') }}</a></li>
                        <li><a id="footer-mental-imbalance" href="#"
                                class="hover:text-[#79584B] transition-colors">{{ __('Mental Imbalance') }}</a></li>
                        <li><a id="footer-stress-reduction" href="#"
                                class="hover:text-[#79584B] transition-colors">{{ __('Stress Reduction') }}</a></li>
                        <li><a id="footer-toxin-removal" href="#"
                                class="hover:text-[#79584B] transition-colors">{{ __('Toxin Removal') }}</a></li>
                        <li><a id="footer-chronic-pain" href="#"
                                class="hover:text-[#79584B] transition-colors">{{ __('Chronic Pain') }}</a></li>
                        <li><a id="footer-immune-support" href="#"
                                class="hover:text-[#79584B] transition-colors">{{ __('Immune Support') }}</a></li>
                    </ul>
                </div>

                <!-- Column 4: Pincode & Socials -->
                <div class="z-1">
                    <h4 id="footer-pincode-title" class="font-medium font-sans! mb-4 text-base text-[#2E2E2E]">
                    ...
                    <div class="flex flex-col justify-between text-sm text-[#252525] gap-4 mt-8 mb-20">
                        <a id="footer-privacy" href="#"
                            class="hover:text-[#79584B] transition-colors">{{ __('Privacy Policy') }}</a>
                        <a id="footer-cookie" href="#"
                            class="hover:text-[#79584B] transition-colors">{{ __('Cookie Policy') }}</a>
                        <a id="footer-terms" href="#"
                            class="hover:text-[#79584B] transition-colors">{{ __('Terms & Conditions') }}</a>
                        <a id="footer-gdpr" href="#"
                            class="hover:text-[#79584B] transition-colors">{{ __('GDPR & Data Protection') }}</a>
                    </div>
                </div>
            </div>
