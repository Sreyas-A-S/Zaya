...
<header class="fixed w-full top-0 z-50 transition-all duration-300 py-6 bg-white">
    <div class="container mx-auto px-4 lg:px-6 flex justify-between items-center relative">
        ...
        <!-- Left Nav (Desktop) -->
        <nav
            class="hidden md:flex items-center gap-6 lg:gap-8 text-lg lg:text-lg font-medium flex-1 justify-start text-primary">
            ...
            <a href="{{ route('about-us') }}" class="hover:text-secondary transition-colors">About Us</a>
            <a href="{{ route('services') }}" class="hover:text-secondary transition-colors">Services</a>
        </nav>
        ...
        <div class="md:flex items-center gap-6 lg:gap-8 justify-end md:flex-1">
            <a href="#services"
                class="text-lg lg:text-lg text-secondary hover:text-primary font-medium transition-colors">Login</a>
            <a href="#"
    ...
    <div id="mobile-menu"
        ...
        <a href="{{ route('about-us') }}" class="text-lg font-medium text-secondary">About Us</a>
        <a href="{{ route('services') }}" class="text-lg font-medium text-secondary">Services</a>
