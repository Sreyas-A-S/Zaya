...
<header class="fixed w-full top-0 z-50 transition-all duration-300 py-8 bg-white">
    <div class="container mx-auto px-4 lg:px-6 flex justify-between items-center relative">
            ...
            <div class="relative group">
                ...
                <div
                    ...
                    <a href="{{ route('services') }}"
                        class="block px-5 py-3 text-sm text-gray-600 hover:bg-surface hover:text-primary transition-colors border-b border-gray-50">Ayurvedha</a>
                    <a href="#"
                    ...
                    <a href="#"
                        class="block px-5 py-3 text-sm text-gray-600 hover:bg-surface hover:text-primary transition-colors border-b border-gray-50">Councelling</a>
                </div>
            </div>
        ...
        <div class="flex items-center gap-6 lg:gap-8 justify-end flex-1">
            ...
            <a href="#"
                class="hidden lg:inline-block bg-secondary text-white px-6 py-2.5 rounded-full text-base font-medium hover:bg-opacity-90 transition-all shadow-md hover:shadow-lg whitespace-nowrap">Book
                a Practitioner</a>
