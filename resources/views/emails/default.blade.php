        ...
        <div class="content">
            ...
            @if(!empty($otp))
                <div class="otp-container">
                    <p
                        style="margin-bottom: 10px; font-weight: 600; color: #2E4B3C; font-size: 14px; text-transform: uppercase; letter-spacing: 1px;">
                        Your Secure OTP</p>
            ...
            @if(!empty($credentials) && (!empty($credentials['password']) || !empty($credentials['login_url'])))
                <table class="table">
                    <tr>
                        ...
                        <td style="word-break: break-all;"><a href="{{ $credentials['login_url'] ?? '' }}"
                                style="color: #4B5563;">{{ $credentials['login_url'] ?? '' }}</a></td>
                    </tr>
                    <tr>
                        <td class="label">Email:</td>
                        <td style="word-break: break-all;"><a href="mailto:{{ $credentials['email'] ?? '' }}"
                                style="color: #4B5563;">{{ $credentials['email'] ?? '' }}</a></td>
                    </tr>
