...
<head>
    ...
    <title><?php echo e($title ?? 'Session Reminder'); ?></title>
    <style>
        ...
        <div class="content">
            ...
            <div class="session-info">
                ...
                <div class="info-row">
                    ...
                    <span class="value"><?php echo e($booking->booking_time); ?> (Today)</span>
                </div>
                <div class="info-row">
                    <span class="label">Participants:</span>
                    <span class="value"><?php echo e($booking->user->name); ?> & <?php echo e($booking->practitioner->user->name); ?></span>
                </div>
                <?php if($booking->need_translator): ?>
                <div class="info-row">
                    <span class="label">Translator:</span>
                    <span class="value"><?php echo e($booking->translator->user->name ?? 'Assigned'); ?></span>
                </div>
                <?php endif; ?>
            </div>
            ...
            <p class="notice">
                ...
                <span style="word-break: break-all; color: #2E4B3C; font-weight: 500;"><?php echo e($videoLink); ?></span>
            </p>
        </div>
...
<?php /**PATH C:\wamp64\www\zaya\resources\views\emails\session-reminder.blade.php ENDPATH**/ ?>