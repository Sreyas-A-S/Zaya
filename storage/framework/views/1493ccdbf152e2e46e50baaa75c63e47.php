...
<script>
    $(document).ready(function() {
        var table = $('#packages-table').DataTable({
            processing: true,
            serverSide: true,
            ajax: "<?php echo e(route('admin.packages.index')); ?>",
            columns: [
        ...
        $('#package-form').on('submit', function(e) {
            ...
            var url = id ? "<?php echo e(url('admin/packages')); ?>/" + id : "<?php echo e(route('admin.packages.store')); ?>";
        ...
        $(document).on('click', '.editPackage', function() {
            var id = $(this).data('id');
            $.get("<?php echo e(url('admin/packages')); ?>/" + id, function(data) {
    ...
    function updateStatus(id, status) {
        $.ajax({
            url: "<?php echo e(url('admin/packages')); ?>/" + id + "/status",
            type: 'POST',
            data: {
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\wamp64\www\zaya\resources\views\admin\packages\index.blade.php ENDPATH**/ ?>