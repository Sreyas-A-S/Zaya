...
<?php $__env->startSection('title', 'Yoga Therapists'); ?>
...
<div id="imagePreview"
style="background-image:url('<?php echo e(asset('admiro/assets/images/user/user.png')); ?>');">
</div>
</div>
</div>
                        ...
                        <div class="row" style="max-height: 300px; overflow-y:auto;">
                            ...
                            <div class="col-12 mb-2">
                                <div class="form-check checkbox-primary d-flex align-items-center">
                                    <input class="form-check-input group-required me-2" type="checkbox" name="areas_of_expertise[]" value="<?php echo e($area->name); ?>" id="area_<?php echo e($area->id); ?>" data-group="expertise">
                                    <label class="form-check-label flex-grow-1 mb-0" for="area_<?php echo e($area->id); ?>"><?php echo e($area->name); ?></label>
                                    <a href="javascript:void(0)" class="text-danger ms-2 delete-master-data-btn" data-id="<?php echo e($area->id); ?>" data-type="yoga_expertises"><i class="fa fa-trash"></i></a>
                                </div>
                            </div>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="mb-3">
                            ...
                            <div class="d-flex gap-2 flex-wrap">
                                <?php $__currentLoopData = $consultationModes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $mode): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="form-check checkbox-info">
                                    <input class="form-check-input group-required" type="checkbox" name="consultation_modes[]" value="<?php echo e($mode); ?>" id="mode_<?php echo e($loop->index); ?>" data-group="modes">
                                    <label class="form-check-label" for="mode_<?php echo e($loop->index); ?>"><?php echo e($mode); ?></label>
                                </div>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </div>
                        </div>
    ...
    function updateStepper() {
        ...
        $(document).ready(function() {
            ...
            table = $('#therapists-table').DataTable({
                ...
                serverSide: true,
                ajax: {
                    url: "<?php echo e(route('admin.yoga-therapists.index')); ?>",
                    data: function (d) {
            ...
            $('#therapist-form').on('submit', function(e) {
                ...
                let url = id ? "<?php echo e(url('admin/yoga-therapists')); ?>/" + id : "<?php echo e(route('admin.yoga-therapists.store')); ?>";
            ...
            $('body').on('click', '.editTherapist', function() {
                ...
                $.get("<?php echo e(url('admin/yoga-therapists')); ?>/" + id + "/edit", function(response) {
                    let u = response.user;
            ...
            $('#confirm-delete-btn').click(function() {
                ...
                $.ajax({
                    url: "<?php echo e(url('admin/yoga-therapists')); ?>/" + id,
                    type: 'DELETE',
                    data: {
                        _token: '<?php echo e(csrf_token()); ?>'
                    },
            ...
            $('body').on('click', '.viewTherapist', function() {
                let id = $(this).data('id');
                $.get("<?php echo e(url('admin/yoga-therapists')); ?>/" + id, function(response) {
                    let u = response.user;
                    let t = response.therapist;
                    ...
                    const defaultProfile = "<?php echo e(asset('admiro/assets/images/user/user.png')); ?>";
            ...
            $('#confirm-status-btn').on('click', function() {
                ...
                $.ajax({
                    url: "<?php echo e(url('admin/yoga-therapists')); ?>/" + id + "/status",
                    type: 'POST',
                    data: {
                        _token: '<?php echo e(csrf_token()); ?>',
                        status: newStatus
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\wamp64\www\zaya\resources\views\admin\yoga_therapists\index.blade.php ENDPATH**/ ?>