<?php $__env->startSection('title', 'Translators'); ?>
                                ...
                                <div class="step-content" id="step-1">
                                    <div class="row g-3">
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <input class="form-control" type="date" name="dob" required max="<?php echo e(date('Y-m-d')); ?>">
                                        </div>
                                        <div class="col-md-12">
                                            <label class="form-label">Address Line 1 <span class="text-danger">*</span></label>
                                            <input type="text" class="form-control validate-char-limit" name="address_line_1" required placeholder="House No, Building, Street" maxlength="500" data-max="500">
                                            <div class="text-danger small mt-1 char-limit-msg d-none">Maximum 500 characters allowed.</div>
                                        </div>
                                        <div class="col-md-12">
                                            <label class="form-label">Address Line 2</label>
                                            <input type="text" class="form-control validate-char-limit" name="address_line_2" placeholder="Locality, Landmark" maxlength="500" data-max="500">
                                            <div class="text-danger small mt-1 char-limit-msg d-none">Maximum 500 characters allowed.</div>
                                        </div>
                                        <div class="col-md-6">
    ...
    <script>
        ...
        $(document).ready(function() {
                    ...
                    table = $('#translators-table').DataTable({
                        ...
                        serverSide: true,
                        ajax: {
                            url: "<?php echo e(route('admin.translators.index')); ?>",
                            data: function(d) {
                ...
                `;
                    ...
                    $('#translator-form').on('submit', function(e) {
                        ...
                        let url = id ? "<?php echo e(url('admin/translators')); ?>/" + id : "<?php echo e(route('admin.translators.store')); ?>";
                    ...
                    $('body').on('click', '.editTranslator', function() {
                        ...
                        $.get("<?php echo e(url('admin/translators')); ?>/" + id + "/edit", function(response) {
                            let u = response.user;
                    ...
                    $('#confirm-delete-btn').click(function() {
                        ...
                        $.ajax({
                            url: "<?php echo e(url('admin/translators')); ?>/" + id,
                            type: 'DELETE',
                            data: {
                                _token: '<?php echo e(csrf_token()); ?>'
                            },
                    ...
                    $('body').on('click', '.viewTranslator', function() {
                        ...
                        $.get("<?php echo e(url('admin/translators')); ?>/" + id, function(response) {
            ...
            $(document).off('click', '#confirm-status-btn').on('click', '#confirm-status-btn', function() {
                ...
                $.ajax({
                    url: "<?php echo e(url('admin/translators')); ?>/" + id + "/status",
                    type: 'POST',
                    data: {
                        _token: '<?php echo e(csrf_token()); ?>',
                        status: newStatus
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\wamp64\www\zaya\resources\views/admin/translators/index.blade.php ENDPATH**/ ?>