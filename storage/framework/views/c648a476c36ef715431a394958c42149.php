...
<div class="bg-white rounded-2xl p-6 mb-12">
    ...
    <div>
        ...
        <select name="external_therapies[]" multiple data-tomselect
            class="w-full py-3.5 px-6 bg-[#F8F8F8] rounded-full border border-[#D1D5DB] outline-none text-[0.95rem] text-gray-700">
...
<div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
    <div class="md:col-span-2">
        ...
        <textarea name="short_bio" rows="4" required
            class="w-full py-4 px-6 bg-white rounded-3xl border border-[#D1D5DB] outline-none text-[0.95rem] text-gray-700"><?php echo e(old('short_bio')); ?></textarea>
    </div>
    <div class="md:col-span-2">
        ...
        <textarea name="key_expertise" rows="4" required
            class="w-full py-4 px-6 bg-white rounded-3xl border border-[#D1D5DB] outline-none text-[0.95rem] text-gray-700"><?php echo e(old('key_expertise')); ?></textarea>
    </div>
    <div class="md:col-span-2">
        ...
        <textarea name="services_offered" rows="4" required
            class="w-full py-4 px-6 bg-white rounded-3xl border border-[#D1D5DB] outline-none text-[0.95rem] text-gray-700"><?php echo e(old('services_offered')); ?></textarea>
    </div>
    <div class="md:col-span-2">
        ...
        <textarea name="awards_recognitions" rows="3"
            class="w-full py-4 px-6 bg-white rounded-3xl border border-[#D1D5DB] outline-none text-[0.95rem] text-gray-700"><?php echo e(old('awards_recognitions')); ?></textarea>
    </div>
</div>
...
<?php /**PATH C:\wamp64\www\zaya\resources\views/team-register/roles/doctor.blade.php ENDPATH**/ ?>