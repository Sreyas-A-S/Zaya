...
<script>
    ...
    $('body').on('click', '.editRole', function() {
        ...
        $.get("<?php echo e(url('admin/roles')); ?>/" + id + "/edit", function(data) {
            $('#role_id').val(data.id);
    ...
    $('#role-form').on('submit', function(e) {
        ...
        const url = id ? "<?php echo e(url('admin/roles')); ?>/" + id : "<?php echo e(route('admin.roles.store')); ?>";
    ...
    $('#confirm-delete-btn').on('click', function() {
        ...
        $.ajax({
            type: "DELETE",
            url: "<?php echo e(url('admin/roles')); ?>/" + id,
            data: {
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\wamp64\www\zaya\resources\views\admin\roles\index.blade.php ENDPATH**/ ?>