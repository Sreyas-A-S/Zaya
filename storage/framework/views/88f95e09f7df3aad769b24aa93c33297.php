    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="card">
                ...
                <div class="card-body">
                    <form id="contactSettingsForm" action="<?php echo e(route('admin.contact-settings.update')); ?>" method="POST" enctype="multipart/form-data">
                        <?php echo csrf_field(); ?>
                        <div class="row g-3">
                            <div class="col-md-3">
                                ...
                                <div class="tab-content" id="v-pills-tabContent">
                                    ...
                                    <div class="tab-pane fade show active p-3" id="v-pills-hero_banner" role="tabpanel" aria-labelledby="v-pills-hero_banner-tab">
                                        <div class="row g-4">
                                            ...
                                            <?php $__currentLoopData = $settings['hero_banner']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $setting): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <?php echo $__env->make('admin.contact-us.partials.field', ['setting' => $setting], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                                    ...
                                    <div class="tab-pane fade p-3" id="v-pills-contact_information" role="tabpanel" aria-labelledby="v-pills-contact_information-tab">
                                        <div class="row g-4">
                                            <?php $__currentLoopData = $settings['contact_information']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $setting): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <?php echo $__env->make('admin.contact-us.partials.field', ['setting' => $setting], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                        </div>
                                    </div>
                                    ...
                                    <div class="tab-pane fade p-3" id="v-pills-message_form" role="tabpanel" aria-labelledby="v-pills-message_form-tab">
                                        <div class="row g-4">
                                            <?php $__currentLoopData = $settings['message_form']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $setting): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <?php echo $__env->make('admin.contact-us.partials.field', ['setting' => $setting], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                        </div>
                                    </div>
                                    ...
                                    <div class="tab-pane fade p-3" id="v-pills-support_section" role="tabpanel" aria-labelledby="v-pills-support_section-tab">
                                        <div class="row g-4">
                                            <?php $__currentLoopData = $settings['support_section']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $setting): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <?php echo $__env->make('admin.contact-us.partials.field', ['setting' => $setting], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                        </div>
                                    </div>
                                    ...
                                    <div class="tab-pane fade p-3" id="v-pills-faqs" role="tabpanel" aria-labelledby="v-pills-faqs-tab">
                                        <div class="row g-4 mb-5">
                                            <?php $__currentLoopData = $settings['faqs']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $setting): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <?php echo $__env->make('admin.contact-us.partials.field', ['setting' => $setting], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                        </div>
                                                ...
                                                <tbody>
                                                    <?php $__empty_1 = true; $__currentLoopData = $faqs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $faq): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                                        <tr>
                                                            ...
                                                            <td class="text-wrap" style="max-width: 250px;"><?php echo e($faq->question); ?></td>
                                                            <td class="text-wrap" style="max-width: 350px;"><?php echo e(Str::limit($faq->answer, 100)); ?></td>
                                                            <td>
                                                                <span class="badge <?php echo e($faq->status ? 'bg-success' : 'bg-danger'); ?> faq-status-toggle" 
                                                                    data-id="<?php echo e($faq->id); ?>" data-status="<?php echo e($faq->status); ?>" style="cursor: pointer;">
                                                            ...
                                                            <td>
                                                                <div class="d-flex gap-2">
                                                                    ...
                                                                    <button type="button" class="text-danger border-0 bg-transparent delete-faq" data-id="<?php echo e($faq->id); ?>">
...
<div class="modal fade" id="addFaqModal" tabindex="-1" aria-labelledby="addFaqModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <form id="addFaqForm" action="<?php echo e(route('admin.contact-settings.faq-store')); ?>">
                <?php echo csrf_field(); ?>
...
<script>
    ...
    $(document).ready(function() {
        ...
        $('#editFaqForm').on('submit', function(e) {
            ...
            $.post("<?php echo e(url('admin/contact-settings/faqs')); ?>/" + id, formData, function(response) {
                if (response.success) {
                    location.reload();
                }
            }).fail(function(xhr) {
        ...
        $('.delete-faq').on('click', function() {
            ...
            let id = $(this).data('id');
            $.ajax({
                url: "<?php echo e(url('admin/contact-settings/faqs')); ?>/" + id,
                type: 'DELETE',
                success: function(response) {
        ...
        $('.faq-status-toggle').on('click', function() {
            ...
            $.post("<?php echo e(url('admin/contact-settings/faqs')); ?>/" + id + "/status", {status: newStatus}, function(response) {
                if (response.success) location.reload();
            });
        });
    });
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\wamp64\www\zaya\resources\views\admin\contact-us\index.blade.php ENDPATH**/ ?>