<?php $__env->startSection('title', 'Assign Permissions - ' . $role->name); ?>
        ...
        <div class="col-sm-12">
            <div class="card">
                <div class="card-header pb-0 d-flex justify-content-between align-items-center">
                    <div>
                        <h5>Role: <span class="text-primary"><?php echo e($role->name); ?></span></h5>
                        <p class="text-muted mb-0 small">Manage access levels and permissions for this role.</p>
                    </div>
                    <div class="d-flex gap-2">
                        <a href="<?php echo e(route('admin.roles.index')); ?>" class="btn btn-outline-dark"><i class="fa-solid fa-arrow-left me-2"></i> Back to Roles</a>
                    </div>
                </div>
                <div class="card-body">
                    <!-- Global Actions -->
                    ...
                    <div class="table-responsive">
                        <table class="table table-bordered table-hover align-middle">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td class="fw-bold text-dark bg-light-primary"><?php echo e(ucwords(str_replace(['_', '-'], ' ', $group))); ?></td>
                                    ...
                                    <td class="text-center">
                                        ...
                                        <div class="form-check checkbox-primary d-flex justify-content-center mb-0">
                                            ...
                                            <label class="form-check-label" for="perm_<?php echo e($perm->id); ?>"></label>
                                        </div>
                                        <?php else: ?>
                                    ...
                                    <td class="text-center bg-light">
                                        <div class="form-check checkbox-solid-dark d-flex justify-content-center mb-0">
                                            <input type="checkbox" class="form-check-input group-row-select"
                                                id="row_select_<?php echo e($loop->index); ?>"
                                                title="Select All in <?php echo e($group); ?>">
                                        </div>
                                    </td>
                                </tr>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
...
<script>
    ...
    $(document).ready(function() {
        ...
        function submitPermissions() {
            ...
            $.ajax({
                url: "<?php echo e(route('admin.roles.permissions.update', $role->id)); ?>",
                type: 'POST',
                data: {
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\wamp64\www\zaya\resources\views\admin\roles\permissions.blade.php ENDPATH**/ ?>