<?php $__env->startSection('title', 'User Credentials'); ?>
...
<script>
    $(document).ready(function() {
        var table = $('#credentials-table').DataTable({
            ...
            serverSide: true,
            ajax: {
                url: "<?php echo e(route('admin.credentials.index')); ?>",
                data: function (d) {
        ...
        $(document).on('click', '.generateLink', function() {
            ...
            $.ajax({
                url: "<?php echo e(url('admin/credentials')); ?>/" + id + "/generate-link",
                type: 'POST',
        ...
        $('#password-form').on('submit', function(e) {
            e.preventDefault();
            var id = $('#user-id').val();
            var url = "<?php echo e(url('admin/credentials')); ?>/" + id + "/password";
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\wamp64\www\zaya\resources\views\admin\credentials\index.blade.php ENDPATH**/ ?>