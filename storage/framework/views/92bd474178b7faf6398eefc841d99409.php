<?php $__env->startSection('title', 'Content Managers'); ?>
...
<script>
    ...
    $(document).ready(function() {
        ...
        let table = $('#content-managers-table').DataTable({
            ...
            serverSide: true,
            ajax: {
                url: "<?php echo e(route('admin.content-managers.index')); ?>",
                data: function(d) {
        ...
        $('#confirmStatusBtn').click(function() {
            ...
            $.ajax({
                url: "<?php echo e(url('admin/content-managers')); ?>/" + id + "/status",
                type: 'POST',
                data: {
        ...
        $('#contentManagerModal').on('hidden.bs.modal', function() {
            ...
            $('#contentManagerForm').attr('action', "<?php echo e(route('admin.content-managers.store')); ?>");
        ...
        $(document).on('click', '.editUser', function() {
            let id = $(this).data('id');
            $.get("<?php echo e(url('admin/content-managers')); ?>/" + id + "/edit", function(user) {
                ...
                $('#contentManagerForm').attr('action', "<?php echo e(url('admin/content-managers')); ?>/" + id);
        ...
        $(document).on('click', '.deleteUser', function() {
            if (confirm('Are you sure you want to delete this user?')) {
                let id = $(this).data('id');
                $.ajax({
                    url: "<?php echo e(url('admin/content-managers')); ?>/" + id,
                    type: 'DELETE',
                    data: {
                        _token: "<?php echo e(csrf_token()); ?>"
                    },
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\wamp64\www\zaya\resources\views\admin\content-manager\index.blade.php ENDPATH**/ ?>