    ...
    <div class="lg:col-span-4 xl:col-span-3 flex flex-col gap-8">
        ...
        <div class="bg-white rounded-xl px-5 pt-12 pb-5 flex flex-col items-center border border-[#2E4B3D]/12">
            <div class="relative mb-6">
                ...
                ?>
                <img id="user-profile-img" src="<?php echo e($avatar); ?>"
                    alt="<?php echo e($user->name); ?>" class="w-38 h-38 rounded-full object-cover"
                    onerror="this.src='<?php echo e(asset('frontend/assets/profile-dummy-img.png')); ?>'">
            ...
            <h2 class="text-2xl font-bold font-sans! text-secondary mb-1"><?php echo e($user->name); ?></h2>
            <p class="text-lg text-gray-400 font-normal mb-10 text-capitalize"><?php echo e(str_replace('_', ' ', $user->role)); ?></p>
            ...
            <div class="w-full px-4 pt-4">
                <a href="javascript:void(0)" onclick="openPasswordModal()"
                    ...
                    <span class="font-normal"><?php echo e(__('Change Password')); ?></span>
                </a>
            </div>
            ...
            <div class="w-full mt-20 relative">
                <div class="flex justify-between items-center mb-6">
                    <h3 class="text-xl font-medium font-sans! text-gray-800"><?php echo e(__('Practitioner Gallery')); ?></h3>
            <button onclick="openGalleryModal()" class="text-gray-400 hover:text-secondary transition-colors">
                <i class="ri-pencil-line text-xl"></i>
            </button>
        </div>
                <div class="grid grid-cols-2 gap-3">
                    <?php $__empty_1 = true; $__currentLoopData = $sanctuaryImages->take(3); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $img): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <?php if($index === 2 && $sanctuaryImages->count() > 3): ?>
                            <div class="relative cursor-pointer group" onclick="openGalleryModal()">
                                ...
                                <div class="absolute inset-0 bg-secondary/30 backdrop-blur-[2px] rounded-xl flex items-center justify-center border border-white/20 shadow-inner group-hover:bg-secondary/40 transition-all">
                                    <span class="text-white text-xl font-bold tracking-wider">+<?php echo e($sanctuaryImages->count() - 2); ?></span>
                                </div>
                            </div>
                        <?php else: ?>
                            <img src="<?php echo e(asset('storage/' . $img->image_path)); ?>"
                                alt="Gallery <?php echo e($index + 1); ?>"
                                class="<?php echo e($index === 0 ? 'col-span-2 h-[140px]' : 'h-[110px]'); ?> w-full object-cover rounded-xl shadow-sm">
                        <?php endif; ?>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                        <div class="col-span-2 py-8 bg-gray-50 rounded-xl border border-dashed border-gray-200 flex flex-col items-center justify-center text-gray-400">
                            ...
                            <p class="text-sm"><?php echo e(__('No gallery images')); ?></p>
                        </div>
                    <?php endif; ?>
                </div>
            </div>
        ...
        <div class="bg-white rounded-xl px-5 py-8 lg:p-12 border border-[#2E4B3D]/12 relative">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-y-8 gap-x-6">
                <div>
                    ...
                    <p class="text-lg font-normal text-gray-800"><?php echo e($age); ?></p>
                </div>
                <div>
                    <p class="text-lg text-gray-400 mb-1">Gender</p>
                    <p class="text-lg font-normal text-gray-800"><?php echo e($gender); ?></p>
                </div>
                <div>
                    <p class="text-lg text-gray-400 mb-1">DOB</p>
                    <p class="text-lg font-normal text-gray-800"><?php echo e($dob); ?></p>
                </div>

                <div>
                    <p class="text-lg text-gray-400 mb-1">Nationality</p>
                    <p class="text-lg font-normal text-gray-800"><?php echo e($nationality); ?></p>
                </div>
                <div>
                    <p class="text-lg text-gray-400 mb-1">Phone</p>
                    <p class="text-lg font-normal text-gray-800"><?php echo e($phone); ?></p>
                </div>
                <div>
                    <p class="text-lg text-gray-400 mb-1">Email</p>
                    <p class="text-lg font-normal text-gray-800"><?php echo e($email); ?></p>
                </div>

                <div class="md:col-span-3">
                    <p class="text-lg text-gray-400 mb-1">Address</p>
                    <p class="text-lg font-normal text-gray-800 leading-relaxed"><?php echo e($address); ?></p>
                </div>
            </div>
        </div>
            ...
            <div class="relative mb-8">
                ...
                <div class="flex flex-wrap gap-2.5" id="specialities-display-container">
                    <?php $__empty_1 = true; $__currentLoopData = $specialities; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $speciality): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <span class="px-6 py-2 bg-[#F6F6F6] text-gray-700 text-lg rounded-full"><?php echo e(is_array($speciality) ? implode(', ', $speciality) : $speciality); ?></span>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
            ...
            <div class="relative">
                ...
                <div class="flex flex-wrap gap-2.5" id="conditions-display-container">
                    <?php $__empty_1 = true; $__currentLoopData = $conditions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $condition): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <span class="px-6 py-2 bg-[#F6F6F6] text-gray-700 text-lg rounded-full"><?php echo e(is_array($condition) ? implode(', ', $condition) : $condition); ?></span>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
...
<div class="grid grid-cols-2 md:grid-cols-4 gap-4 lg:gap-6 mt-8">
    <div
        ...
        <h3 class="text-4xl lg:text-5xl font-medium font-sans! text-[#1A1A1A] mb-4"><?php echo e($totalSessions); ?></h3>
        <p class="text-base lg:text-xl text-gray-400 font-normal">Total Sessions</p>
    </div>
    <div
        class="bg-white rounded-xl px-4 py-8 flex flex-col items-center justify-center text-center border border-[#2E4B3D]/12">
        <h3 class="text-4xl lg:text-5xl font-medium font-sans! text-[#1A1A1A] mb-4"><?php echo e($totalClients); ?></h3>
        <p class="text-base lg:text-xl text-gray-400 font-normal">Total No.of Clients</p>
    </div>
    <div
        class="bg-white rounded-xl px-4 py-8 flex flex-col items-center justify-center text-center border border-[#2E4B3D]/12">
        <h3 class="text-4xl lg:text-5xl font-medium font-sans! text-[#1A1A1A] mb-4"><?php echo e($todaySessions); ?></h3>
        <p class="text-base lg:text-xl text-gray-400 font-normal">Today's Session</p>
    </div>
    <div
        class="bg-white rounded-xl px-4 py-8 flex flex-col items-center justify-center text-center border border-[#2E4B3D]/12">
        <h3 class="text-4xl lg:text-5xl font-medium font-sans! text-[#1A1A1A] mb-4"><?php echo e($upcomingSessions); ?></h3>
...
<div class="grid grid-cols-1 lg:grid-cols-2 gap-8 mt-8">
    ...
    <div class="bg-white rounded-xl px-5 py-8 lg:p-8 border border-[#2E4B3D]/12 flex flex-col">
        ...
        <div class="flex-1 space-y-6">
            <?php $__empty_1 = true; $__currentLoopData = $servicesHistory; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $booking): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
            <div class="flex items-center justify-between">
                <div class="flex items-center gap-4 w-[198px]">
                    <img src="<?php echo e($booking->user->profile_pic ? asset('storage/' . $booking->user->profile_pic) : asset('frontend/assets/profile-dummy-img.png')); ?>" class="w-13 h-13 rounded-full object-cover">
                    <div>
                        <p class="text-base font-medium text-gray-800"><?php echo e($booking->user->name); ?></p>
                        <p class="text-sm text-gray-400 mt-0.5"><?php echo e(\Carbon\Carbon::parse($booking->booking_date)->isToday() ? 'Today' : (\Carbon\Carbon::parse($booking->booking_date)->isYesterday() ? 'Yesterday' : \Carbon\Carbon::parse($booking->booking_date)->format('M d, Y'))); ?></p>
                    </div>
                </div>
                <div class="text-sm text-gray-400 hidden sm:block">
                    <?php echo e(\Carbon\Carbon::parse($booking->booking_time)->format('h:i A')); ?> - <?php echo e(\Carbon\Carbon::parse($booking->booking_time)->addMinutes($booking->duration ?? 60)->format('h:i A')); ?>
        ...
        <?php if($servicesHistory->count() > 0): ?>
        <div class="mt-8 text-center pt-2">
            <a href="<?php echo e(route('bookings.index')); ?>" class="text-lg text-gray-400 hover:text-gray-600 transition-colors font-normal">See all...</a>
        </div>
        <?php endif; ?>
    </div>
    ...
    <div class="bg-white rounded-xl px-5 py-8 lg:p-8 border border-[#2E4B3D]/12 flex flex-col">
        ...
        <div class="flex-1 space-y-6">
            <?php $__empty_1 = true; $__currentLoopData = $upcomingServices; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $booking): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
            <div class="flex items-center justify-between">
                <div class="flex items-center gap-4 w-[198px]">
                    <img src="<?php echo e($booking->user->profile_pic ? asset('storage/' . $booking->user->profile_pic) : asset('frontend/assets/profile-dummy-img.png')); ?>" class="w-13 h-13 rounded-full object-cover">
                    <div>
                        <p class="text-base font-medium text-gray-800"><?php echo e($booking->user->name); ?></p>
                        <p class="text-sm text-gray-400 mt-0.5"><?php echo e(\Carbon\Carbon::parse($booking->booking_date)->isToday() ? 'Today' : \Carbon\Carbon::parse($booking->booking_date)->format('M d, Y')); ?></p>
                ...
                <div class="flex flex-col sm:flex-row items-center gap-2">
                    ...
                    <div class="w-[100px] sm:w-[120px] text-right">
                        ...
                        ?>
                        <span class="<?php echo e($statusColor); ?> text-white text-xs sm:text-sm font-normal p-2 sm:px-4 sm:py-1.5 rounded-full inline-block text-center w-full text-capitalize"><?php echo e($booking->status); ?></span>
                    </div>
                </div>
            </div>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
...
<div id="specialitiesModal" class="fixed inset-0 bg-black/50 backdrop-blur-sm hidden z-50 flex items-center justify-center p-4">
    <div class="bg-white rounded-2xl w-full max-w-lg overflow-hidden shadow-2xl">
        ...
        <form id="specialitiesForm" action="<?php echo e(route('profile.updateProfessional')); ?>" method="POST" class="px-8 py-8 space-y-6">
            <?php echo csrf_field(); ?>
            ...
            <div>
                ...
                <select id="specialities-select" name="specialities[]" multiple placeholder="Select or type specialities...">
                    <?php $__currentLoopData = $allSpecialities; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option value="<?php echo e($item); ?>" <?php echo e(in_array($item, $specialities) ? 'selected' : ''); ?>><?php echo e($item); ?></option>
                    ...
                    <?php $__currentLoopData = $specialities; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <?php if(!$allSpecialities->contains($item)): ?>
...
<div id="conditionsModal" class="fixed inset-0 bg-black/50 backdrop-blur-sm hidden z-50 flex items-center justify-center p-4">
    <div class="bg-white rounded-2xl w-full max-w-lg overflow-hidden shadow-2xl">
        ...
        <form id="conditionsForm" action="<?php echo e(route('profile.updateProfessional')); ?>" method="POST" class="px-8 py-8 space-y-6">
            <?php echo csrf_field(); ?>
            ...
            <div>
                ...
                <select id="conditions-select" name="conditions[]" multiple placeholder="Select or type conditions...">
                    <?php $__currentLoopData = $allConditions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option value="<?php echo e($item); ?>" <?php echo e(in_array($item, $conditions) ? 'selected' : ''); ?>><?php echo e($item); ?></option>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    <?php $__currentLoopData = $conditions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <?php if(!$allConditions->contains($item)): ?>
                            <option value="<?php echo e($item); ?>" selected><?php echo e($item); ?></option>
                        <?php endif; ?>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </select>
        ...
        <div class="overflow-y-auto p-8 space-y-8">
            ...
            <div>
                ...
                <div class="grid grid-cols-2 sm:grid-cols-3 gap-4" id="gallery-items-container">
                    ...
                    ?>
                    <?php $__empty_1 = true; $__currentLoopData = $allImages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $img): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <div class="relative group aspect-video rounded-xl overflow-hidden shadow-sm gallery-item" data-id="<?php echo e($img->id); ?>" data-category="<?php echo e($img->category); ?>" style="display: <?php echo e($img->category === 'sanctuary' ? 'block' : 'none'); ?>">
                            <img src="<?php echo e(asset('storage/' . $img->image_path)); ?>" class="w-full h-full object-cover">
                            <div class="absolute inset-0 bg-black/40 opacity-0 group-hover:opacity-100 transition-opacity flex items-center justify-center gap-3">
                                <button onclick="previewImage('<?php echo e(asset('storage/' . $img->image_path)); ?>')" class="w-10 h-10 bg-white text-secondary rounded-full flex items-center justify-center hover:bg-gray-100 transition-colors shadow-lg">
                                    <i class="ri-fullscreen-line text-lg"></i>
                                </button>
                                <button onclick="deleteGalleryImage(<?php echo e($img->id); ?>)" class="w-10 h-10 bg-red-500 text-white rounded-full flex items-center justify-center hover:bg-red-600 transition-colors shadow-lg">
                                    <i class="ri-delete-bin-line text-lg"></i>
                                </button>
                            </div>
                        </div>
...
<div id="passwordModal" class="fixed inset-0 bg-black/50 backdrop-blur-sm hidden z-50 flex items-center justify-center p-4">
    <div class="bg-white rounded-2xl w-full max-w-lg overflow-hidden shadow-2xl">
        ...
        <form id="changePasswordForm" action="<?php echo e(route('profile.updatePassword')); ?>" method="POST" class="px-8 py-8 space-y-6">
            <?php echo csrf_field(); ?>
            <div>
...
<div id="personal-edit-modal" class="fixed inset-0 bg-[#1A1A1A]/40 backdrop-blur-sm hidden z-[100] flex items-center justify-center p-4">
    <div class="bg-white rounded-[32px] w-full max-w-[520px] overflow-hidden shadow-2xl scale-95 opacity-0 transition-all duration-200" id="personalEditContent">
        <div class="p-8">
            <div class="flex justify-between items-center mb-6">
                <h3 class="text-2xl font-bold text-secondary"><?php echo e(__('Edit Personal Details')); ?></h3>
            ...
            <form method="POST" action="<?php echo e(route('profile.updatePersonal')); ?>">
                <?php echo csrf_field(); ?>
                <div class="grid grid-cols-1 md:grid-cols-2 gap-5 mb-6">
                    <div class="col-span-1 md:col-span-2 grid grid-cols-3 gap-4">
                        <div class="col-span-1">
                            <label class="text-sm text-gray-500 font-semibold mb-2 block"><?php echo e(__('Code')); ?></label>
                            <input type="text" name="mobile_country_code" value="<?php echo e(old('mobile_country_code', $profile->mobile_country_code ?? '')); ?>" placeholder="+1" class="w-full border border-gray-200 rounded-xl px-4 py-3 focus:border-secondary outline-none">
                        </div>
                        <div class="col-span-2">
                            <label class="text-sm text-gray-500 font-semibold mb-2 block"><?php echo e(__('Phone')); ?></label>
                            <input type="text" name="phone" value="<?php echo e(old('phone', $profile->phone ?? ($user->phone ?? ''))); ?>" class="w-full border border-gray-200 rounded-xl px-4 py-3 focus:border-secondary outline-none">
                        </div>
                    </div>
                    <div>
                        <label class="text-sm text-gray-500 font-semibold mb-2 block"><?php echo e(__('Gender')); ?></label>
                        <select name="gender" class="w-full border border-gray-200 rounded-xl px-4 py-3 bg-white focus:border-secondary outline-none">
                            ...
                            <?php $__currentLoopData = ['male' => 'Male', 'female' => 'Female', 'transgender' => 'Transgender', 'other' => 'Other']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value => $label): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($value); ?>" <?php echo e(old('gender', $profile->gender ?? $user->gender ?? '') === $value ? 'selected' : ''); ?>><?php echo e(__($label)); ?></option>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </select>
                    </div>
                    <div>
                        <label class="text-sm text-gray-500 font-semibold mb-2 block"><?php echo e(__('DOB')); ?></label>
                        <input type="date" name="dob" value="<?php echo e(old('dob', $profile && $profile->dob ? \Illuminate\Support\Carbon::parse($profile->dob)->format('Y-m-d') : '')); ?>" class="w-full border border-gray-200 rounded-xl px-4 py-3 focus:border-secondary outline-none">
                    </div>
                    <div>
                        <label class="text-sm text-gray-500 font-semibold mb-2 block"><?php echo e(__('Email')); ?></label>
                        <input type="email" value="<?php echo e($email); ?>" class="w-full border border-gray-200 rounded-xl px-4 py-3 bg-gray-100 text-gray-500 cursor-not-allowed" readonly>
                    </div>
                    <div>
                        <label class="text-sm text-gray-500 font-semibold mb-2 block"><?php echo e(__('Nationality')); ?></label>
                        <select name="nationality" class="w-full border border-gray-200 rounded-xl px-4 py-3 bg-white focus:border-secondary outline-none">
                            ...
                            <?php $__currentLoopData = $countries; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $country): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($country->name); ?>" <?php echo e(old('nationality', $nationality !== 'Not set' ? $nationality : '') === $country->name ? 'selected' : ''); ?>>
                    ...
                    <div>
                        <label class="text-sm text-gray-500 font-semibold mb-2 block"><?php echo e(__('Address Line 1')); ?></label>
                        <input type="text" name="address_line_1" value="<?php echo e(old('address_line_1', $profile->address_line_1 ?? $profile->residential_address ?? '')); ?>" class="w-full border border-gray-200 rounded-xl px-4 py-3 focus:border-secondary outline-none">
                    </div>
                    <div>
                        <label class="text-sm text-gray-500 font-semibold mb-2 block"><?php echo e(__('Address Line 2')); ?></label>
                        <input type="text" name="address_line_2" value="<?php echo e(old('address_line_2', $profile->address_line_2 ?? '')); ?>" class="w-full border border-gray-200 rounded-xl px-4 py-3 focus:border-secondary outline-none">
                    </div>
                    <div>
                        <label class="text-sm text-gray-500 font-semibold mb-2 block"><?php echo e(__('City')); ?></label>
                        <input type="text" name="city" value="<?php echo e(old('city', $profile->city ?? '')); ?>" class="w-full border border-gray-200 rounded-xl px-4 py-3 focus:border-secondary outline-none">
                    </div>
                    <div>
                        <label class="text-sm text-gray-500 font-semibold mb-2 block"><?php echo e(__('State')); ?></label>
                        <input type="text" name="state" value="<?php echo e(old('state', $profile->state ?? '')); ?>" class="w-full border border-gray-200 rounded-xl px-4 py-3 focus:border-secondary outline-none">
                    </div>
                    <div>
                        <label class="text-sm text-gray-500 font-semibold mb-2 block"><?php echo e(__('Zip Code')); ?></label>
                        <input type="text" name="zip_code" value="<?php echo e(old('zip_code', $profile->zip_code ?? '')); ?>" class="w-full border border-gray-200 rounded-xl px-4 py-3 focus:border-secondary outline-none">
                    </div>
                    <div>
                        <label class="text-sm text-gray-500 font-semibold mb-2 block"><?php echo e(__('Country')); ?></label>
                        <input type="text" name="country" value="<?php echo e(old('country', $profile->country ?? '')); ?>" class="w-full border border-gray-200 rounded-xl px-4 py-3 focus:border-secondary outline-none">
                    </div>
                </div>
                <div class="flex justify-end gap-3">
                    <button type="button" onclick="closePersonalEditModal()" class="px-5 py-3 rounded-xl border border-gray-200 text-gray-600"><?php echo e(__('Cancel')); ?></button>
                    <button type="submit" class="px-6 py-3 rounded-xl bg-secondary text-white hover:bg-opacity-90"><?php echo e(__('Save')); ?></button>
                </div>
            </form>
        </div>
    </div>
...
<div id="removePicModal" class="fixed inset-0 bg-[#1A1A1A]/40 backdrop-blur-sm hidden z-[100] flex items-center justify-center p-4">
    <div class="bg-white rounded-[32px] w-full max-w-[340px] overflow-hidden shadow-2xl scale-95 opacity-0 transition-all duration-200" id="removePicModalContent">
        <div class="p-8 text-center">
            ...
            <h3 class="text-xl font-bold text-secondary mb-2"><?php echo e(__('Remove profile picture?')); ?></h3>
            <p class="text-gray-500 mb-6 leading-relaxed text-sm"><?php echo e(__('This will revert your avatar to the default illustration.')); ?></p>
            
            <div class="flex flex-col gap-3">
                <button type="button" onclick="confirmRemovePic()" class="w-full py-3 bg-red-500 text-white font-semibold rounded-2xl hover:bg-red-600 transition-all text-base shadow-md shadow-red-100"><?php echo e(__('Yes, remove it')); ?></button>
                <button type="button" onclick="closeRemovePicModal()" class="w-full py-3 bg-gray-50 text-gray-600 font-semibold rounded-2xl hover:bg-gray-100 transition-all text-base"><?php echo e(__('Cancel')); ?></button>
            </div>
        </div>
    </div>
</div>
...
<script>
    ...
    function performBatchUpload() {
        ...
        xhr.open('POST', '<?php echo e(route("profile.gallery.upload")); ?>', true);
    ...
    function confirmRemovePic() {
        fetch('<?php echo e(route("profile.updatePic")); ?>', {
            method: 'POST',
            headers: {
        ...
        .then(res => {
            if (res.success) {
                showToast(res.message || '<?php echo e(__("Profile picture removed.")); ?>');
                document.getElementById('user-profile-img').src = '<?php echo e(asset('frontend/assets/profile-dummy-img.png')); ?>';
            } else {
...
<?php echo $__env->make('layouts.client', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\wamp64\www\zaya\resources\views/client/profile.blade.php ENDPATH**/ ?>