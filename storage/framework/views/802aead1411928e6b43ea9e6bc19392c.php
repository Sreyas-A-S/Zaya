<?php $__env->startSection('title', 'User Managers'); ?>
        ...
        <div class="row">
            ...
            <div class="col-sm-6">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">User Managers</li>
                </ol>
            </div>
        </div>
    </div>
    ...
    <div class="card">
        ...
        <div class="card-body">
            <div class="table-responsive">
                <table class="display" id="user-managers-table">
                    <thead>
                        <tr>
                            <th>ID</th>
                            <th>Name</th>
    ...
    <div class="modal-dialog modal-lg modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="um-modal-title">Register User Manager</h5>
...
<!-- View User Manager Modal -->
<div class="modal fade" id="viewUserManagerModal" tabindex="-1">
    <div class="modal-dialog modal-xl modal-dialog-centered">
        <div class="modal-content border-0 shadow-lg">
            <div class="modal-header bg-white border-bottom-0">
                <h5 class="modal-title fw-bold">User Manager Details</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal"></button>
            </div>
                            ...
                            <div class="tab-pane fade show active" id="info-pane" role="tabpanel">
                                ...
                                <div class="row g-4 mb-4">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="fw-bold text-capitalize">User Manager</div>
                                    </div>
                                    <div class="col-md-6">
...
<script>
    ...
    $(document).ready(function() {
        ...
        let table = $('#user-managers-table').DataTable({
            processing: true,
            serverSide: true,
            ajax: "<?php echo e(route('admin.user-managers.index')); ?>",
            columns: [{
                    data: 'DT_RowIndex',
                    orderable: false,
                    searchable: false
        ...
        $('#confirmStatusBtn').click(function() {
            ...
            $.ajax({
                url: "<?php echo e(url('admin/user-managers')); ?>/" + id + "/status",
                type: 'POST',
                data: {
        ...
        $('#userManagerModal').on('hidden.bs.modal', function() {
            ...
            $('#userManagerForm').attr('action', "<?php echo e(route('admin.user-managers.store')); ?>");
        ...
        $(document).on('click', '.editUser', function() {
            let id = $(this).data('id');
            $.get("<?php echo e(url('admin/user-managers')); ?>/" + id + "/edit", function(user) {
                ...
                $('#userManagerForm').attr('action', "<?php echo e(url('admin/user-managers')); ?>/" + id);
        ...
        $(document).on('click', '.deleteUser', function() {
            if (confirm('Are you sure you want to delete this user?')) {
                let id = $(this).data('id');
                $.ajax({
                    url: "<?php echo e(url('admin/user-managers')); ?>/" + id,
                    type: 'DELETE',
                    data: {
                        _token: "<?php echo e(csrf_token()); ?>"
                    },
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\wamp64\www\zaya\resources\views\admin\user-manager\index.blade.php ENDPATH**/ ?>