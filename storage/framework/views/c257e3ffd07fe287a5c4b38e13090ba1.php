...
<?php $__env->startSection('title', 'Mindfulness Counsellors'); ?>
                                ...
                                <div class="step-content d-none" id="step-4">
                                    <div class="row g-3">
                                        <div class="col-md-6">
                                            ...
                                            <div class="row">
                                                <?php $__currentLoopData = $servicesOffered; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $service): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <div class="col-12 mb-2">
                                                    <div class="form-check checkbox-primary d-flex align-items-center w-100">
                                                        ...
                                                        <label class="form-check-label flex-grow-1 mb-0"
                                                            for="service_<?php echo e($service->id); ?>">
                                                ...
                                                <div class="col-12 mb-2">
                                                    <div class="form-check checkbox-secondary d-flex align-items-center w-100">
                                                        ...
                                                        <input class="form-check-input group-required me-2"
                                                            ...
                                                            id="concern_<?php echo e($concern->id); ?>"
                                                            data-group="concerns">

                                                        <label class="form-check-label flex-grow-1 mb-0"
                                                            for="concern_<?php echo e($concern->id); ?>">
...
<script>
    ...
    table = $('#practitioners-table').DataTable({
        ...
        serverSide: true,
        ajax: {
            url: "<?php echo e(route('admin.mindfulness-practitioners.index')); ?>",
            data: function(d) {
    ...
    $('#practitioner-form').on('submit', function(e) {
        ...
        let url = id ? "<?php echo e(url('admin/mindfulness-practitioners')); ?>/" + id : "<?php echo e(route('admin.mindfulness-practitioners.store')); ?>";
    ...
    $('body').on('click', '.editPractitioner', function() {
        ...
        $.get("<?php echo e(url('admin/mindfulness-practitioners')); ?>/" + id + "/edit", function(response) {
            let u = response.user;
    ...
    $('#confirm-delete-btn').click(function() {
        ...
        $.ajax({
            url: "<?php echo e(url('admin/mindfulness-practitioners')); ?>/" + id,
            type: 'DELETE',
            data: {
                _token: '<?php echo e(csrf_token()); ?>'
            },
    ...
    $('body').on('click', '.viewPractitioner', function() {
        let id = $(this).data('id');
        $.get("<?php echo e(url('admin/mindfulness-practitioners')); ?>/" + id, function(response) {
            let u = response.user;
            let p = response.practitioner;
    ...
    $(document).off('click', '#confirm-status-btn').on('click', '#confirm-status-btn', function() {
        ...
        $.ajax({
            url: "<?php echo e(url('admin/mindfulness-practitioners')); ?>/" + id + "/status",
            type: 'POST',
            data: {
                _token: '<?php echo e(csrf_token()); ?>',
                status: newStatus
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\wamp64\www\zaya\resources\views/admin/mindfulness_practitioners/index.blade.php ENDPATH**/ ?>