<?php $__env->startSection('title', 'Manage ' . $title); ?>
...
<script>
    ...
    $(document).ready(function() {
        table = $('#master-table').DataTable({
            processing: true,
            serverSide: true,
            ajax: "<?php echo e(route('admin.master-data.index', $type)); ?>",
            columns: [{
                    data: 'DT_RowIndex',
                    name: 'DT_RowIndex',
                    orderable: false,
        ...
        $('#item-form').on('submit', function(e) {
            ...
            const url = id ? "<?php echo e(url('admin/master-data')); ?>/<?php echo e($type); ?>/" + id : "<?php echo e(route('admin.master-data.store', $type)); ?>";
        ...
        $('#confirm-status-btn').on('click', function() {
            ...
            $.ajax({
                url: "<?php echo e(url('admin/master-data')); ?>/<?php echo e($type); ?>/" + id + "/status",
                type: 'POST',
                data: {
        ...
        $('body').on('click', '.deleteItem', function() {
            if (confirm("Are you sure you want to delete this item?")) {
                const id = $(this).data('id');
                $.ajax({
                    url: "<?php echo e(url('admin/master-data')); ?>/<?php echo e($type); ?>/" + id,
                    type: 'DELETE',
                    data: {
                        _token: "<?php echo e(csrf_token()); ?>"
                    },
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\wamp64\www\zaya\resources\views\admin\master_data\index.blade.php ENDPATH**/ ?>