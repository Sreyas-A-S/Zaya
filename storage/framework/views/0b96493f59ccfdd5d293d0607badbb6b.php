        ...
        <div class="consultation-tab-panels">
            <div data-tab-panel="assessment" class="consultation-tab-panel space-y-6 is-active" id="tab-assessment">
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                    <div class="bg-[#F9FBFA] rounded-2xl border border-[#2E4B3D]/10 p-5 shadow-sm">
                        ...
                        <textarea name="presenting_concerns" rows="7" class="w-full rounded-xl border border-gray-200 px-4 py-3 text-sm" placeholder="Stress, anxiety, sleep, emotions, focus"><?php echo e(data_get($payload, 'presenting_concerns')); ?></textarea>
                    </div>
                    <div class="bg-[#F9FBFA] rounded-2xl border border-[#2E4B3D]/10 p-5 shadow-sm">
                        <h2 class="text-lg font-bold text-secondary mb-4">Mental / Emotional State</h2>
                        <textarea name="mental_state" rows="7" class="w-full rounded-xl border border-gray-200 px-4 py-3 text-sm" placeholder="Mood, fear, confusion, confidence, stress"><?php echo e(data_get($payload, 'mental_state')); ?></textarea>
                    </div>
                </div>
            </div>
            ...
            <div data-tab-panel="lifestyle" class="consultation-tab-panel space-y-6" id="tab-lifestyle">
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                    <div class="bg-white rounded-2xl border border-[#2E4B3D]/10 p-5 shadow-sm">
                        ...
                        <textarea name="sleep_rhythm" rows="7" class="w-full rounded-xl border border-gray-200 px-4 py-3 text-sm" placeholder="Bedtime, wake time, sleep quality, naps, awakenings"><?php echo e(data_get($payload, 'sleep_rhythm')); ?></textarea>
                    </div>
                    <div class="bg-white rounded-2xl border border-[#2E4B3D]/10 p-5 shadow-sm">
                        <h2 class="text-lg font-bold text-secondary mb-4">Mindfulness Practices</h2>
                        <textarea name="mindfulness_practices" rows="7" class="w-full rounded-xl border border-gray-200 px-4 py-3 text-sm" placeholder="Breathing, meditation, journaling, routine"><?php echo e(data_get($payload, 'mindfulness_practices')); ?></textarea>
                    </div>
                </div>
            </div>
            ...
            <div data-tab-panel="plan" class="consultation-tab-panel space-y-6" id="tab-plan">
                <div class="bg-[#F9FBFA] rounded-2xl border border-[#2E4B3D]/10 p-5 shadow-sm">
                    ...
                    <textarea name="follow_up_goals" rows="8" class="w-full rounded-xl border border-gray-200 px-4 py-3 text-sm" placeholder="Goals, next review, next actions"><?php echo e(data_get($payload, 'follow_up_goals')); ?></textarea>
                </div>
...
<?php /**PATH C:\wamp64\www\zaya\resources\views\consultation-forms\mindfulness_practitioner.blade.php ENDPATH**/ ?>