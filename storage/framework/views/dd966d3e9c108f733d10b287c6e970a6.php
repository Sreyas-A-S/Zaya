                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <select name="country[]" id="edit_country" class="form-control select2 w-100" multiple required>
                                <?php $__currentLoopData = $countries; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $country): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($country->id); ?>" data-flag="<?php echo e(strtolower($country->code)); ?>">
...
<script>
    ...
    $(document).ready(function() {
        ...
        const table = $('#Admins-table').DataTable({
            ...
            serverSide: true,
            ajax: {
                url: "<?php echo e(route('admin.admins.index')); ?>",
                data: function(d) {
        ...
        $('#adminModal').on('hidden.bs.modal', function() {
            ...
            $('#adminForm').attr('action', "<?php echo e(route('admin.admins.store')); ?>");
    ...
    $(document).on('click', '.editUser', function() {
        let id = $(this).data('id');
        $.get("<?php echo e(url('admin/admins')); ?>/" + id + "/edit", function(user) {
            ...
            $('#adminForm').attr('action', "<?php echo e(url('admin/admins')); ?>/" + id);
    ...
    $(document).off('click', '#confirm-status-btn').on('click', '#confirm-status-btn', function() {
        ...
        $.ajax({
            url: "<?php echo e(url('admin/admins')); ?>/" + id + "/status",
            type: 'POST',
            data: {
    ...
    $(document).on('click', '.deleteUser', function() {
        ...
        if (confirm('Are you sure?')) {
            $.ajax({
                url: "<?php echo e(url('admin/admins')); ?>/" + id,
                type: 'DELETE',
                data: {
                    _token: "<?php echo e(csrf_token()); ?>"
                },
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\wamp64\www\zaya\resources\views\admin\admins\index.blade.php ENDPATH**/ ?>