...
<body>
    <div class="container">
        ...
        <div class="content">
            ...
            <p>Hello <?php echo e($referral->user->name); ?>,</p>
            <p>We are writing to inform you that you are being referred to a new specialist by your current practitioner.</p>
            <p><strong><?php echo e($referral->referredBy->name); ?></strong> has recommended <strong><?php echo e($referral->referredTo->name); ?></strong> for a specialized session to further support your wellness journey.</p>

            <div class="referral-card">
                <div class="practitioner-info">
                    <div>
                        <span class="label">Referred To:</span>
                        <span class="value"><?php echo e($referral->referredTo->name); ?></span>
                        <a href="<?php echo e($referral->referredTo->profile_url); ?>" style="color: #97563D; font-size: 12px; font-weight: 700; text-decoration: underline; margin-top: 5px; display: inline-block;">View Profile</a>
                    </div>
                </div>
                <div style="margin-top: 15px; border-top: 1px solid #edf2f7; padding-top: 15px;">
                    <span class="label">Session Amount:</span>
                    <span class="value">€ <?php echo e(number_format($referral->amount, 2)); ?></span>
                </div>
            </div>

            <p>To confirm this referral and schedule your session, please complete the payment using the secure link below:</p>

            <a href="<?php echo e($payUrl); ?>" class="button">Accept Referral & Pay</a>
            
            <p style="font-size: 13px; color: #94a3b8; margin-top: 30px;">
                Reference ID: <?php echo e($referral->referral_no); ?>
...
<?php /**PATH C:\wamp64\www\zaya\resources\views\emails\referral-invitation.blade.php ENDPATH**/ ?>