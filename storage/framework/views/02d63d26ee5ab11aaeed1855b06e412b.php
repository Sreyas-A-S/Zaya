...
<head>
    ...
    <?php echo app('Illuminate\Foundation\Vite')(['resources/css/app.css', 'resources/css/practitioner-register.css', 'resources/js/app.js', 'resources/js/country-selector.js']); ?>
    ...
    <div class="flex-1 relative">
        <div class="container mx-auto px-4 py-8 md:py-12 lg:py-16">
            ...
            <div class="text-center mb-8 md:mb-12">
                <h1 class="text-2xl md:text-3xl lg:text-4xl font-serif font-bold text-primary mb-6"><?php echo e(__('Elevate Your Practice. Join the ZAYA Collective')); ?></h1>
                <p class="text-gray-500 text-sm md:text-base max-w-2xl mx-auto">
                    <?php echo e(__('Become a part of a specialized ecosystem where tradition meets technology. Complete your registration to showcase your expertise, manage your global clientele and help us redefine holistic wellness.')); ?>

                </p>
            </div>

            <!-- Form Title -->
            <h2 class="text-xl md:text-2xl font-sans! font-medium text-center text-gray-900 mb-8"><?php echo e(__('Practitioner Registration Form')); ?></h2>
                ...
                <div class="flex items-start justify-center gap-0" id="step-indicator">
                    <div class="flex flex-col items-center relative z-[2]">
                        ...
                        <span class="text-sm lg:text-base text-gray-700 mt-2.5 font-normal whitespace-nowrap"
                            id="step-label-1"><?php echo e(__('Basic Details')); ?></span>
                    </div>
                    ...
                    <div class="flex flex-col items-center relative z-[2]">
                        ...
                        <span class="text-sm lg:text-base text-gray-400 mt-2.5 font-normal whitespace-nowrap"
                            id="step-label-2"><?php echo e(__('Qualifications')); ?></span>
                    </div>
                    <div class="w-[60px] md:w-[100px] xl:w-[140px] h-0 border-t-2 border-dashed border-[#C0C0C0] self-center -mt-7 relative"
                        id="step-line-2"></div>
                    <div class="flex flex-col items-center relative z-[2]">
                        ...
                        <span class="text-sm lg:text-base text-gray-400 mt-2.5 font-normal whitespace-nowrap"
                            id="step-label-3"><?php echo e(__('Verification')); ?></span>
                    </div>
                </div>
            </div>
            ...
            <form action="<?php echo e(route('register')); ?>" method="POST" enctype="multipart/form-data" class="max-w-5xl mx-auto"
                ...
                <div class="block" id="tab-1">
                    <h3 class="text-2xl font-sans! font-normal text-gray-900 mb-10"><?php echo e(__('Basic Details')); ?></h3>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
                        ...
                        <div class="flex flex-col items-center order-first md:order-last">
                            ...
                            <span class="text-gray-500 text-sm mt-2"><?php echo e(__('Add Photo')); ?></span>
                        </div>
                    </div>

                    <!-- Gender -->
                    <div class="mb-8">
                        <label class="block text-gray-700 font-normal mb-4 text-lg"><?php echo e(__('Gender')); ?></label>
                        <div class="flex flex-wrap gap-6">
                            <label class="gender-radio flex items-center gap-2 cursor-pointer">
                                <input type="radio" name="gender" value="male">
                                <span class="text-gray-700"><?php echo e(__('Male')); ?></span>
                            </label>
                            <label class="gender-radio flex items-center gap-2 cursor-pointer">
                                <input type="radio" name="gender" value="female" checked>
                                <span class="text-gray-700"><?php echo e(__('Female')); ?></span>
                            </label>
                            <label class="gender-radio flex items-center gap-2 cursor-pointer">
                                <input type="radio" name="gender" value="other">
                                <span class="text-gray-700"><?php echo e(__('Other')); ?></span>
                            </label>
                        </div>
                    </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
                        ...
                        <div>
                            <label class="block text-gray-700 font-normal mb-4 text-lg"><?php echo e(__('Phone No.')); ?></label>
                            <input type="tel" name="phone" id="phone" value="<?php echo e(old('phone')); ?>"
                                maxlength="15" oninput="this.value = this.value.replace(/[^0-9]/g, '')"
                                class="w-full py-3.5 px-6 bg-[#F5F5F5] rounded-full border border-transparent outline-none text-[0.95rem] text-gray-700 transition-all duration-300 placeholder:text-gray-400 focus:border-[#97563D] focus:bg-white focus:shadow-[0_0_0_3px_rgba(151,86,61,0.1)]"
                                placeholder="<?php echo e(__('Enter Phone No.')); ?>" required>
                        </div>
                    </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
                        <div>
                            <label class="block text-gray-700 font-normal mb-4 text-lg"><?php echo e(__('DOB')); ?></label>
                            <input type="date" name="dob" value="<?php echo e(old('dob')); ?>"
                                max="<?php echo e(now()->format('Y-m-d')); ?>"
                                class="w-full py-3.5 px-6 bg-[#F5F5F5] rounded-full border border-transparent outline-none text-[0.95rem] text-gray-700 transition-all duration-300 placeholder:text-gray-400 focus:border-[#97563D] focus:bg-white focus:shadow-[0_0_0_3px_rgba(151,86,61,0.1)]"
                                placeholder="<?php echo e(__('DD/MM/YYYY')); ?>" required>
                        </div>
                        <div>
                            <label class="block text-gray-700 font-normal mb-4 text-lg"><?php echo e(__('Country')); ?></label>
                            <select id="country-select" name="country"
                                data-default="<?php echo e(old('country', 'IN')); ?>" required>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
                        ...
                        <div>
                            <label class="block text-gray-700 font-normal mb-4 text-lg"><?php echo e(__('Website')); ?> <span class="text-gray-400 italic"><?php echo e(__('(if any)')); ?></span></label>
                            <input type="url" name="website_url" value="<?php echo e(old('website_url')); ?>"
                                class="w-full py-3.5 px-6 bg-[#F5F5F5] rounded-full border border-transparent outline-none text-[0.95rem] text-gray-700 transition-all duration-300 placeholder:text-gray-400 focus:border-[#97563D] focus:bg-white focus:shadow-[0_0_0_3px_rgba(151,86,61,0.1)]"
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
                        ...
                        <div>
                            ...
                            <input type="text" name="state" value="<?php echo e(old('state')); ?>"
                                pattern="^[A-Za-z\s]+$" title="Only alphabets and spaces are allowed"
                                class="w-full py-3.5 px-6 bg-[#F5F5F5] rounded-full border border-transparent outline-none text-[0.95rem] text-gray-700 transition-all duration-300 placeholder:text-gray-400 focus:border-[#97563D] focus:bg-white focus:shadow-[0_0_0_3px_rgba(151,86,61,0.1)]"
                                placeholder="<?php echo e(__('Enter State')); ?>" required>
                        </div>
                        <div>
                            <label class="block text-gray-700 font-normal mb-4 text-lg"><?php echo e(__('Zip Code')); ?></label>
                            <input type="text" name="zip_code" value="<?php echo e(old('zip_code')); ?>"
                                pattern="^[A-Za-z0-9\s\-]{4,10}$" title="Enter a valid zip code (4-10 characters)"
                                class="w-full py-3.5 px-6 bg-[#F5F5F5] rounded-full border border-transparent outline-none text-[0.95rem] text-gray-700 transition-all duration-300 placeholder:text-gray-400 focus:border-[#97563D] focus:bg-white focus:shadow-[0_0_0_3px_rgba(151,86,61,0.1)]"
                                placeholder="<?php echo e(__('Enter Zip Code')); ?>" required>
                        </div>
                    </div>
                </div>
                ...
                <div class="hidden" id="tab-2">
                    ...
                    <div class="flex justify-between items-center mb-6">
                        <h3 class="text-2xl font-sans! font-medium text-gray-900"><?php echo e(__('Education')); ?></h3>
                        <button type="button"
                            ...
                            <i class="ri-add-line text-lg"></i><?php echo e(__('Add Another Education')); ?></button>
                    </div>
                    ...
                    <div id="education-container">
                        <div class="bg-[#F6F6F6] rounded-[24px] py-10 px-6 md:px-12 mb-8 education-block" id="education-block-0">
                            ...
                            <div class="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-8">
                                <div>
                                    <label class="block text-[#525252] text-lg font-normal mb-3"><?php echo e(__('Education Type')); ?></label>
                                    <div class="custom-select-wrapper w-full">
                                        <div class="custom-select" id="education-type-select-0">
                                            <div class="custom-select-trigger cursor-pointer">
                                                <span id="education-type-selected-0"><?php echo e(__('Select')); ?></span>
                                                <i class="ri-arrow-down-s-line arrow text-gray-400"></i>
                                            </div>
                                            <div class="custom-options">
                                                <div class="custom-option" data-value="degree"><?php echo e(__('Degree')); ?></div>
                                                <div class="custom-option" data-value="diploma"><?php echo e(__('Diploma')); ?></div>
                                                <div class="custom-option" data-value="certification"><?php echo e(__('Certification')); ?></div>
                                            </div>
                                        </div>
                                ...
                                <div>
                                    <label class="block text-[#525252] text-lg font-normal mb-3"><?php echo e(__('Institution Name')); ?></label>
                                    <input type="text" name="education[0][institution]"
                                        ...
                                        placeholder="<?php echo e(__('Enter Institution Name')); ?>" required>
                                </div>
                                <div>
                                    <label class="block text-[#525252] text-lg font-normal mb-3"><?php echo e(__('Duration')); ?><span
                                            class="italic text-[#737373] text-[1rem] font-normal"><?php echo e(__('(Hours/Years)')); ?></span></label>
                                    <div class="flex gap-3">
                                        <input type="number" min="0" step="0.1" name="education[0][duration]"
                                            class="w-full py-3.5 px-6 bg-white rounded-full border border-transparent outline-none text-[0.95rem] text-gray-700 transition-all duration-300 placeholder:text-[#A3A3A3] focus:border-[#97563D] focus:shadow-[0_0_0_3px_rgba(151,86,61,0.1)]"
                                            placeholder="<?php echo e(__('Enter Duration')); ?>" required>
                            ...
                            <div class="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-8">
                                <div>
                                    <label class="block text-[#525252] text-lg font-normal mb-3"><?php echo e(__('Address Line 1')); ?></label>
                                    <input type="text" name="education[0][address_line_1]"
                                        class="w-full py-3.5 px-6 bg-white rounded-full border border-transparent outline-none text-[0.95rem] text-gray-700 transition-all duration-300 placeholder:text-[#A3A3A3] focus:border-[#97563D] focus:shadow-[0_0_0_3px_rgba(151,86,61,0.1)]"
                                        placeholder="<?php echo e(__('Address Line 1')); ?>">
                                </div>
                                <div>
                                    <label class="block text-[#525252] text-lg font-normal mb-3"><?php echo e(__('Address Line 2')); ?></label>
                            ...
                            <div class="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-12">
                                <div>
                                    <label class="block text-[#525252] text-lg font-normal mb-3"><?php echo e(__('City')); ?></label>
                                    <input type="text" name="education[0][city]"
                                        class="w-full py-3.5 px-6 bg-white rounded-full border border-transparent outline-none text-[0.95rem] text-gray-700 transition-all duration-300 placeholder:text-[#A3A3A3] focus:border-[#97563D] focus:shadow-[0_0_0_3px_rgba(151,86,61,0.1)]"
                                        placeholder="<?php echo e(__('Enter City')); ?>">
                                </div>
                                <div>
                                    <label class="block text-[#525252] text-lg font-normal mb-3"><?php echo e(__('State')); ?></label>
                                    <input type="text" name="education[0][state]"
                                        class="w-full py-3.5 px-6 bg-white rounded-full border border-transparent outline-none text-[0.95rem] text-gray-700 transition-all duration-300 placeholder:text-[#A3A3A3] focus:border-[#97563D] focus:shadow-[0_0_0_3px_rgba(151,86,61,0.1)]"
                                        placeholder="<?php echo e(__('Enter State')); ?>">
                                </div>
                                <div class="education-country-wrapper">
                                    <label class="block text-[#525252] text-lg font-normal mb-3"><?php echo e(__('Country')); ?></label>
                    ...
                    <div class="mb-8">
                        <h3 class="text-2xl font-medium text-gray-900 mb-4"><?php echo e(__('Professional Bio')); ?></h3>
                        <textarea name="professional_bio"
                            ...
                            placeholder="<?php echo e(__('Write your Professional Bio...')); ?>"></textarea>
                    </div>

                    <!-- Professional Practice Details -->
                    <div class="mb-8">
                        <h3 class="text-2xl font-medium text-gray-900 mb-6"><?php echo e(__('Professional Practice Details')); ?></h3>

                        <!-- Ayurvedic Wellness Consultation -->
                        <div class="mb-8 practice-group" data-input="ayurvedic-input">
                            <h4 class="font-medium text-gray-900 mb-4 text-xl"><?php echo e(__('Ayurvedic Wellness Consultation:')); ?></h4>
                            <p class="text-gray-700 text-lg mb-4"><?php echo e(__('Focuses on nutritional and lifestyle guidance rooted in Ayurvedic principles:')); ?></p>
                            <input type="text" name="ayurvedic_practices_custom" id="ayurvedic-input"
                                ...
                                placeholder="<?php echo e(__('Choose your practice areas')); ?>">
                            <div class="flex flex-wrap gap-4">
                                <?php $__currentLoopData = $wellnessConsultations; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $consultation): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <?php if(strtolower($consultation->name) !== 'other'): ?>
                                <label
                                    ...
                                    <input type="checkbox" name="ayurvedic_practices[]" value="<?php echo e($consultation->name); ?>" class="sr-only">
                                ...
                                <label
                                    class="practice-tag select-none inline-flex items-center py-2 px-4 border border-gray-200 rounded-full text-base text-gray-700 cursor-pointer transition-all duration-200 bg-white hover:border-[#FABD4D] hover:bg-[#FABD4D] hover:text-[#423131] focus-within:ring-2 focus-within:ring-[#FABD4D] focus-within:ring-offset-1">
                                    <input type="checkbox" name="ayurvedic_practices[]" value="other" class="sr-only other-checkbox" onchange="toggleOtherInput(this, 'ayurvedic-other-text')"><?php echo e(__('Other')); ?></label>
                            </div>
                            <div id="ayurvedic-other-text" class="hidden mt-4">
                                <input type="text" name="ayurvedic_practices_other" class="w-full py-3.5 px-6 bg-white rounded-full border border-gray-200 outline-none focus:border-[#97563D] focus:shadow-[0_0_0_3px_rgba(151,86,61,0.1)] text-[0.95rem]" placeholder="<?php echo e(__('Please specify other practice area')); ?>">
                            </div>
                        </div>

                        <!-- Massage & Body Therapists -->
                        <div class="mb-8 practice-group" data-input="massage-input">
                            <h4 class="text-xl font-medium text-gray-900 mb-4"><?php echo e(__('Massage & Body Therapists:')); ?></h4>
                            <p class="text-gray-700 text-lg mb-4"><?php echo e(__('Includes specific traditional physical treatments and specialized care:')); ?></p>
                            <input type="text" name="massage_practices_custom" id="massage-input"
                                class="w-full py-3.5 px-6 bg-[#F5F5F5] rounded-full border border-transparent outline-none text-[0.95rem] text-gray-700 transition-all duration-300 placeholder:text-gray-400 focus:border-[#97563D] focus:bg-white focus:shadow-[0_0_0_3px_rgba(151,86,61,0.1)] mb-4 cursor-default"
                                placeholder="<?php echo e(__('Choose your practice areas')); ?>">
                            <div class="flex flex-wrap gap-4">
                                <?php $__currentLoopData = $bodyTherapies; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $bodyTherapy): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <?php if(strtolower($bodyTherapy->name) !== 'other'): ?>
                                <label
                                    class="practice-tag select-none inline-flex items-center py-2 px-4 border border-gray-200 rounded-full text-base text-gray-700 cursor-pointer transition-all duration-200 bg-white hover:border-[#FABD4D] hover:bg-[#FABD4D] hover:text-[#423131] focus-within:ring-2 focus-within:ring-[#FABD4D] focus-within:ring-offset-1">
                                    <input type="checkbox" name="massage_practices[]" value="<?php echo e($bodyTherapy->name); ?>" class="sr-only">
                                    <?php echo e($bodyTherapy->name); ?>
                                ...
                                <label
                                    class="practice-tag select-none inline-flex items-center py-2 px-4 border border-gray-200 rounded-full text-base text-gray-700 cursor-pointer transition-all duration-200 bg-white hover:border-[#FABD4D] hover:bg-[#FABD4D] hover:text-[#423131] focus-within:ring-2 focus-within:ring-[#FABD4D] focus-within:ring-offset-1">
                                    <input type="checkbox" name="massage_practices[]" value="other" class="sr-only other-checkbox" onchange="toggleOtherInput(this, 'massage-other-text')"><?php echo e(__('Other')); ?></label>
                            </div>
                            <div id="massage-other-text" class="hidden mt-4">
                                <input type="text" name="massage_practices_other" class="w-full py-3.5 px-6 bg-white rounded-full border border-gray-200 outline-none focus:border-[#97563D] focus:shadow-[0_0_0_3px_rgba(151,86,61,0.1)] text-[0.95rem]" placeholder="<?php echo e(__('Please specify other therapy')); ?>">
                            </div>
                        </div>

                        <!-- Other Modalities -->
                        <div class="mb-8 practice-group" data-input="modalities-input">
                            <h4 class="text-xl font-medium text-gray-900 mb-4"><?php echo e(__('Other Modalities:')); ?></h4>
                            <input type="text" name="other_modalities_custom" id="modalities-input"
                                class="w-full py-3.5 px-6 bg-[#F5F5F5] rounded-full border border-transparent outline-none text-[0.95rem] text-gray-700 transition-all duration-300 placeholder:text-gray-400 focus:border-[#97563D] focus:bg-white focus:shadow-[0_0_0_3px_rgba(151,86,61,0.1)] mb-4 cursor-default"
                                placeholder="<?php echo e(__('Choose your practice areas')); ?>">
                            <div class="flex flex-wrap gap-4">
                                <?php $__currentLoopData = $otherModalities; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $modality): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <?php if(strtolower($modality->name) !== 'other'): ?>
                                <label
                                    class="practice-tag select-none inline-flex items-center py-2 px-4 border border-gray-200 rounded-full text-base text-gray-700 cursor-pointer transition-all duration-200 bg-white hover:border-[#FABD4D] hover:border-[#FABD4D] hover:text-[#423131] focus-within:ring-2 focus-within:ring-[#FABD4D] focus-within:ring-offset-1">
                                    <input type="checkbox" name="other_modalities[]" value="<?php echo e($modality->name); ?>" class="sr-only">
                                ...
                                <label
                                    class="practice-tag select-none inline-flex items-center py-2 px-4 border border-gray-200 rounded-full text-base text-gray-700 cursor-pointer transition-all duration-200 bg-white hover:border-[#FABD4D] hover:bg-[#FABD4D] hover:text-[#423131] focus-within:ring-2 focus-within:ring-[#FABD4D] focus-within:ring-offset-1">
                                    <input type="checkbox" name="other_modalities[]" value="other" class="sr-only other-checkbox" onchange="toggleOtherInput(this, 'modalities-other-text')"><?php echo e(__('Other')); ?></label>
                            </div>
                            <div id="modalities-other-text" class="hidden mt-4">
                                <input type="text" name="other_modalities_other" class="w-full py-3.5 px-6 bg-white rounded-full border border-gray-200 outline-none focus:border-[#97563D] focus:shadow-[0_0_0_3px_rgba(151,86,61,0.1)] text-[0.95rem]" placeholder="<?php echo e(__('Please specify other modality')); ?>">
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="hidden" id="tab-3">
                    <!-- Add Summary -->
                    <div class="mb-8">
                        <h3 class="text-2xl font-medium text-gray-900 mb-4"><?php echo e(__('Add Summary')); ?></h3>
                        <textarea name="summary"
                            class="w-full py-4 px-5 bg-[#F5F5F5] rounded-2xl outline-none text-[0.95rem] text-gray-700 transition-all duration-300 min-h-[200px] resize-y placeholder:text-gray-400 focus:border-[#97563D] focus:shadow-[0_0_0_3px_rgba(151,86,61,0.1)]"
                            placeholder="<?php echo e(__('E.g Outline your background in Ayurveda, yoga, sports or holistic wellness')); ?>"></textarea>
                    </div>

                    <!-- Certifications -->
                    <div class="flex justify-between items-center mb-4">
                        <div>
                            <h3 class="text-2xl font-medium text-gray-900"><?php echo e(__('Certifications')); ?><span class="text-gray-500 text-lg font-normal italic"><?php echo e(__('(Kindly include hours and dates. It should be self-attested)')); ?></span>
                            </h3>
                        </div>
                        <button type="button"
                            class="text-secondary text-lg font-medium hover:text-primary cursor-pointer"
                            onclick="addCertification()"><?php echo e(__('+ Add More Certificates')); ?></button>
                    </div>
                    ...
                    <div id="certification-container">
                        <div class="bg-[#F5F5F5] rounded-xl mb-6 certification-block" id="certification-block-0">
                            <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mb-4 p-10">
                                <div>
                                    <label class="block text-gray-600 text-lg mb-4"><?php echo e(__('ID Proof')); ?></label>
                                ...
                                <div>
                                    <label class="block text-gray-600 text-lg mb-4"><?php echo e(__('Training / Diploma')); ?></label>
                                    <div class="upload-box rounded-xl p-5 text-center cursor-pointer transition-all duration-300 bg-white hover:bg-[#FFECC8]">
                                        <div class="inline-flex justify-center items-center gap-2 border border-[#D8D8D8] rounded-[6px] px-4 py-2 mb-3">
                                            <i class="ri-upload-2-line text-gray-400 text-sm leading-none"></i>
                                            <p class="text-gray-500 text-sm leading-none"><?php echo e(__('Upload')); ?></p>
                                ...
                                <div>
                                    <label class="block text-gray-600 text-lg mb-4"><?php echo e(__('Experience')); ?><span class="text-gray-400"><?php echo e(__('(if any)')); ?></span></label>
                                    <div class="upload-box rounded-xl p-5 text-center cursor-pointer transition-all duration-300 bg-white hover:bg-[#FFECC8]">
                                        <div class="inline-flex justify-center items-center gap-2 border border-[#D8D8D8] rounded-[6px] px-4 py-2 mb-3">
                                            <i class="ri-upload-2-line text-gray-400 text-sm leading-none"></i>
                                            <p class="text-gray-500 text-sm leading-none"><?php echo e(__('Upload')); ?></p>
                    ...
                    <div class="bg-[#F5F5F5] rounded-xl mb-6">
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-4 px-10 pt-10">
                            <div>
                                <label class="block text-gray-600 mb-4 text-lg"><?php echo e(__('Registration Form')); ?></label>
                                <div class="upload-box rounded-xl p-5 text-center cursor-pointer transition-all duration-300 bg-white hover:bg-[#FFECC8]">
                                    <div class="inline-flex justify-center items-center gap-2 border border-[#D8D8D8] rounded-[6px] px-4 py-2 mb-3">
                                        <i class="ri-upload-2-line text-gray-400 text-sm leading-none"></i>
                                        <p class="text-gray-500 text-sm leading-none"><?php echo e(__('Upload')); ?></p>
                            ...
                            <div>
                                <label class="block text-gray-700  mb-4 text-lg"><?php echo e(__('Code of Ethics')); ?></label>
                                <div class="upload-box rounded-xl p-5 text-center cursor-pointer transition-all duration-300 bg-white hover:bg-[#FFECC8]">
                                    <div class="inline-flex justify-center items-center gap-2 border border-[#D8D8D8] rounded-[6px] px-4 py-2 mb-3">
                                        <i class="ri-upload-2-line text-gray-400 text-sm leading-none"></i>
                                        <p class="text-gray-500 text-sm leading-none"><?php echo e(__('Upload')); ?></p>
                            ...
                            <div>
                                <label class="block text-gray-700  mb-4 text-lg"><?php echo e(__('Wellness Contract')); ?></label>
                                <div class="upload-box rounded-xl p-5 text-center cursor-pointer transition-all duration-300 bg-white hover:bg-[#FFECC8]">
                                    <div class="inline-flex justify-center items-center gap-2 border border-[#D8D8D8] rounded-[6px] px-4 py-2 mb-3">
                                        <i class="ri-upload-2-line text-gray-400 text-sm leading-none"></i>
                                        <p class="text-gray-500 text-sm leading-none"><?php echo e(__('Upload')); ?></p>
                        ...
                        <!-- Upload Cover Letter -->
                        <div class="p-10">
                            <label class="block text-gray-700  mb-4 text-lg"><?php echo e(__('Upload Cover Letter')); ?></label>
                            <div class="upload-box rounded-xl py-8 px-4 text-center cursor-pointer transition-all duration-300 bg-white hover:bg-[#FFECC8]">
                                ...
                                <p class="text-gray-500 text-sm"><?php echo e(__('Choose Images or documents')); ?></p>
                                <p class="text-gray-400 text-xs file-name-display"><?php echo e(__('JPG, JPEG, PNG, WEBP, DOC & PDF (Max.20MB)')); ?></p>
                    ...
                    <!-- Languages Known -->
                    <div class="mb-12">
                        <h3 class="text-2xl font-medium text-gray-900 mb-8"><?php echo e(__('Languages Known')); ?></h3>
                            ...
                            <div class="w-full lg:w-[45%]">
                                ...
                                <div class="flex flex-wrap gap-8 pl-4">
                                    <label class="custom-radio-checkbox flex items-center gap-2 cursor-pointer group">
                                        ...
                                        <span
                                            class="text-[#A3A3A3] text-base transition-colors duration-200 label-text font-normal"><?php echo e(__('Read')); ?></span>
                                    </label>
                                    <label class="custom-radio-checkbox flex items-center gap-2 cursor-pointer group">
                                        ...
                                        <span
                                            class="text-[#A3A3A3] text-base transition-colors duration-200 label-text font-normal"><?php echo e(__('Write')); ?></span>
                                    </label>
                                    <label class="custom-radio-checkbox flex items-center gap-2 cursor-pointer group">
                                        ...
                                        <span
                                            class="text-[#A3A3A3] text-base transition-colors duration-200 label-text font-normal"><?php echo e(__('Speak')); ?></span>
                                    </label>
                                </div>
                            </div>
                    ...
                    <?php if($practitionerRegistrationFeeEnabled): ?>
                        <div class='mb-12 border-t border-[#E5E5E5] pt-12'>
                            <div class='grid grid-cols-1 md:grid-cols-2 gap-8 lg:gap-12 mb-12'>
                                <div>
                                    <label class='block text-gray-800 text-lg font-medium mb-4'><?php echo e(__('Registration Fee Amount')); ?></label>
                                    <div class='relative w-full'>
                                        <div class='w-full h-[58px] bg-[#F5F5F5] rounded-full flex items-center pl-8 pr-2' data-registration-fee-container>
                                            ...
                                            <input type='hidden' name='registration_fee' value='<?php echo e(number_format($practitionerRegistrationFee ?? 0, 2, '.', '')); ?>'>
                                            <input type='hidden' name='registration_fee_actual' value='<?php echo e(number_format($practitionerRegistrationFee ?? 0, 2, '.', '')); ?>'>
                                            <button type='button' class='absolute right-2 top-1/2 -translate-y-1/2 bg-[#FABC41] text-[#423131] px-8 py-2.5 rounded-full text-[0.95rem] transition-all duration-300 hover:bg-[#E8AA32] border-none cursor-pointer'><?php echo e(__('Pay')); ?></button>
                                        </div>
                                    </div>
                                </div>

                                <div>
                                    <label class='block text-gray-800 text-lg font-medium mb-4'><?php echo e(__('Promocode')); ?></label>
                                    <div class='relative w-full'>
                                        ...
                                        <button type='button' id='promo-apply-btn' class='absolute right-2 top-1/2 -translate-y-1/2 bg-[#FABC41] text-[#423131] px-7 py-2.5 rounded-full text-[0.95rem] transition-all duration-300 hover:bg-[#E8AA32] border-none cursor-pointer'><?php echo e(__('Apply')); ?></button>
                                    </div>
                                </div>
                            ...
                            <div class='bg-gradient-to-r from-[#FFFFFF] via-[#F0F0F0] to-[#FFFFFF] p-12 flex flex-col items-center justify-center'>
                                <h3 class='text-xl font-medium text-gray-800 mb-6'><?php echo e(__('Captcha Verification')); ?></h3>
                                <div class='flex items-center justify-center gap-3'>
                                    ...
                                    <input type='text' name='captcha' placeholder='<?php echo e(__('Enter Code')); ?>' class='h-[48px] w-[140px] px-4 bg-white rounded-lg border border-[#D1D5DB] outline-none text-[0.95rem] text-gray-700 transition-all duration-300 placeholder:text-[#A3A3A3] focus:border-[#1B5CB8] focus:shadow-[0_0_0_3px_rgba(27,92,184,0.1)]' required>
                                </div>
...
unset($__errorArgs, $__bag); ?>
        ...
        <div class="container mx-auto px-4">
            <div class="max-w-5xl mx-auto flex items-center justify-end gap-4 md:gap-8">
                <button type="button"
                    ...
                    <span id="back-btn-text"><?php echo e(__('← Back to Website')); ?></span>
                </button>
                <button type="button"
                    ...
                    <span id="next-btn-text"><?php echo e(__('Save & Continue')); ?></span>
                </button>
            </div>
        </div>
    </footer>
    ...
    <div id="thank-you-popup" class="fixed inset-0 bg-black/40 z-[100] hidden items-center justify-center backdrop-blur-sm px-4">
        <div class="bg-white rounded-[24px] shadow-2xl w-full max-w-[450px] p-10 text-center relative animate-[popIn_0.3s_ease-out_forwards]">
            ...
            <!-- Text Content -->
            <h3 class="text-[#209F59] text-[28px] font-medium mb-4"><?php echo e(__('Thank you!')); ?></h3>
            <h4 class="text-[#333333] text-[20px] font-semibold mb-3"><?php echo e(__('Your Application Submitted!')); ?></h4>
            <p class="text-[#737373] text-[15px] leading-relaxed mb-6 font-normal"><?php echo e(__('Your application will be reviewed within 20 days.')); ?><br><?php echo e(__('Stay connect with us!')); ?></p>
    ...
    <div id="cropper-modal" class="fixed inset-0 bg-black/60 z-[110] hidden items-center justify-center backdrop-blur-md px-4">
        <div class="bg-white rounded-3xl shadow-2xl w-full max-w-2xl overflow-hidden animate-[popIn_0.3s_ease-out_forwards]">
            <div class="p-6 border-b border-gray-100 flex justify-between items-center">
                <h3 class="text-xl font-medium text-gray-900 font-sans!"><?php echo e(__('Crop Profile Photo')); ?></h3>
            ...
            <div class="p-6 border-t border-gray-100 flex justify-end gap-3">
                <button type="button" onclick="closeCropperModal()"
                    class="px-6 py-2.5 rounded-full border border-gray-200 text-gray-600 font-medium hover:bg-gray-50 transition-all duration-200"><?php echo e(__('Cancel')); ?></button>
                <button type="button" id="cropSave"
                    class="px-8 py-2.5 rounded-full bg-[#F5A623] text-[#423131] font-medium hover:bg-[#E09518] transition-all duration-200 shadow-sm shadow-[#F5A623]/20"><?php echo e(__('Crop & Save')); ?></button>
            </div>
        </div>
    </div>
    ...
    <script>
        ...
        function updateStepIndicator() {
            ...
            if (currentTab === 1) {
                backBtnText.textContent = '<?php echo e(__('Back to Website ')); ?>';
            } else {
                backBtnText.textContent = '<?php echo e(__('Back')); ?>';
            }

            if (currentTab === totalTabs) {
                nextBtnText.textContent = '<?php echo e(__('Complete Application')); ?>';
            } else {
                nextBtnText.textContent = '<?php echo e(__('Save & Continue')); ?>';
            }
        }
        ...
        function validateStep() {
            ...
            inputs.forEach(input => {
                ...
                if (input.hasAttribute('required') && !input.value.trim() && input.type !== 'radio' && input.type !== 'checkbox' && input.type !== 'file') {
                    errorMsg = '<?php echo e(__('This field is required ')); ?>';
                    ...
                    if (!checked) errorMsg = '<?php echo e(__('Please select an option ')); ?>';
                    ...
                    if (age < 18) {
                        errorMsg = '<?php echo e(__('You must be at least 18 years old ')); ?>';
                    }
                }
            ...
            if (currentTab === 1) {
                ...
                if (pwd && conf && conf.value !== pwd.value) {
                    ...
                    err.textContent = '<?php echo e(__('The password confirmation does not match ')); ?>';
        ...
        function closeThankYouPopup() {
            ...
            if (popup) {
                ...
                window.location.href = "<?php echo e(route('zaya-login')); ?>";
            }
        }
                ...
                <div class="bg-[#F6F6F6] rounded-[24px] py-10 px-6 md:px-12 mb-8 education-block" id="education-block-${index}">
                    <div class="flex justify-between items-center mb-6">
                        ...
                        <button type="button" class="text-red-500 hover:text-red-700 font-medium flex items-center gap-1 bg-transparent border-none cursor-pointer" onclick="removeEducation(${index})">
                            <i class="ri-delete-bin-line"></i> <?php echo e(__('Remove')); ?>
                    ...
                    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-8">
                        <div>
                            ...
                            <div class="custom-select-wrapper w-full">
                                <div class="custom-select" id="education-type-select-${index}">
                                    <div class="custom-select-trigger cursor-pointer">
                                        <span id="education-type-selected-${index}"><?php echo e(__('Select')); ?></span>
                                        <i class="ri-arrow-down-s-line arrow text-gray-400"></i>
                                    </div>
                                    <div class="custom-options">
                                        <div class="custom-option" data-value="degree"><?php echo e(__('Degree')); ?></div>
                        ...
                        <div>
                            <label class="block text-[#525252] text-lg font-normal mb-3"><?php echo e(__('Duration')); ?><span class="italic text-[#737373] text-[1rem] font-normal"><?php echo e(__('(Hours/Years)')); ?></span></label>
        ...
        function refreshCaptcha() {
            ...
            if (img) {
                img.src = "<?php echo e(route('captcha')); ?>?" + Date.now();
            }
        }
...
<?php /**PATH C:\wamp64\www\zaya\resources\views\practitioner-register.blade.php ENDPATH**/ ?>