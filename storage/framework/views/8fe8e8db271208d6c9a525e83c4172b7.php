                    ...
                    <div class="table-responsive">
                        <table class="table table-bordered table-striped" id="invoices-table">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td><?php echo e($booking->invoice_no); ?></td>
                                    <td><?php echo e($booking->user->name ?? 'N/A'); ?></td>
                                    <td><?php echo e($booking->practitioner->user->name ?? 'N/A'); ?></td>
                                    ...
                                    ?>
                                    <td><?php echo e($currencySymbol); ?> <?php echo e(number_format($booking->total_price, 2)); ?></td>
                                    <td>
                                        <span class="badge <?php echo e($booking->status === 'Paid' ? 'bg-success' : 'bg-warning'); ?>">
                                            <?php echo e(ucfirst($booking->status)); ?>

                                        </span>
                                    </td>
                                    <td>
                                        <a href="<?php echo e(route('invoice.show', $booking->invoice_no)); ?>" target="_blank" class="btn btn-primary btn-sm">
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\wamp64\www\zaya\resources\views\admin\invoices\index.blade.php ENDPATH**/ ?>