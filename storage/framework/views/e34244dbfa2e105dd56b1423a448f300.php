    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="card">
                ...
                <div class="card-body">
                    <form id="footerSettingsForm" action="<?php echo e(route('admin.footer-settings.update')); ?>" method="POST" enctype="multipart/form-data">
                        <?php echo csrf_field(); ?>
                        <div class="row g-3">
                            <div class="col-md-3">
                            ...
                            <div class="col-md-9 border-start">
                                <div class="tab-content" id="v-pills-tabContent">
                                    ...
                                    <div class="tab-pane fade p-3" id="v-pills-newsletter" role="tabpanel" aria-labelledby="v-pills-newsletter-tab">
                                        <div class="row g-4">
                                            <?php if(isset($settings['newsletter'])): ?>
                                                <?php $__currentLoopData = $settings['newsletter']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $setting): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <?php echo $__env->make('admin.services-settings.partials.field', ['setting' => $setting], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                            <?php endif; ?>
                                        </div>
                                    ...
                                    <div class="tab-pane fade p-3" id="v-pills-headings" role="tabpanel" aria-labelledby="v-pills-headings-tab">
                                        <div class="row g-4">
                                            <?php if(isset($settings['headings'])): ?>
                                                <?php $__currentLoopData = $settings['headings']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $setting): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <?php echo $__env->make('admin.services-settings.partials.field', ['setting' => $setting], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                            <?php endif; ?>
                                        </div>
                                    ...
                                    <div class="tab-pane fade p-3" id="v-pills-quick-links" role="tabpanel" aria-labelledby="v-pills-quick-links-tab">
                                        <div class="row g-4">
                                            <?php if(isset($settings['quick_links'])): ?>
                                                <?php $__currentLoopData = $settings['quick_links']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $setting): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <?php echo $__env->make('admin.services-settings.partials.field', ['setting' => $setting], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                            <?php endif; ?>
                                        </div>
                                    ...
                                    <div class="tab-pane fade p-3" id="v-pills-social" role="tabpanel" aria-labelledby="v-pills-social-tab">
                                        <div class="row g-4">
                                            <?php if(isset($settings['social_links'])): ?>
                                                <?php $__currentLoopData = $settings['social_links']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $setting): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <?php echo $__env->make('admin.services-settings.partials.field', ['setting' => $setting], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                            <?php endif; ?>
                                        </div>
                                    ...
                                    <div class="tab-pane fade p-3" id="v-pills-legal" role="tabpanel" aria-labelledby="v-pills-legal-tab">
                                        <div class="row g-4">
                                            <?php if(isset($settings['legal'])): ?>
                                                <?php $__currentLoopData = $settings['legal']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $setting): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <?php echo $__env->make('admin.services-settings.partials.field', ['setting' => $setting], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                            <?php endif; ?>
                                        </div>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\wamp64\www\zaya\resources\views\admin\footer-settings\index.blade.php ENDPATH**/ ?>