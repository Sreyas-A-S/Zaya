<?php $__env->startSection('title', 'Promo Code Management'); ?>
...
<script>
    $(document).ready(function() {
        ...
        var table = $('#promo-codes-table').DataTable({
            processing: true,
            serverSide: true,
            ajax: "<?php echo e(route('admin.promo-codes.index')); ?>",
            columns: [
        ...
        $('#promo-code-form').on('submit', function(e) {
            ...
            var url = id ? "<?php echo e(url('admin/promo-codes')); ?>/" + id : "<?php echo e(route('admin.promo-codes.store')); ?>";
        ...
        $(document).on('click', '.editPromoCode', function() {
            var id = $(this).data('id');
            $.get("<?php echo e(url('admin/promo-codes')); ?>/" + id, function(data) {
        ...
        $('#confirm-delete-btn').on('click', function() {
            ...
            $.ajax({
                url: "<?php echo e(url('admin/promo-codes')); ?>/" + id,
                type: 'DELETE',
    ...
    window.updateStatus = function(id, status) {
        $.ajax({
            url: "<?php echo e(url('admin/promo-codes')); ?>/" + id + "/status",
            type: 'POST',
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\wamp64\www\zaya\resources\views/admin/promo-codes/index.blade.php ENDPATH**/ ?>