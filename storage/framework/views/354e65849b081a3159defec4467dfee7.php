                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-md-6 border-end">
                            ...
                            <div class="row" id="root-categories-container">
                                ...
                                <div class="col-12 category-item" data-id="<?php echo e($parent->id); ?>">
                                    <div class="form-check checkbox-primary mb-2 d-flex align-items-center">
                                        <input class="form-check-input" type="checkbox" name="categories[]" value="<?php echo e($parent->id); ?>" id="cat_<?php echo e($parent->id); ?>" >
                                        <label class="form-check-label flex-grow-1 mb-0 ms-2" for="cat_<?php echo e($parent->id); ?>"><?php echo e($parent->name); ?></label>
                                        <a href="javascript:void(0)" class="text-danger ms-2 delete-master-data-btn" data-id="<?php echo e($parent->id); ?>" data-type="service_categories"><i class="fa fa-trash"></i></a>
                                    </div>
                                </div>
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="row" id="sub-categories-container">
                                <?php $__currentLoopData = $categories->whereNotNull('parent_id'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $child): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="col-12 category-item" data-id="<?php echo e($child->id); ?>">
                                    <div class="form-check checkbox-secondary mb-2 d-flex align-items-center">
                                        <input class="form-check-input" type="checkbox"  name="categories[]" value="<?php echo e($child->id); ?>" id="cat_<?php echo e($child->id); ?>">
                                        <label class="form-check-label flex-grow-1 mb-0 ms-2" for="cat_<?php echo e($child->id); ?>">
                                            <?php echo e($child->name); ?>

                                            <span class="text-muted small">(<?php echo e($child->parent->name ?? 'N/A'); ?>)</span>
                                        </label>
                                        <a href="javascript:void(0)" class="text-danger ms-2 delete-master-data-btn" data-id="<?php echo e($child->id); ?>" data-type="service_categories"><i class="fa fa-trash"></i></a>
                                    </div>
                                </div>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </div>
...
<script>
    ...
    var storageUrl = "<?php echo e(asset('storage')); ?>";
    ...
    window.deleteExistingImage = function(e, id) {
        ...
        $.ajax({
            url: "<?php echo e(url('admin/services/image')); ?>/" + id,
            type: 'DELETE',
            data: {
    ...
    $(document).ready(function() {
        ...
        servicesTable = $('#services-table').DataTable({
            ...
            serverSide: true,
            ajax: {
                url: "<?php echo e(route('admin.services.index')); ?>",
                data: function(d) {
        ...
        $('#service-form').on('submit', function(e) {
            ...
            let url = "<?php echo e(route('admin.services.store')); ?>";
            let method = $('#form-method').val();

            if (method === 'PUT') {
                url = "<?php echo e(url('admin/services')); ?>/" + $('#service_id').val();
        ...
        $('body').on('click', '.editService', function() {
            let id = $(this).data('id');
            $.get("<?php echo e(url('admin/services')); ?>/" + id + "/edit", function(data) {
        ...
        $('#confirm-delete-btn').click(function() {
            ...
            $.ajax({
                type: "DELETE",
                url: "<?php echo e(url('admin/services')); ?>/" + id,
                data: {
                    _token: '<?php echo e(csrf_token()); ?>'
                },
            ...
            $.get("<?php echo e(url('admin/services')); ?>/" + id + "/edit", function(data) {
                ...
                if (data.image) {
                    ...
                    if (!data.images || data.images.length === 0) {
                        slides.push({
                            src: "<?php echo e(asset('admiro/assets/images/user/user.png')); ?>",
                            is_main: true
                        });
                    }
                }
        ...
        $('#confirm-status-btn').on('click', function() {
            ...
            $.ajax({
                url: "<?php echo e(url('admin/services')); ?>/" + id + "/status",
                type: 'POST',
                data: {
                    _token: '<?php echo e(csrf_token()); ?>',
                    status: newStatus
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\wamp64\www\zaya\resources\views\admin\services\index.blade.php ENDPATH**/ ?>