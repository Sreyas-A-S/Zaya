...
<link rel="stylesheet" type="text/css" href="<?php echo e(asset('admiro/assets/css/vendors/select2.css')); ?>">
                                        ...
                                        <div class="col-md-12 text-center mb-4">
                                            <div class="avatar-upload">
                                                ...
                                                <div class="avatar-preview">
                                                    <div id="imagePreview" style="background-image: url('<?php echo e(asset('admiro/assets/images/user/user.png')); ?>');">
                                                    </div>
                                                </div>
                                            </div>
...
<input type="date" 
    ...
    required>                                       </div>
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <input type="email" class="form-control validate-char-limit" name="email" required maxlength="255" data-max="255" placeholder="Enter email id">
                                ...
                                <div class="step-content d-none" id="step2">
                                    <div class="row g-3">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-3">
                                                    <div class="form-check checkbox-primary d-flex align-items-center">
                                                        <input class="form-check-input spec-checkbox me-2" type="checkbox" name="specialization[]" value="<?php echo e($spec->name); ?>" id="spec_<?php echo e($spec->id); ?>">

                                                        <label class="form-check-label flex-grow-1 mb-0" for="spec_<?php echo e($spec->id); ?>">
                                                            <?php echo e($spec->name); ?>

                                                        </label>

                                                        <a href="javascript:void(0)" class="text-danger ms-2 delete-master-data-btn" data-id="<?php echo e($spec->id); ?>" data-type="specializations">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <input type="number" class="form-control" name="years_of_experience" required min="0" max="70" placeholder="e.g. 5">
                                        </div>
                                        <div class="col-md-6">
                                            <label class="form-label">Current Workplace / Clinic Name <span class="text-danger">*</span></label>
                                            <input type="text" class="form-control validate-char-limit" name="current_workplace" required maxlength="255" data-max="255" placeholder="Enter clinic name">
                                            <div class="text-danger small mt-1 char-limit-msg d-none">Maximum 255 characters allowed.</div>
                                        </div>
                                        <div class="col-md-12">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <input type="text" class="form-control validate-char-limit validate-format" name="city" required maxlength="100" data-max="100" pattern="^[a-zA-Z\s\-]+$" title="Only letters, spaces, and hyphens allowed" placeholder="City">
                                            <div class="text-danger small mt-1 char-limit-msg d-none">Maximum 100 characters allowed.</div>
                                            <div class="text-danger small mt-1 format-error d-none">Numbers and special characters are not allowed.</div>
                                        </div>
                                        <div class="col-md-6">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <select class="form-select" name="country" id="country" required>
                                                ...
                                                <option value="<?php echo e($name); ?>" data-flag="<?php echo e(strtolower($code)); ?>" <?php echo e($name == 'India' ? 'selected' : ''); ?>><?php echo e($name); ?></option>
                                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                            </select>
                                        </div>
                                        <div class="col-md-6">
                                ...
                                <div class="step-content d-none" id="step3">
                                    <div class="row g-3">
                                        ...
                                        <div class="col-md-12">
                                            <div class="row">
                                                <?php $__currentLoopData = $expertises; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $skill): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <div class="col-md-4">
                                                    <div class="form-check checkbox-primary d-flex align-items-center">
                                                        ...
                                                        <label class="form-check-label flex-grow-1 mb-0" for="skill_<?php echo e($skill->id); ?>">
                                                ...
                                                <div class="col-md-3">
                                                    <div class="form-check checkbox-primary d-flex align-items-center">
                                                        ...
                                                        <input class="form-check-input cond-checkbox me-2"
                                                            ...
                                                            value="<?php echo e($cond->name); ?>"
                                                            id="cond_<?php echo e($cond->id); ?>">

                                                        <label class="form-check-label flex-grow-1 mb-0"
                                                            for="cond_<?php echo e($cond->id); ?>">
                                                            <?php echo e($cond->name); ?>

                                                        </label>

                                                        <a href="javascript:void(0)"
                                                            class="text-danger ms-2 delete-master-data-btn"
                                                            data-id="<?php echo e($cond->id); ?>"
                                            ...
                                            <div class="row mb-3">
                                                ...
                                                <div class="col-md-2">
                                                    <div class="form-check checkbox-primary">
                                                        <input class="form-check-input proc-checkbox" type="checkbox" name="panchakarma_procedures[]" value="<?php echo e($proc); ?>" id="proc_<?php echo e($loop->index); ?>">
                                                        <label class="form-check-label" for="proc_<?php echo e($loop->index); ?>"><?php echo e($proc); ?></label>
                                                    </div>
                                                </div>
                                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                            </div>
                                                ...
                                                <div class="col-md-4">
                                                    <div class="form-check checkbox-primary d-flex align-items-center w-100">
                                                        ...
                                                        <input class="form-check-input ther-checkbox me-2"
                                                            ...
                                                            value="<?php echo e($ther->name); ?>"
                                                            id="ther_<?php echo e($ther->id); ?>">

                                                        <label class="form-check-label flex-grow-1 mb-0"
                                                            for="ther_<?php echo e($ther->id); ?>">
                                                            <?php echo e($ther->name); ?>

                                                        </label>

                                                        <a href="javascript:void(0)"
                                                            class="text-danger ms-2 delete-master-data-btn"
                                                            data-id="<?php echo e($ther->id); ?>"
                                                            data-type="therapies">
                                                            <i class="fa fa-trash"></i>
                                                        </a>
...
<script src="<?php echo e(asset('admiro/assets/js/select2/select2.full.min.js')); ?>"></script>
...
<script>
    ...
    $(document).ready(function() {
        table = $('#doctors-table').DataTable({
            ...
            serverSide: true,
            ajax: {
                url: "<?php echo e(route('admin.doctors.index')); ?>",
                data: function(d) {
    ...
    function openCreateModal() {
        ...
        $('#imagePreview').css('background-image', "url('<?php echo e(asset('admiro/assets/images/user/user.png')); ?>')");
    ...
    function editDoctor(id) {
        ...
        $.get("<?php echo e(url('admin/doctors')); ?>/" + id + "/edit", function(data) {
    ...
    function viewDoctor(id) {
        $.get("<?php echo e(url('admin/doctors')); ?>/" + id, function(data) {
            const d = data.doctor;
    ...
    $('#doctor-form').on('submit', function(e) {
        ...
        const url = doctor_id ? "<?php echo e(url('admin/doctors')); ?>/" + doctor_id : "<?php echo e(route('admin.doctors.store')); ?>";
        ...
        const validations = [{
            ...
            },
            {
                ...
                check: (el) => {
                    ...
                    if (!val && !passwordVal) return true;
                    return val === passwordVal;
                },
    ...
    $('#confirm-status-btn').on('click', function() {
        ...
        $.ajax({
            url: "<?php echo e(url('admin/doctors')); ?>/" + id + "/status",
            type: 'POST',
            data: {
    ...
    $('#confirm-delete-btn').on('click', function() {
        ...
        $.ajax({
            type: "DELETE",
            url: "<?php echo e(url('admin/doctors')); ?>/" + id,
            data: {
                _token: '<?php echo e(csrf_token()); ?>'
            },
    ...
    $(document).off('click', '.add-master-data-btn').on('click', '.add-master-data-btn', function() {
        ...
        $.ajax({
            url: "<?php echo e(url('admin/master-data')); ?>/" + type,
            method: 'POST',
            data: {
                _token: '<?php echo e(csrf_token()); ?>',
                name: value,
    ...
    $(document).on('click', '#confirm-master-delete-btn', function() {
        ...
        $.ajax({
            url: "<?php echo e(url('admin/master-data')); ?>/" + type + "/" + id,
            type: 'DELETE',
            data: {
                _token: '<?php echo e(csrf_token()); ?>'
            },
    ...
    window.deleteDegreeCertificate = function(doctorId, path, index) {
        if (confirm('Are you sure you want to delete this specific certificate?')) {
            $.ajax({
                url: "<?php echo e(url('admin/doctors/delete-certificate')); ?>/" + doctorId,
                type: 'POST',
                data: {
                    _token: "<?php echo e(csrf_token()); ?>",
                    path: path
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\wamp64\www\zaya\resources\views/admin/doctors/index.blade.php ENDPATH**/ ?>