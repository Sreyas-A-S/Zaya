...
<head>
    ...
    <title><?php echo e(__('Reset Password')); ?> - Zaya Wellness</title>
...
<body class="bg-white min-h-screen flex gap-10 xl:gap-20 p-2 md:p-10 max-lg:pb-15! relative"
    ...
    <div class="relative hidden lg:flex w-1/2 bg-cover bg-center items-end p-16 z-10">
        ...
        <div class="relative z-10 text-white max-w-xl">
            <h1 class="text-4xl xl:text-5xl font-sans! font-bold mb-6 leading-tight"><?php echo e(__('Create New Password')); ?></h1>
            <p class="text-white/80 text-lg font-light leading-relaxed"><?php echo e(__('Your identity has been verified. Set a new password for your account to continue.')); ?></p>
        </div>
    </div>
    ...
    <div class="w-full lg:w-1/2 flex items-center justify-center px-4 py-6 lg:p-8 bg-white overflow-y-auto z-20 rounded-3xl">
        <div class="w-full max-w-md">
            ...
            <h2 class="text-lg md:text-3xl font-sans! font-bold text-center text-gray-900 lg:mb-[18px]"><?php echo e(__('Reset Password')); ?></h2>
            <p class="text-gray-500 text-center mb-6 md:mb-8 text-md md:text-base"><?php echo e(__('Choose a strong new password for your account.')); ?></p>
            ...
            <form method="POST" action="<?php echo e(route('client.forgot-password.reset.update')); ?>" class="space-y-5">
                <?php echo csrf_field(); ?>

                <div class="relative">
                    <input type="password" name="password" id="new-password" required
                        placeholder="<?php echo e(__('New Password')); ?>" minlength="8"
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="relative">
                    <input type="password" name="password_confirmation" id="confirm-password" required
                        placeholder="<?php echo e(__('Confirm New Password')); ?>" minlength="8"
                ...
                <div class="px-4">
                    <p class="text-xs text-gray-400 mb-1.5"><?php echo e(__('Password must contain:')); ?></p>
                    <ul class="text-xs text-gray-400 space-y-1" id="pw-rules">
                        <li id="rule-length" class="flex items-center gap-1.5">
                            <i class="ri-close-circle-line text-gray-300 text-sm"></i> <?php echo e(__('At least 8 characters')); ?>

                        </li>
                        <li id="rule-upper" class="flex items-center gap-1.5">
                            <i class="ri-close-circle-line text-gray-300 text-sm"></i> <?php echo e(__('One uppercase letter')); ?>

                        </li>
                        <li id="rule-lower" class="flex items-center gap-1.5">
                            <i class="ri-close-circle-line text-gray-300 text-sm"></i> <?php echo e(__('One lowercase letter')); ?>

                        </li>
                        <li id="rule-number" class="flex items-center gap-1.5">
                            <i class="ri-close-circle-line text-gray-300 text-sm"></i> <?php echo e(__('One number')); ?>
...
<?php /**PATH C:\wamp64\www\zaya\resources\views\auth\client-passwords\reset.blade.php ENDPATH**/ ?>