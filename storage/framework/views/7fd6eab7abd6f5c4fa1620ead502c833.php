<?php $__env->startSection('title', 'Finance Managers'); ?>
                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <select name="country[]" id="fm-countries" class="form-control select2" multiple required>
                                        <?php $__currentLoopData = $countries; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $country): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($country->id); ?>" data-flag="<?php echo e(strtolower($country->code)); ?>"><?php echo e($country->name); ?></option>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    </select>
                                </div>
                                <div class="col-md-6 mb-3">
                ...
                <div class="row g-0">
                    ...
                    <div class="col-md-4 border-end bg-light p-4 text-center">
                        <div class="position-relative d-inline-block mb-3">
                            <img id="view-profile-pic" src="<?php echo e(asset('admiro/assets/images/user/user.png')); ?>"
...
<script>
    ...
    $(document).ready(function() {
        ...
        function formatCountry(country) {
            ...
            if (!element) return country.text;
        ...
        let table = $('#finance-managers-table').DataTable({
            ...
            serverSide: true,
            ajax: {
                url: "<?php echo e(route('admin.finance-managers.index')); ?>",
                data: function(d) {
        ...
        $('#confirmStatusBtn').click(function() {
            ...
            $.ajax({
                url: "<?php echo e(url('admin/finance-managers')); ?>/" + id + "/status",
                type: 'POST',
                data: {
        ...
        $('#financeManagerModal').on('hidden.bs.modal', function() {
            ...
            $('#financeManagerForm').attr('action', "<?php echo e(route('admin.finance-managers.store')); ?>");
        ...
        $(document).on('click', '.editUser', function() {
            let id = $(this).data('id');
            $.get("<?php echo e(url('admin/finance-managers')); ?>/" + id + "/edit", function(user) {
                ...
                if (user.national_id) {
                    ...
                    $('#fm-countries').val(countries).trigger('change');
                } else {
                    $('#fm-countries').val([]).trigger('change');
                }
                ...
                if (user.languages) {
                    ...
                    $('#fm-languages').val(languages).trigger('change');
                } else {
                    $('#fm-languages').val([]).trigger('change');
                }

                $('#status').val(user.status || 'pending');

                // Handle profile pic preview
                let avatar = user.profile_pic ? "<?php echo e(asset('storage')); ?>/" + user.profile_pic : "<?php echo e(asset('admiro/assets/images/user/user.png')); ?>";
                ...
                $('#methodPlaceholder').html('<?php echo method_field("PUT"); ?>');
                $('#financeManagerForm').attr('action', "<?php echo e(url('admin/finance-managers')); ?>/" + id);
        ...
        $(document).on('click', '.deleteUser', function() {
            if (confirm('Are you sure you want to delete this user?')) {
                let id = $(this).data('id');
                $.ajax({
                    url: "<?php echo e(url('admin/finance-managers')); ?>/" + id,
                    type: 'DELETE',
                    data: {
                        _token: "<?php echo e(csrf_token()); ?>"
                    },
        ...
        $(document).on('click', '.viewUser', function() {
            ...
            $.get("<?php echo e(url('admin/finance-managers')); ?>/" + id + "/edit", function(user) {
                ...
                if (user.national_id) {
                    ...
                    cIds.forEach(cid => {
                        let name = $('#fm-countries option[value="' + cid + '"]').text();
                ...
                if (user.languages) {
                    ...
                    lIds.forEach(lid => {
                        let name = $('#fm-languages option[value="' + lid + '"]').text();
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\wamp64\www\zaya\resources\views\admin\finance-manager\index.blade.php ENDPATH**/ ?>