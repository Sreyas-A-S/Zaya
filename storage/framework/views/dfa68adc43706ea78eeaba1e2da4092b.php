    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="card">
                ...
                <div class="card-body">
                    <form id="profileSettingsForm" action="<?php echo e(route('admin.admin-panel-settings.update')); ?>" method="POST" enctype="multipart/form-data">
                        <?php echo csrf_field(); ?>
                        <div class="row g-3">
                            <div class="col-md-3">
                            ...
                            <div class="col-md-9 border-start">
                                <div class="tab-content" id="v-pills-tabContent">
                                    ...
                                    <div class="tab-pane fade show active p-3" id="v-pills-general"        
                                        ...
                                        <div class="row g-4">
                                            <?php $__currentLoopData = $generalSettings; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $setting): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <?php echo $__env->make('admin.services-settings.partials.field',
                                                            ['setting' => $setting], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                                    ...
                                    <div class="tab-pane fade p-3" id="v-pills-sidebar" role="tabpanel" aria-labelledby="v-pills-sidebar-tab">
                                        <div class="row g-4">
                                            <?php $__currentLoopData = $sidebarSettings; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $setting): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <?php echo $__env->make('admin.services-settings.partials.field',
                                                            ['setting' => $setting], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                        </div>
                                    ...
                                    <div class="tab-pane fade p-3" id="v-pills-stats" role="tabpanel"
                                       aria-labelledby="v-pills-stats-tab">
                                        <div class="row g-4">
                                            <?php $__currentLoopData = $statsSettings; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $setting): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <?php echo $__env->make('admin.services-settings.partials.field',
                                                            ['setting' => $setting], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                        </div>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\wamp64\www\zaya\resources\views\admin\admin-panel-settings\index.blade.php ENDPATH**/ ?>