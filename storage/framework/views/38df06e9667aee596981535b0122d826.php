<?php $__env->startSection('title', 'Practitioners Management'); ?>
                            ...
                            <form id="practitioner-form" method="POST" enctype="multipart/form-data" class="theme-form" novalidate>
                                ...
                                <div class="step-content" id="step1">
                                    <div class="row g-3">
                                        ...
                                        <div class="col-md-3">
                                            ...
                                            <input type="date" class="form-control" name="dob" max="<?php echo e(date('Y-m-d', strtotime('-1 day'))); ?>" required>
                                        </div>
                                        <div class="col-md-3">
                                    ...
                                    <div class="row g-3">
                                        ...
                                        <div class="col-12">
                                            ...
                                            <div class="row g-3 items-container">
                                                <?php $__currentLoopData = $wellnessConsultations; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <div class="col-md-6 mb-2">
                                                    <div class="d-flex align-items-center justify-content-between bg-light p-2 rounded border">
                                                        <div class="form-check checkbox-primary mb-0 d-flex align-items-center">
                                                            <input class="form-check-input cons-checkbox" type="checkbox" name="consultations[]" value="<?php echo e($item->name); ?>" id="cons_<?php echo e($item->id); ?>">
                                                            <label class="form-check-label ms-2 mb-0" for="cons_<?php echo e($item->id); ?>"><?php echo e($item->name); ?></label>
                                                        </div>
                                                        <a href="javascript:void(0)" class="text-danger delete-master-data-btn" data-id="<?php echo e($item->id); ?>" data-type="wellness_consultations">
                                        ...
                                        <div class="col-12 mt-3">
                                            ...
                                            <div class="row g-3 items-container">
                                                <?php $__currentLoopData = $bodyTherapies; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <div class="col-md-6 mb-2">
                                                    <div class="d-flex align-items-center justify-content-between bg-light p-2 rounded border">
                                                        <div class="form-check checkbox-primary mb-0 d-flex align-items-center">
                                                            <input class="form-check-input body-checkbox" type="checkbox" name="body_therapies[]" value="<?php echo e($item->name); ?>" id="body_<?php echo e($item->id); ?>">
                                                            <label class="form-check-label ms-2 mb-0" for="body_<?php echo e($item->id); ?>"><?php echo e($item->name); ?></label>
                                                        </div>
                                                        <a href="javascript:void(0)" class="text-danger delete-master-data-btn" data-id="<?php echo e($item->id); ?>" data-type="body_therapies">
                                                            <i class="fa fa-trash"></i>
                                                        </a>
                                                    </div>
                                                </div>
                                        ...
                                        <div class="col-12 mt-3">
                                            ...
                                            <div class="row g-3 items-container">
                                                <?php $__currentLoopData = $practitionerModalities; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <div class="col-md-6 mb-2">
                                                    <div class="d-flex align-items-center justify-content-between bg-light p-2 rounded border">
                                                        <div class="form-check checkbox-primary mb-0 d-flex align-items-center">
                                                            <input class="form-check-input mod-checkbox" type="checkbox" name="other_modalities[]" value="<?php echo e($item->name); ?>" id="mod_<?php echo e($item->id); ?>">
                                                            <label class="form-check-label ms-2 mb-0" for="mod_<?php echo e($item->id); ?>"><?php echo e($item->name); ?></label>
                                                        </div>
                                                        <a href="javascript:void(0)" class="text-danger delete-master-data-btn" data-id="<?php echo e($item->id); ?>" data-type="practitioner_modalities">
                                                            <i class="fa fa-trash"></i>
                                                        </a>
                                                    </div>
                                                </div>
                                ...
                                <div class="step-content d-none" id="step5">
                                    <div class="row g-3">
                                        ...
                                        ?>
                                        <?php $__currentLoopData = $docs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $name => $label): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <div class="col-md-6">
                                            <label class="form-label small fw-bold"><?php echo e($label); ?> <span class="text-danger">*</span></label>
                                            <input type="file"  class="form-control form-control-sm" name="<?php echo e($name); ?>"
                                                accept=".pdf,.doc,.docx,.jpg,.jpeg,.png"
                                                 multiple required>
                                            <div id="current-<?php echo e($name); ?>" class="mt-1 d-none small"></div>
                                        </div>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
...
<script>
    ...
    const countryMap = <?php echo json_encode($countryMap, 15, 512) ?>;
    let table;
    let toastInstance;
    let languageChoices;
    let qualCount = 1;
    ...
    $(document).ready(function() {
        table = $('#practitioners-table').DataTable({
            ...
            serverSide: true,
            ajax: {
                url: "<?php echo e(route('admin.practitioners.index')); ?>",
                data: function (d) {
    ...
    $('body').on('click', '.editPractitioner', function() {
        ...
        $.get("<?php echo e(url('admin/practitioners')); ?>/" + id + "/edit", function(data) {
            const u = data.user;
    ...
    $(document).off('click', '#confirm-status-btn').on('click', '#confirm-status-btn', function() {
        ...
        $.ajax({
            url: "<?php echo e(url('admin/practitioners')); ?>/" + id + "/status",
            type: 'POST',
            data: {
    ...
    $('#practitioner-form').on('submit', function(e) {
        ...
        const url = id ? "<?php echo e(url('admin/practitioners')); ?>/" + id : "<?php echo e(route('admin.practitioners.store')); ?>";
    ...
    $('body').on('click', '.viewPractitioner', function() {
        const id = $(this).data('id');
        $.get("<?php echo e(url('admin/practitioners')); ?>/" + id, function(data) {
            const u = data.user;
            const p = data.practitioner || {};
    ...
    $('#confirm-delete-btn').on('click', function() {
        ...
        $.ajax({
            type: "DELETE",
            url: "<?php echo e(url('admin/practitioners')); ?>/" + id,
            data: {
                _token: '<?php echo e(csrf_token()); ?>'
            },
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\wamp64\www\zaya\resources\views/admin/practitioners/index.blade.php ENDPATH**/ ?>