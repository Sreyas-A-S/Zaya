<?php $__env->startSection('title', 'Service Packages'); ?>
...
<script>
    $(function () {
        ...
        const table = $('#service-packages-table').DataTable({
            processing: true,
            serverSide: true,
            ajax: "<?php echo e(route('admin.service-packages.index')); ?>",
            columns: [
        ...
        $('#service-package-form').on('submit', function (e) {
            ...
            const url = id ? "<?php echo e(url('admin/service-packages')); ?>/" + id : "<?php echo e(route('admin.service-packages.store')); ?>";
        ...
        $(document).on('click', '.editServicePackage', function () {
            ...
            $.get("<?php echo e(url('admin/service-packages')); ?>/" + id, function (data) {
        ...
        $(document).on('click', '.deleteServicePackage', function () {
            ...
            $.ajax({
                url: "<?php echo e(url('admin/service-packages')); ?>/" + id,
                type: 'POST',
        ...
        $(document).on('click', '.toggle-status', function () {
            ...
            $.post("<?php echo e(url('admin/service-packages')); ?>/" + id + "/status", {
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\wamp64\www\zaya\resources\views\admin\service-packages\index.blade.php ENDPATH**/ ?>