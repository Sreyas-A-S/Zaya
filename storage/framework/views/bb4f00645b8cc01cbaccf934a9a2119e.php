...
<div class="min-h-[85vh] flex items-center justify-center px-6 bg-[#FDFDFD] relative overflow-hidden">
    ...
    <div class="text-center max-w-2xl relative z-10 mt-12">
        ...
        <div class="flex flex-col sm:flex-row items-center justify-center gap-5">
            <a href="<?php echo e(url('/')); ?>" class="w-full sm:w-auto px-12 py-4 bg-secondary text-white rounded-full font-medium transition-all hover:bg-[#243B2F] hover:shadow-xl hover:-translate-y-1 shadow-[0_10px_25px_rgba(46,75,60,0.15)]">
                Back to Home
            </a>
            <a href="<?php echo e(route('dashboard')); ?>" class="w-full sm:w-auto px-12 py-4 border-2 border-[#EEF2EF] text-secondary rounded-full font-medium hover:bg-white hover:border-secondary/20 transition-all">
                Go to Dashboard
            </a>
        </div>
        ...
        <p class="mt-16 text-sm text-gray-400">
            Need help? <a href="<?php echo e(url('/contact')); ?>" class="text-secondary font-medium hover:underline">Contact Support</a>
        </p>
    </div>
</div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\wamp64\www\zaya\resources\views\errors\404.blade.php ENDPATH**/ ?>