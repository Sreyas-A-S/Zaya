...
<script>
    ...
    $(document).ready(function() {
        table = $('#countries-table').DataTable({
            processing: true,
            serverSide: true,
            ajax: "<?php echo e(route('admin.countries.index')); ?>",
            columns: [{
                    data: 'DT_RowIndex',
                    name: 'DT_RowIndex',
                    orderable: false,
        ...
        $(document).on('click', '#confirm-status-btn', function() {
            ...
            $.ajax({
                url: "<?php echo e(url('admin/countries')); ?>/" + id + "/status",
                type: 'POST',
                data: {
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\wamp64\www\zaya\resources\views\admin\countries\index.blade.php ENDPATH**/ ?>