...
<div id="bookings-wrapper">
    <?php echo $__env->make('partials.bookings-table', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
</div>
                        ...
                        <div id="refer-step-1">
                            ...
                            <div class="mb-6">
                                ...
                                <div class="flex overflow-x-auto gap-2 pb-2 scrollbar-hide" id="refer-tabs">
                                    ...
                                    ?>
                                    <?php $__currentLoopData = $roles; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $val => $info): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <button type="button" 
                                        onclick="switchReferTab('<?php echo e($val); ?>')"
                                        data-role-tab="<?php echo e($val); ?>"
...
<script>
    ...
    async function fetchProfessionals() {
        ...
        try {
            const url = new URL("<?php echo e(route('referrable-practitioners-api')); ?>", window.location.origin);
    ...
    async function fetchTranslators() {
        ...
        try {
            const url = new URL("<?php echo e(route('available-translators-api')); ?>", window.location.origin);
            if (query) url.searchParams.append('query', query);
...
<?php echo $__env->make('layouts.client', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\wamp64\www\zaya\resources\views\bookings.blade.php ENDPATH**/ ?>