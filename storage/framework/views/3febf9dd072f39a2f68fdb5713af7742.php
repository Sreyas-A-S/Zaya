<?php $__env->startSection('title', 'Clients Management'); ?>
                ...
                <form id="client-form" method="POST" class="theme-form" novalidate>
                    ...
                    <div class="row g-3 mb-4">
                        ...
                        <div class="col-md-3">
                            ...
                            <input type="date" max="<?php echo e(date('Y-m-d')); ?>" class="form-control" name="dob" id="dob_input" required>
                        </div>
                        <div class="col-md-3">
        ...
        <div class="col-md-6">
            <div class="form-check checkbox-primary mb-2 d-flex align-items-center">
                ...
                <input class="form-check-input pref-checkbox me-2"
                       ...
                       value="<?php echo e($pref->name); ?>"
                       id="pref_<?php echo e($pref->id); ?>">

                <label class="form-check-label flex-grow-1 mb-0"
                       for="pref_<?php echo e($pref->id); ?>">
...
<script>
    ...
    $(document).ready(function() {
        ...
        $('#client-form').on('submit', function(e) {
            ...
            let url = "<?php echo e(route('admin.clients.store')); ?>";
            if ($('#form-method').val() === 'PUT') {
                url = "<?php echo e(url('admin/clients')); ?>/" + $('#client_id_hidden').val();
        ...
        $(document).on('click', '.editClient', function() {
            let id = $(this).data('id');
            $.get("<?php echo e(url('admin/clients')); ?>/" + id + "/edit", function(data) {
    ...
    $('#confirm-delete-btn').click(function() {
        ...
        $.ajax({
            url: "<?php echo e(url('admin/clients')); ?>/" + id,
            type: 'DELETE',
            data: {
    ...
    $(document).off('click', '#confirm-status-btn').on('click', '#confirm-status-btn', function() {
        ...
        $.ajax({
            url: "<?php echo e(url('admin/clients')); ?>/" + id + "/status",
            type: 'POST',
            data: {
                _token: "<?php echo e(csrf_token()); ?>",
                status: newStatus
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\wamp64\www\zaya\resources\views\admin\clients\index.blade.php ENDPATH**/ ?>