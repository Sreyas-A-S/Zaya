...
<div id="joinAsModal" class="fixed inset-0 z-[1000] hidden flex items-center justify-center p-4">
    ...
    <div class="popup-content relative w-full max-w-[720px] bg-white rounded-[32px] shadow-2xl p-8 md:p-10 opacity-0 scale-95 transition-all duration-200">
        ...
        <h3 class="text-2xl md:text-3xl font-serif font-bold text-primary text-center mb-3"><?php echo e(__('Join Us As')); ?></h3>
        <p class="text-gray-500 text-center mb-8"><?php echo e(__('Select your role to continue')); ?></p>

        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
            <a href="<?php echo e(route('practitioner-register')); ?>"
                ...
                <div class="text-gray-900 font-medium"><?php echo e(__('Practitioner')); ?></div>
            </a>

            <a href="<?php echo e(route('join.register', ['role' => 'doctor'])); ?>"
                class="border border-gray-200 rounded-2xl p-5 hover:border-secondary hover:bg-[#FFF7EF] transition-all text-center">
                <div class="text-secondary text-2xl mb-2"><i class="ri-stethoscope-line"></i></div>
                <div class="text-gray-900 font-medium"><?php echo e(__('Doctor')); ?></div>
            </a>

            <a href="<?php echo e(route('join.register', ['role' => 'yoga-therapist'])); ?>"
                class="border border-gray-200 rounded-2xl p-5 hover:border-secondary hover:bg-[#FFF7EF] transition-all text-center">
                <div class="text-secondary text-2xl mb-2"><i class="ri-leaf-line"></i></div>
                <div class="text-gray-900 font-medium"><?php echo e(__('Yoga Therapist')); ?></div>
            </a>

            <a href="<?php echo e(route('join.register', ['role' => 'mindfulness-practitioner'])); ?>"
                class="border border-gray-200 rounded-2xl p-5 hover:border-secondary hover:bg-[#FFF7EF] transition-all text-center">
                <div class="text-secondary text-2xl mb-2"><i class="ri-mental-health-line"></i></div>
                <div class="text-gray-900 font-medium"><?php echo e(__('Mindfulness Practitioner')); ?></div>
            </a>

            <a href="<?php echo e(route('join.register', ['role' => 'translator'])); ?>"
                class="border border-gray-200 rounded-2xl p-5 hover:border-secondary hover:bg-[#FFF7EF] transition-all text-center">
                <div class="text-secondary text-2xl mb-2"><i class="ri-translate-2"></i></div>
                <div class="text-gray-900 font-medium"><?php echo e(__('Translator')); ?></div>
            </a>
        </div>
...
<?php /**PATH C:\wamp64\www\zaya\resources\views\partials\frontend\join-as-modal.blade.php ENDPATH**/ ?>