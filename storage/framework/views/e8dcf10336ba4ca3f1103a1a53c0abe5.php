        ...
        <section class="pt-[144px] md:pt-[150px] px-4 md:px-6 bg-white min-h-screen pb-20">
            <div class="container mx-auto">
                ...
                <div class="flex flex-col md:flex-row md:items-start justify-between gap-6 mb-8 md:mb-16">
                    <h1 class="text-4xl md:text-7xl font-serif text-primary font-medium tracking-tight" data-i18n="<?php echo e($category); ?>">
                        <?php echo e(__($category)); ?>

                    </h1>
                    <p class="text-gray-500 text-[15px] md:text-base leading-relaxed max-w-xl md:mt-4 md:text-right" data-i18n="desc_<?php echo e(strtolower($category)); ?>">
                        <?php echo e($categoryDescription); ?>
                ...
                <div class="flex flex-col lg:flex-row justify-between items-center border-b border-gray-200 pb-4 mb-12 gap-6">
                    ...
                    <div id="category-tabs-container"
                        ...
                        <?php $__currentLoopData = ['Ayurveda', 'Yoga', 'Counselling', 'Packages']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tab): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <a href="<?php echo e(route('services', ['category' => $tab])); ?>"
                                class="whitespace-nowrap text-base md:text-lg lg:text-xl pb-4 transition-all <?php echo e($category === $tab ? 'text-secondary font-medium' : 'text-gray-400 hover:text-secondary'); ?>" data-i18n="<?php echo e($tab); ?>">
                                <?php echo e(__($tab)); ?>
                    ...
                    <!-- Search Box -->
                    <form action="<?php echo e(route('services')); ?>" method="GET" class="w-full lg:w-auto flex items-center gap-2">
                        <?php if(request()->has('servicescategory')): ?>
                            <input type="hidden" name="servicescategory" value="<?php echo e(request('servicescategory')); ?>">
                        <?php else: ?>
                            <input type="hidden" name="category" value="<?php echo e(request('category', $category)); ?>">
                        <?php endif; ?>
                        <input type="text" name="search" value="<?php echo e(request('search')); ?>"
                            placeholder="<?php echo e(__('Search services or conditions...')); ?>" data-i18n="Search services or conditions..."
                ...
                <?php if($category === 'Packages'): ?>
                <div class="grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-12" id="services-grid">
                    <?php $__empty_1 = true; $__currentLoopData = $servicePackages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $package): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <article class="block">
                            <div class="w-full aspect-video overflow-hidden mb-5 bg-gray-100">
                                <img src="<?php echo e($package->cover_image_url); ?>"
                                    alt="<?php echo e($package->title); ?>"
                                    class="w-full h-full object-cover">
                            </div>
                            <div>
                                <h3 class="text-xl md:text-2xl font-sans! font-medium text-gray-900 mb-2">
                                    <?php echo e(__($package->title)); ?>

                                </h3>
                                <?php if($package->description): ?>
                                    <p class="text-gray-500 text-base leading-relaxed font-light mb-4">
                                        <?php echo e(__($package->description)); ?>

                                    </p>
                                <?php endif; ?>
                                <div class="flex flex-wrap gap-2">
                                    <?php $__currentLoopData = $package->service_titles; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $serviceTitle): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <span class="inline-flex px-4 py-2 bg-[#F5F5F5] text-gray-700 rounded-full text-sm">
                                            <?php echo e(__($serviceTitle)); ?>
                    ...
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                        <div class="col-span-full py-20 text-center">
                            <p class="text-gray-500 text-lg italic"><?php echo e(__('No service packages found.')); ?></p>
                        </div>
                    <?php endif; ?>
                </div>
                <?php else: ?>
                <div class="grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-12" id="services-grid">
                    <?php $__empty_1 = true; $__currentLoopData = $services; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $service): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <a href="<?php echo e($service->slug ? route('service-detail', $service->slug) : '#'); ?>" class="block group cursor-pointer">
                            <div class="w-full aspect-video overflow-hidden mb-5 bg-gray-100">
                                <?php
                            ...
                            <div>
                                <h3 class="text-xl md:text-2xl font-sans! font-medium text-gray-900 mb-2 group-hover:text-primary transition-colors" data-i18n="<?php echo e($service->title); ?>">
                                    <?php echo e(__($service->title)); ?>

                                </h3>
                                <p class="text-gray-500 text-base leading-relaxed font-light line-clamp-2" data-i18n="<?php echo e($service->description); ?>">
                                    <?php echo e(__($service->description)); ?>
                    ...
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                        <div class="col-span-full py-20 text-center">
                            <p class="text-gray-500 text-lg italic" data-i18n="No services found in this category."><?php echo e(__('No services found in this category.')); ?></p>
                        </div>
                    <?php endif; ?>
                </div>
                <?php endif; ?>
        ...
        <section class="pt-[144px] md:pt-[150px] px-4 md:px-6 bg-white">
            <div class="container mx-auto">
                    ...
                    <div>
                        <div class="mb-8 animate-on-scroll">
                            <span id="services_page_badge" class="bg-accent text-secondary px-8 py-2.5 rounded-full font-medium text-base inline-block" data-i18n="Our Services">
                                <?php echo e($settings['services_page_badge'] ?? __('Our Services')); ?>

                            </span>
                        </div>
                        <h1 id="services_page_title" class="text-4xl md:text-5xl font-serif font-bold text-primary mb-8 leading-tight">
                            <?php echo nl2br($settings['services_page_title'] ?? __("Embrace Holistic \n Wellness")); ?>
                ...
                <div class="w-full overflow-hidden group">
                    ...
                    ?>
                    <img src="<?php echo e($bannerImg); ?>" alt="Holistic Wellness"
                ...
                <div class="grid grid-cols-2 md:grid-cols-2 lg:grid-cols-4 gap-4 md:gap-6">
                    ...
                    <div
                        ...
                        <h3 id="services_stat_1_count" class="text-3xl md:text-5xl font-medium font-sans! text-black mb-4">
                            <?php echo e($settings['services_stat_1_count'] ?? '300'); ?>

                        </h3>
                        <p id="services_stat_1_label" class="text-gray-500 font-normal text-sm md:text-base" data-i18n="Sessions Completed">
                            <?php echo e($settings['services_stat_1_label'] ?? __('Sessions Completed')); ?>
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-6 lg:gap-8">
                    ...
                    <div class="flex flex-col gap-6">
                        <div class="w-full rounded-4xl overflow-hidden shadow-sm">
                            <img src="<?php echo e(asset('frontend/assets/ayurveda-service.png')); ?>" alt="Ayurveda"
                        ...
                        <div
                            ...
                            <h3 class="text-2xl font-medium text-gray-900 mb-3" data-i18n="Ayurveda"><?php echo e(__('Ayurveda')); ?></h3>
                            <p class="text-[15px] text-gray-500 mb-8 font-normal" data-i18n="Personalized constitutional balance"><?php echo e(__('Personalized constitutional balance')); ?></p>
                            <a href="<?php echo e(route('services', ['category' => 'Ayurveda'])); ?>"
                                class="border border-secondary text-secondary rounded-full px-8 py-2 text-[15px] font-medium hover:bg-secondary hover:text-white transition-colors duration-300" data-i18n="Explore"><?php echo e(__('Explore')); ?></a>
                        </div>
                    </div>
                    ...
                    <div class="flex flex-col-reverse md:flex-col gap-6">
                        ...
                        <div
                            class="bg-white hover:bg-[#FFF8ED] rounded-4xl border border-gray-100 shadow-sm p-10 text-center flex flex-col items-center justify-center transition-all duration-300 hover:shadow-lg">
                            <h3 class="text-2xl font-medium text-gray-900 mb-3" data-i18n="Yoga"><?php echo e(__('Yoga')); ?></h3>
                            <p class="text-[15px] text-gray-500 mb-8 font-normal" data-i18n="Integrated therapeutic movement"><?php echo e(__('Integrated therapeutic movement')); ?></p>
                            <a href="<?php echo e(route('services', ['category' => 'Yoga'])); ?>"
                                class="border border-secondary text-secondary rounded-full px-8 py-2 text-[15px] font-medium hover:bg-secondary hover:text-white transition-colors duration-300" data-i18n="Explore"><?php echo e(__('Explore')); ?></a>
                        </div>
                        <!-- Bottom Image -->
                        <div class="w-full rounded-4xl overflow-hidden shadow-sm">
                            <img src="<?php echo e(asset('frontend/assets/yoga-service.png')); ?>" alt="Yoga"
                                class="w-full h-full object-cover transition-transform duration-700 hover:scale-105">
                        </div>
                    </div>
                    ...
                    <div class="flex flex-col gap-6">
                        <div class="w-full rounded-4xl overflow-hidden shadow-sm">
                            <img src="<?php echo e(asset('frontend/assets/counselling-service.png')); ?>" alt="Counselling"
                                class="w-full h-full object-cover transition-transform duration-700 hover:scale-105">
                        </div>
                        <div
                            class="bg-white hover:bg-[#FFF8ED] rounded-4xl border border-gray-100 shadow-sm p-10 text-center flex flex-col items-center justify-center transition-all duration-300 hover:shadow-lg">
                            <h3 class="text-2xl font-medium text-gray-900 mb-3" data-i18n="Counselling"><?php echo e(__('Counselling')); ?></h3>
                            <p class="text-[15px] text-gray-500 mb-8 font-normal" data-i18n="Mindful emotional restoration"><?php echo e(__('Mindful emotional restoration')); ?></p>
                            <a href="<?php echo e(route('services', ['category' => 'Counselling'])); ?>"
                                class="border border-secondary text-secondary rounded-full px-8 py-2 text-[15px] font-medium hover:bg-secondary hover:text-white transition-colors duration-300" data-i18n="Explore"><?php echo e(__('Explore')); ?></a>
                        </div>
                    </div>
                </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\wamp64\www\zaya\resources\views\services.blade.php ENDPATH**/ ?>