<?php $__env->startSection('title', 'Practitioner Reviews Management'); ?>
...
<script>
    $(document).ready(function() {
        ...
        var table = $('#reviews-table').DataTable({
            processing: true,
            serverSide: true,
            ajax: "<?php echo e(route('admin.reviews.practitioners.index')); ?>",
            columns: [{
                    data: 'id',
                    name: 'id'
                },
        ...
        $('#confirm-delete-btn').click(function() {
            ...
            $.ajax({
                type: "DELETE",
                url: "<?php echo e(url('admin/reviews/practitioners')); ?>/" + id,
                data: {
        ...
        $('#confirm-status-btn').on('click', function() {
            ...
            $.ajax({
                url: "<?php echo e(url('admin/reviews/practitioners')); ?>/" + id + "/status",
                type: 'POST',
                data: {
                    _token: '<?php echo e(csrf_token()); ?>',
                    status: newStatus
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\wamp64\www\zaya\resources\views\admin\reviews\practitioner\index.blade.php ENDPATH**/ ?>