<?php $__env->startSection('content'); ?>
    ...
    <section class="pt-[144px] md:pt-[150px] pb-0 px-4 md:px-6 scroll-mt-[180px] bg-white" id="who-we-are">
        <div class="container mx-auto">
            ...
            <!-- Banner Image & Text -->
            <div class="relative w-full h-[250px] md:h-[500px] rounded-[30px] overflow-hidden shadow-xl mb-16 md:mb-20">
                <!-- Background Image -->
                <img id="about_banner_image"
                    src="<?php echo e(isset($settings['about_banner_image']) ? (str_starts_with($settings['about_banner_image'], 'frontend/') ? asset($settings['about_banner_image']) : asset('storage/' . $settings['about_banner_image'])) : asset('frontend/assets/about-us-cover-img.png')); ?>"
                    alt="Zaya Community" class="w-full h-full object-cover">
                ...
                <div class="absolute inset-0 flex flex-col items-center justify-center text-center p-6 md:p-12">
                    <h2 id="about_banner_title"
                        class="text-xl md:text-2xl lg:text-3xl font-semibold text-white max-w-3xl leading-relaxed font-sans! drop-shadow-md">
                        <?php echo e($settings['about_banner_title'] ?? 'We connect you with trusted wellness practitioners and Ayurveda experts through secure, personalized consultations - anywhere in the world'); ?>
    ...
    <!-- What We Do Section -->
    <section class="scroll-mt-[120px] py-16 md:py-24 bg-white" id="what-we-do">

        <div class="container mx-auto px-4 mb-12 md:mb-20">
            <!-- Heading -->
            <div class="text-center">
                <h2 id="about_what_we_do_title" class="text-3xl sm:text-4xl md:text-5xl font-serif font-bold text-primary">
                    <?php echo e($settings['about_what_we_do_title'] ?? 'What we do?'); ?>
        ...
        <div class="relative w-full mb-16 md:mb-24">
            ...
            <!-- Left Line -->
            <img src="<?php echo e(asset('frontend/assets/what-we-do-left-line.png')); ?>"
                class="absolute left-0 top-5 lg:top-10 xl:top-1/2 lg:-translate-y-1/2  w-[15vw] lg:w-[10vw] xl:w-[15vw] max-w-[250px]"
                alt="">

            <!-- Right Plant -->
            <img src="<?php echo e(asset('frontend/assets/what-we-do-img-01.png')); ?>"
                class="absolute right-0 top-auto -bottom-12 lg:top-1/2 lg:-translate-y-1/2 w-14 lg:w-[12vw] max-w-[200px]"
                alt="Vision Leaves">
        </div>
        ...
        <div class="relative w-full">
            <div class="container mx-auto px-4 flex flex-col md:flex-row justify-end items-center">
                ...
                <div class="w-full lg:w-8/12 lg:mr-[10%] xl:mr-[14%] text-center lg:text-right">
                    <div class="flex flex-col items-center lg:items-end">
                        <h3 id="about_mission_title" class="text-3xl md:text-4xl font-serif font-bold text-secondary mb-6">
                            <?php echo e($settings['about_mission_title'] ?? 'Our Mission'); ?>

                        </h3>
                        <p id="about_mission_description"
                            class="text-gray-600 leading-relaxed text-base md:text-lg xl:max-w-2xl">
                            <?php echo e($settings['about_mission_description'] ?? "We're on a mission to support the practitioners and simplify the wellness process for everyone across the globe. Driven by a passion for holistic health, our team empowers practitioners to provide the best care that you deserve."); ?>
            ...
            <!-- Left Plant -->
            <img src="<?php echo e(asset('frontend/assets/what-we-do-img-02.png')); ?>"
                class="absolute left-0 top-auto -bottom-20 lg:top-1/2 lg:-translate-y-1/2 w-20 lg:w-[15vw] max-w-[280px]"
                alt="Mission Leaves">

            <!-- Right Line -->
            <img src="<?php echo e(asset('frontend/assets/what-we-do-right-line.png')); ?>"
    ...
    <section class="py-16 md:py-24 bg-white" id="core-values">
        <div class="container mx-auto px-4">
            ...
            <div class="text-center mb-16 md:mb-20">
                <h2 id="about-core-values-title"
                    class="text-3xl sm:text-4xl md:text-5xl font-serif font-bold text-primary tracking-wide">
                    <?php echo e(__('Core Values')); ?>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-y-16 gap-x-8 max-w-7xl mx-auto">
                ...
                <div class="flex flex-col items-center text-center group">
                    ...
                    <h3 id="about-value-1-title" class="text-xl font-bold text-gray-900 mb-3 font-sans!">
                        <?php echo e(__('Trust & Ethics')); ?>

                    </h3>
                    <p id="about-value-1-desc" class="text-gray-500 leading-relaxed max-w-xs mx-auto text-base">
                        <?php echo e(__('We respect the practitioner-client relationship and uphold transparency in every interaction.')); ?>
                ...
                <div class="flex flex-col items-center text-center group">
                    ...
                    <h3 id="about-value-2-title" class="text-xl font-bold text-gray-900 mb-3 font-sans!">
                        <?php echo e(__('Holistic Care')); ?>

                    </h3>
                    <p id="about-value-2-desc" class="text-gray-500 leading-relaxed max-w-xs mx-auto text-base">
                        <?php echo e(__('We believe in treating the whole person through Ayurveda, yoga, and mindfulness.')); ?>
                ...
                <div class="flex flex-col items-center text-center group">
                    ...
                    <h3 id="about-value-3-title" class="text-xl font-bold text-gray-900 mb-3 font-sans!">
                        <?php echo e(__('Collaboration')); ?>

                    </h3>
                    <p id="about-value-3-desc" class="text-gray-500 leading-relaxed max-w-xs mx-auto text-base">
                        <?php echo e(__('We foster meaningful partnerships between practitioners and specialists.')); ?>
                ...
                <div class="flex flex-col items-center text-center group">
                    ...
                    <h3 id="about-value-4-title" class="text-xl font-bold text-gray-900 mb-3 font-sans!">
                        <?php echo e(__('Human-Centered Technology')); ?>

                    </h3>
                    <p id="about-value-4-desc" class="text-gray-500 leading-relaxed max-w-xs mx-auto text-base">
                        <?php echo e(__('We use technology to support care, not to replace it.')); ?>
                ...
                <div class="flex flex-col items-center text-center group">
                    ...
                    <h3 id="about-value-5-title" class="text-xl font-bold text-gray-900 mb-3 font-sans!">
                        <?php echo e(__('Accessibility')); ?>

                    </h3>
                    <p id="about-value-5-desc" class="text-gray-500 leading-relaxed max-w-xs mx-auto text-base">
                        <?php echo e(__('We strive to make quality wellness services available across borders and languages.')); ?>
                ...
                <div class="flex flex-col items-center justify-center h-full pt-8 md:pt-0">
                    <a id="about-services-btn" href="<?php echo e(route('services')); ?>"
                        ...
                        <?php echo e(__('Go to Our Services')); ?>
        ...
        <div class="container-fluid">
            ...
            <div class="text-center mb-16 md:mb-24">
                <h2 id="about_team_title"
                    ...
                    <?php echo e($settings['about_team_title'] ?? 'Meet the Team'); ?>

                </h2>
                <p id="about_team_subtitle" class="text-[#404040] text-base mx-auto">
                    <?php echo e($settings['about_team_subtitle'] ?? 'Meet the people behind your wellness journey - empowering providers and smoothing the path to whole-body health.'); ?>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-y-10 md:gap-y-16">
                ...
                <div class="group flex flex-col items-center">
                    <div
                        ...
                        <img src="<?php echo e(asset('frontend/assets/team/sarath-sasankan-img.png')); ?>" alt="Sarath Sasankan"
                ...
                <div class="group flex flex-col items-center">
                    <div
                        class="w-full h-[350px] bg-[#EAF9F2] mb-6 flex items-end justify-center overflow-hidden rounded-sm">
                        <img src="<?php echo e(asset('frontend/assets/team/dr-yadun-m-r.png')); ?>" alt="Dr. Yadun M R"
                            class="h-[90%] object-contain group-hover:scale-105 transition-transform duration-500">
                    </div>
                ...
                <div class="group flex flex-col items-center">
                    <div
                        class="w-full h-[350px] bg-[#EAF9F2] mb-6 flex items-end justify-center overflow-hidden rounded-sm">
                        <img src="<?php echo e(asset('frontend/assets/team/dr-parvathi-s.png')); ?>" alt="Dr. Parvathy S"
                            class="h-[90%] object-contain group-hover:scale-105 transition-transform duration-500">
                    </div>
                ...
                <div class="group flex flex-col items-center">
                    <div
                        class="w-full h-[350px] bg-[#EAF9F2] mb-6 flex items-end justify-center overflow-hidden rounded-sm">
                        <img src="<?php echo e(asset('frontend/assets/team/arun-lekshmy.png')); ?>" alt="Arun Lekshmy"
                            class="h-[90%] object-contain group-hover:scale-105 transition-transform duration-500">
                    </div>
                ...
                <div class="group flex flex-col items-center">
                    <div
                        class="w-full h-[350px] bg-[#EAF9F2] mb-6 flex items-end justify-center overflow-hidden rounded-sm">
                        <img src="<?php echo e(asset('frontend/assets/team/saneejja.png')); ?>" alt="Saneejjaa"
                            class="h-[90%] object-contain group-hover:scale-105 transition-transform duration-500">
                    </div>
                ...
                <div class="group flex flex-col items-center">
                    <div
                        class="w-full h-[350px] bg-[#EAF9F2] mb-6 flex items-end justify-center overflow-hidden rounded-sm">
                        <img src="<?php echo e(asset('frontend/assets/team/sangeeth-s.png')); ?>" alt="Sangeeth S"
                            class="h-[90%] object-contain group-hover:scale-105 transition-transform duration-500">
                    </div>
                ...
                <div class="group flex flex-col items-center">
                    <div
                        class="w-full h-[350px] bg-[#EAF9F2] mb-6 flex items-end justify-center overflow-hidden rounded-sm">
                        <img src="<?php echo e(asset('frontend/assets/team/volga-benjamin.png')); ?>" alt="Volga Benjamin"
                            class="h-[90%] object-contain group-hover:scale-105 transition-transform duration-500">
                    </div>
                ...
                <div class="group flex flex-col items-center">
                    <div
                        class="w-full h-[350px] bg-[#EAF9F2] mb-6 flex items-end justify-center overflow-hidden rounded-sm">
                        <img src="<?php echo e(asset('frontend/assets/team/shiju-philipose.png')); ?>" alt="Shiju Philipose"
                            class="h-[90%] object-contain group-hover:scale-105 transition-transform duration-500">
                    </div>
                ...
                <div class="group flex flex-col items-center">
                    <div
                        class="w-full h-[350px] bg-[#EAF9F2] mb-6 flex items-end justify-center overflow-hidden rounded-sm">
                        <img src="<?php echo e(asset('frontend/assets/team/aarathy-m.png')); ?>" alt="Aarathy M"
                            class="h-[90%] object-contain group-hover:scale-105 transition-transform duration-500">
                    </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8 max-w-6xl mx-auto">
                ...
                <div
                    ...
                    <h3 id="about-cta-1-title" class="text-2xl font-sans! font-regular text-gray-900 mb-8 leading-tight">
                        <?php echo e(__('Ready to start your wellness journey?')); ?>

                    </h3>
                    <a id="about-cta-1-btn" href="<?php echo e(route('book-session')); ?>"
                        ...
                        <?php echo e(__('Book a Practitioner')); ?>
                ...
                <div
                    ...
                    <h3 id="about-cta-2-title" class="text-2xl font-sans! font-regular text-gray-900 mb-8 leading-tight">
                        <?php echo e(__('Join our community of holistic experts.')); ?>

                    </h3>
                    <a id="about-cta-2-btn" href="<?php echo e(route('practitioner-register')); ?>"
    ...
    <section class="py-4 bg-[#F9EBD6]">
        <div class="container mx-auto px-4 flex flex-col md:flex-row items-center justify-center gap-6 md:gap-8">
            <p id="about-help-title"
                ...
                <?php echo e(__("Have questions? We're here to help.")); ?>

            </p>
            <a id="about-help-btn" href="<?php echo e(route('contact-us')); ?>"
    ...
    <section class="py-20 pb-0 md:pt-28 md:pb-0 bg-white text-center relative overflow-hidden">
        ...
        <div class="container mx-auto px-6 max-w-4xl relative z-10">
            <h2 id="about-testimonials-title"
                class="text-4xl lg:text-5xl font-serif font-bold text-primary mb-14 animate-on-scroll">
                <?php echo e($settings['testimonials_title'] ?? __('What people say about Zaya?')); ?>
                    ...
                    <?php $__currentLoopData = $testimonials; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $testimonial): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="swiper-slide w-auto">
                            <div class="p-4">
                                ...
                                <p class="text-[#404040] text-sm/7 mb-6">"<?php echo e($testimonial->message); ?>"</p>
                                <div class="flex items-center justify-between mt-6 pt-6 border-t border-gray-100">
                                    ...
                                    <div class="flex items-center gap-4 text-gray-400">
                                        <div class="flex items-center gap-1.5 cursor-pointer hover:text-primary transition-colors testimonial-like-btn <?php echo e($testimonial->is_liked ? 'text-primary' : ''); ?>"
                                            data-id="<?php echo e($testimonial->id); ?>">
                                            <i
                                                class="<?php echo e($testimonial->is_liked ? 'ri-thumb-up-fill' : 'ri-thumb-up-line'); ?> text-lg"></i>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\wamp64\www\zaya\resources\views\about.blade.php ENDPATH**/ ?>