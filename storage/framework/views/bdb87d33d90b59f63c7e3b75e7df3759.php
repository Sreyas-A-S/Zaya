<?php $__env->startSection('title', 'Select Registration Type'); ?>
                ...
                <div class="card-body text-center">
                    <div class="text-center">
                        <a class="logo" href="<?php echo e(route('login')); ?>">
                            <img class="img-fluid for-light m-auto mb-4 d-block" src="<?php echo e(asset('admiro/assets/images/logo/zaya wellness logo white.svg')); ?>" alt="logo" style="max-height: 60px;">
                            <img class="img-fluid for-dark m-auto mb-4 d-block" src="<?php echo e(asset('admiro/assets/images/logo/zaya wellness logo white.svg')); ?>" alt="logo" style="max-height: 60px;">
                        </a>
                    </div>
                    ...
                    <div class="mt-5">
                        <p class="mb-0">Already have an account? <a class="ms-2" href="<?php echo e(route('login')); ?>">Sign in</a></p>
                    </div>
                </div>
            </div>
        </div>
...
<?php echo $__env->make('layouts.auth', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\wamp64\www\zaya\resources\views\auth\register_selection.blade.php ENDPATH**/ ?>