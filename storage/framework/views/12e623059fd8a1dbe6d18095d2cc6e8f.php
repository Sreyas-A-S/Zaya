<?php $__env->startSection('title', 'Session Recording - ' . $booking->practitioner->user->name); ?>

<?php $__env->startSection('content'); ?>
<div class="bg-[#F9FAFB] min-h-screen py-8 md:py-20">
    <div class="container mx-auto px-4 md:px-6">
        <!-- Back Link -->
        <a href="<?php echo e(route('conferences.index')); ?>" class="inline-flex items-center text-secondary hover:text-opacity-80 transition-colors mb-6 md:mb-8 group text-sm md:text-base">
            ...
            <div class="flex flex-col md:flex-row md:items-end justify-between mb-6 md:mb-8 gap-4">
                <div>
                    ...
                    <p class="text-gray-500 text-sm md:text-base">
                        Consultation with <span class="text-secondary font-medium"><?php echo e($booking->practitioner->user->name); ?></span> 
                        <span class="hidden md:inline">on</span><br class="md:hidden"> <?php echo e($booking->booking_date->format('F d, Y')); ?> at <?php echo e($booking->booking_time); ?>
                ...
                <div class="relative group aspect-video bg-black overflow-hidden" id="player-container">
                    ...
                    <div id="video-error-overlay" class="absolute inset-0 z-50 bg-[#1A1A1A] flex items-center justify-center p-6 text-center hidden">
                        <div class="max-w-sm">
                            ...
                            <a href="<?php echo e(route('conferences.index')); ?>" class="inline-flex px-6 py-2.5 md:px-8 md:py-3 bg-secondary text-white rounded-full font-medium hover:bg-opacity-90 transition-all text-xs md:text-sm">
                                Return to History
                            </a>
                        </div>
                    </div>
                    ...
                    <video id="main-player" class="w-full h-full cursor-pointer" playsinline>
                        <source src="<?php echo e($booking->recording_url); ?>" type="video/mp4">
                    </video>
                ...
                <div class="p-5 md:p-10 flex flex-col sm:flex-row items-center justify-between gap-4 md:gap-6 border-t border-gray-50">
                    <div class="flex items-center gap-3 md:gap-4 w-full sm:w-auto">
                        ...
                        <div>
                            ...
                            <p class="text-sm md:text-lg font-bold text-secondary"><?php echo e($booking->invoice_no); ?></p>
                        </div>
                    </div>
                    ...
                    <div class="flex items-center justify-between sm:justify-end gap-4 md:gap-6 w-full sm:w-auto border-t sm:border-t-0 pt-4 sm:pt-0">
                        <div class="text-left sm:text-right">
                            ...
                            <p class="text-sm md:text-lg font-bold text-secondary"><?php echo e($booking->booking_date->format('M d, Y')); ?></p>
                        </div>
                    </div>
                </div>
            </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\wamp64\www\zaya\resources\views\recordings\show.blade.php ENDPATH**/ ?>