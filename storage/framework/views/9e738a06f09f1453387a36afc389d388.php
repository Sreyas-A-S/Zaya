<?php $__env->startSection('title', 'Transaction Vault'); ?>
        ...
        <div class="flex items-center justify-between relative z-10">
            <div>
                ...
                <div class="flex items-baseline gap-2">
                    <span class="text-4xl font-black text-secondary tracking-tight">₹ <?php echo e(number_format($totalBalance, 2)); ?></span>
...
<div id="table-wrapper" class="transition-opacity duration-300">
    <?php echo $__env->make('partials.transactions-table', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
</div>
...
<script>
    function openTransactionModal(data) {
        ...
        if (data.practitioner_id == <?php echo e(auth()->id()); ?>) {
            shareLabel = 'Your Practitioner Share';
            shareValue = data.practitioner_share;
        } else if (data.referrer_id == <?php echo e(auth()->id()); ?>) {
...
<?php echo $__env->make('layouts.client', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\wamp64\www\zaya\resources\views\transactions.blade.php ENDPATH**/ ?>