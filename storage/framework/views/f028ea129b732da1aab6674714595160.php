...
<section class="pt-[144px] md:pt-[150px] pb-8 lg:pb-20 px-4 md:px-6 bg-white">
    <div class="container mx-auto max-w-6xl">
            ...
            <div class="swiper mainImageSwiper h-full">
                <div class="swiper-wrapper">
                    ...
                    <div class="swiper-slide">
                        <img src="<?php echo e(Str::startsWith($service->image, 'frontend/') ? asset($service->image) : asset('storage/' . $service->image)); ?>"
                            alt="<?php echo e($service->title); ?>" class="w-full h-full object-cover">
                    </div>
                    <?php endif; ?>

                    <?php $__currentLoopData = $service->images; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $img): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="swiper-slide">
                    ...
                    <?php if(!$service->image && $service->images->isEmpty()): ?>
                    <div class="swiper-slide">
                        <img src="<?php echo e(asset('frontend/assets/ayurveda-and-panchakarma-01.jpg')); ?>"
                            alt="<?php echo e($service->title); ?>" class="w-full h-full object-cover">
                    </div>
                    <?php endif; ?>
                </div>
        ...
        <div class="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-6 mb-10 pb-8 border-b border-gray-100">
            <div>
                <h1 class="text-2xl md:text-4xl font-sans! font-bold text-secondary mb-2 tracking-tight"><?php echo e($service->title); ?></h1>
            ...
            <div class="flex items-center gap-4 w-full sm:w-auto">
                <a href="<?php echo e(route('find-practitioner', ['service' => $service->slug ?? $service->id])); ?>"
        ...
        <div class="service-description-content max-w-none">
            <?php echo html_entity_decode(str_replace(['font-weight: normal;', 'font-weight: normal'], '', $service->description)); ?>
...
<section class="pt-0 pb-16 bg-white text-center">
    <div class="container mx-auto px-4 md:px-6 max-w-2xl">
        ...
        <a href="<?php echo e(route('find-practitioner', ['service' => $service->slug ?? $service->id])); ?>" class="inline-block bg-secondary text-white px-10 py-4 rounded-full font-normal hover:bg-primary transition-all shadow-lg">Book a Session</a>
    </div>
</section>
...
<script>
    ...
    function shareService() {
        if (navigator.share) {
            navigator.share({ title: '<?php echo e($service->title); ?> | Zaya Wellness', url: window.location.href }).catch(console.error);
        } else {
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\wamp64\www\zaya\resources\views\service-detail.blade.php ENDPATH**/ ?>