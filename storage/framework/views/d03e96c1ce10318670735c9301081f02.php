<?php $__env->startSection('title', 'Gallery Page Settings'); ?>
    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="card">
                ...
                <div class="card-body">
                    <form id="gallerySettingsForm" action="<?php echo e(route('admin.gallery-settings.update')); ?>" method="POST" enctype="multipart/form-data">
                        <?php echo csrf_field(); ?>
                        <div class="row g-3">
                            <div class="col-md-3">
                            ...
                            <div class="col-md-9 border-start">
                                <div class="tab-content" id="v-pills-tabContent">
                                    ...
                                    <div class="tab-pane fade p-3" id="v-pills-sanctuary" role="tabpanel" aria-labelledby="v-pills-sanctuary-tab">
                                        <div class="row g-4">
                                            <?php $__currentLoopData = $sanctuarySettings; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $setting): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <?php echo $__env->make('admin.services-settings.partials.field', ['setting' => $setting, 'aspectRatio' => '1.33'], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                        </div>
                                    </div>
                                    ...
                                    <div class="tab-pane fade p-3" id="v-pills-movement" role="tabpanel" aria-labelledby="v-pills-movement-tab">
                                        <div class="row g-4">
                                            <?php $__currentLoopData = $movementSettings; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $setting): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <?php echo $__env->make('admin.services-settings.partials.field', ['setting' => $setting, 'aspectRatio' => '0.75'], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                        </div>
                                    </div>
                                    ...
                                    <div class="tab-pane fade p-3" id="v-pills-rituals" role="tabpanel" aria-labelledby="v-pills-rituals-tab">
                                        <div class="row g-4">
                                            <?php $__currentLoopData = $ritualsSettings; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $setting): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <?php echo $__env->make('admin.services-settings.partials.field', ['setting' => $setting, 'aspectRatio' => '1.33'], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                        </div>
                                    </div>
                                    ...
                                    <div class="tab-pane fade p-3" id="v-pills-retreats" role="tabpanel" aria-labelledby="v-pills-retreats-tab">
                                        <div class="row g-4">
                                            <?php $__currentLoopData = $retreatsSettings; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $setting): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <?php echo $__env->make('admin.services-settings.partials.field', ['setting' => $setting, 'aspectRatio' => '1.33'], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                        </div>
                                    </div>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\wamp64\www\zaya\resources\views\admin\gallery-settings\index.blade.php ENDPATH**/ ?>