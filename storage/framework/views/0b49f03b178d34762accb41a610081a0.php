<header class="page-header row">
    ...
    <div class="logo-wrapper d-flex align-items-center col-auto">
        <a href="<?php echo e(route('admin.dashboard')); ?>" class="d-flex align-items-center gap-2 text-decoration-none me-3">
            <img src="<?php echo e(asset('admiro/assets/images/logo/zaya-logo-admin.svg')); ?>" alt="logo" style="width: 60px;">
        </a>
            ...
            <ul class="header-right">
                <li class="custom-dropdown">
                    ...
                    if ($code >= 65 && $code <= 90) {
                        ...
                        <a class="lang lang-dropdown-trigger" href="javascript:void(0)" style="min-width: 100px; display: flex; align-items: center; text-decoration: none; padding: 10px 0; gap: 6px; background: none !important; border-radius: 0 !important;">
                            ...
                            <?php if($currentLocale !== 'all'): ?>
                            <img src="<?php echo e(asset('admiro/assets/fonts/flag-icon/' . ($currentLanguage ? getCountryCode($currentLanguage) : 'us') . '.svg')); ?>" style="width: 20px; height: 14px; border: 1px solid #eee; border-radius: 2px;" alt="flag">
                            <?php endif; ?>
                            <h6 class="lang-txt f-w-700 mb-0" style="color: #2b2b2b; font-size: 13px;"><?php echo e($currentLocale === 'all' ? 'ALL' : ($currentLanguage ? strtoupper($currentLanguage->code) : 'EN')); ?></h6>
                        </a>

                        <div class="custom-menu overflow-hidden">
                            <div class="dropdown-header py-2 px-3 border-bottom bg-light">
                                <span class="f-w-700 text-dark small"><?php echo e(__('SELECT LANGUAGE')); ?></span>
                            </div>
                            <ul class="profile-body language-menu-list" style="max-height: 350px; overflow-y: auto; padding: 5px;">
                                <?php if(in_array($user?->role, ['super-admin', 'admin', 'country-admin', 'financial-manager', 'content-manager', 'user-manager'])): ?>
                                <li class="d-flex align-items-center last-0" style="cursor: pointer;">
                                    <a href="javascript:void(0)"
                                        class="lang d-flex align-items-center w-100 <?php echo e($currentLocale == 'all' ? 'active text-primary' : ''); ?>"
                                        data-value="all"
                                        data-flag="<?php echo e(asset('admiro/assets/images/dashboard/all-countries.png')); ?>"
                                        ...
                                        <span class="f-w-600 small"><?php echo e(__('ALL LANGUAGES')); ?></span>
                                        <?php if($currentLocale == 'all'): ?>
                                ...
                                <?php endif; ?>
                                <?php if($languages->isEmpty() && !in_array($user?->role, ['super-admin', 'admin', 'country-admin', 'financial-manager', 'content-manager', 'user-manager'])): ?>
                                <li class="p-3 text-center text-muted small"><?php echo e(__('No assigned languages')); ?></li>
                                <?php endif; ?>
                                <?php $__currentLoopData = $languages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $lang): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <li class="d-flex align-items-center last-0" style="cursor: pointer;">
                                    <a href="javascript:void(0)"
                                        class="lang d-flex align-items-center w-100 <?php echo e($currentLocale == $lang->code ? 'active text-primary' : ''); ?>"
                                        data-value="<?php echo e($lang->code); ?>"
                                        data-flag="<?php echo e(asset('admiro/assets/fonts/flag-icon/' . getCountryCode($lang) . '.svg')); ?>"
                                        onclick="changeLanguage(this)"
                                        style="text-decoration: none; color: inherit; padding: 8px 12px !important;">
                                        <img src="<?php echo e(asset('admiro/assets/fonts/flag-icon/' . getCountryCode($lang) . '.svg')); ?>" style="width: 18px; height: 13px; margin-right: 10px; border: 1px solid #f0f0f0; border-radius: 1px;" alt="flag">
                                        <span class="f-w-600 small"><?php echo e(strtoupper($lang->name)); ?></span>
                                        <?php if($currentLocale == $lang->code): ?>
                                        <i class="fa fa-check ms-auto text-primary" style="font-size: 10px;"></i>
                                        <?php endif; ?>
                                    </a>
                                </li>
                ...
                <li class="custom-dropdown">
                    <a class="lang country-dropdown-trigger" href="javascript:void(0)" style="min-width: 100px; display: flex; align-items: center; text-decoration: none; padding: 10px 0; gap: 6px; background: none !important; border-radius: 0 !important;">
                        ...
                        <?php if($currentCountryCode !== 'all'): ?>
                        <img src="<?php echo e(asset('admiro/assets/fonts/flag-icon/' . ($currentCountry ? strtolower($currentCountry->code) : 'us') . '.svg')); ?>" style="width: 20px; height: 14px; border: 1px solid #eee; border-radius: 2px;" alt="flag">
                        <?php endif; ?>
                        <h6 class="country-txt f-w-700 mb-0" style="color: #2b2b2b; font-size: 13px;"><?php echo e($currentCountryCode === 'all' ? 'ALL' : ($currentCountry ? strtoupper($currentCountry->code) : 'US')); ?></h6>
                    </a>

                    <div class="custom-menu overflow-hidden">
                        <div class="dropdown-header py-2 px-3 border-bottom bg-light">
                            <span class="f-w-700 text-dark small"><?php echo e(__('SELECT REGION')); ?></span>
                        </div>
                        <ul class="profile-body country-menu-list" style="max-height: 350px; overflow-y: auto; padding: 5px;">
                            <?php if(in_array($user?->role, ['super-admin', 'admin', 'country-admin', 'financial-manager', 'content-manager', 'user-manager'])): ?>
                            <li class="d-flex align-items-center last-0" style="cursor: pointer;">
                                <a href="javascript:void(0)"
                                    class="lang d-flex align-items-center w-100 <?php echo e($currentCountryCode == 'all' ? 'active text-primary' : ''); ?>"
                                    data-value="all"
                                    data-flag="<?php echo e(asset('admiro/assets/images/dashboard/all-countries.png')); ?>"
                                    onclick="changeCountry(this)"
                                    style="text-decoration: none; color: inherit; padding: 8px 12px !important;">
                                    <i class="fa fa-earth-americas ms-1 me-2 text-muted" style="width: 18px; font-size: 14px;"></i>
                                    <span class="f-w-600 small"><?php echo e(__('ALL REGIONS')); ?></span>
                                    <?php if($currentCountryCode == 'all'): ?>
                                    <i class="fa fa-check ms-auto text-primary" style="font-size: 10px;"></i>
                                    <?php endif; ?>
                                </a>
                            ...
                            <?php endif; ?>
                            <?php if($userCountries->isEmpty() && !in_array($user?->role, ['super-admin', 'admin', 'country-admin', 'financial-manager', 'content-manager', 'user-manager'])): ?>
                            <li class="p-3 text-center text-muted small"><?php echo e(__('No assigned regions')); ?></li>
                            <?php endif; ?>
                            <?php $__currentLoopData = $userCountries; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $country): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <li class="d-flex align-items-center last-0" style="cursor: pointer;">
                                <a href="javascript:void(0)"
                                    class="lang d-flex align-items-center w-100 <?php echo e(strtoupper($currentCountryCode) == $country->code ? 'active text-primary' : ''); ?>"
                                    data-value="<?php echo e($country->code); ?>"
                                    data-flag="<?php echo e(asset('admiro/assets/fonts/flag-icon/' . strtolower($country->code) . '.svg')); ?>"
                                    onclick="changeCountry(this)"
                                    style="text-decoration: none; color: inherit; padding: 8px 12px !important;">
                                    <img src="<?php echo e(asset('admiro/assets/fonts/flag-icon/' . strtolower($country->code) . '.svg')); ?>" style="width: 18px; height: 13px; margin-right: 10px; border: 1px solid #f0f0f0; border-radius: 1px;" alt="flag">
                                    <span class="f-w-600 small"><?php echo e(strtoupper($country->name)); ?></span>
                                    <?php if(strtoupper($currentCountryCode) == $country->code): ?>
                                    <i class="fa fa-check ms-auto text-primary" style="font-size: 10px;"></i>
                                    <?php endif; ?>
                                </a>
                            </li>
                ...
                <li class="profile-nav custom-dropdown">
                    <div class="user-wrap">
                        <div class="user-img"><img src="<?php echo e($user?->profile_pic ? '/storage/' . $user->profile_pic : asset('admiro/assets/images/user/user.png')); ?>" alt="user" style="width: 40px; height: 40px; border-radius: 50%; object-fit: cover;" /></div>
                        <div class="user-content">
                            <h6><?php echo e($user?->name ?? 'Guest'); ?></h6>
                            <p class="mb-0 text-capitalize"><?php echo e($user?->role ?? 'User'); ?><i class="fa-solid fa-chevron-down"></i></p>
                        </div>
                    </div>
                    <div class="custom-menu overflow-hidden">
                        <ul class="profile-body">
                            <li class="d-flex">
                                ...
                                </svg><a class="ms-2" href="<?php echo e(route('admin.profile')); ?>"><?php echo e(__('My Profile')); ?></a>
                            </li>
                            <li class="d-flex">
                                <svg class="svg-color">
                                    <use href="<?php echo e(asset('admiro/assets/svg/iconly-sprite.svg#Login')); ?>"></use>
                                </svg>
                                <a class="ms-2" href="<?php echo e(route('logout')); ?>" onclick="event.preventDefault(); document.getElementById('logout-form').submit();"><?php echo e(__('Log Out')); ?></a>
...
<script>
    ...
    localStorage.setItem('selectedLanguage', '<?php echo e($currentLocale); ?>');
    ...
    function changeLanguage(element) {
        ...
        fetch(`<?php echo e(url('admin/change-language')); ?>/${id}`, {
                method: "POST",
                headers: {
    ...
    function changeCountry(element) {
        ...
        fetch(`<?php echo e(url('admin/change-country')); ?>/${code}`, {
                method: "POST",
                headers: {
                    "X-CSRF-TOKEN": "<?php echo e(csrf_token()); ?>",
                    "Accept": "application/json"
...
<?php /**PATH C:\wamp64\www\zaya\resources\views/partials/navbar.blade.php ENDPATH**/ ?>