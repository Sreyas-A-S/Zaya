...
<head>
    ...
    <?php echo app('Illuminate\Foundation\Vite')(['resources/css/app.css', 'resources/css/book-session.css', 'resources/js/app.js']); ?>
...
<body class="min-h-screen flex flex-col">
    ...
    <div class="w-full">
        ...
        ?>
        <input type="hidden" id="booking-currency" name="currency" value="<?php echo e($defaultCurrencyBooking); ?>">
        ...
        <div
            ...
            <div class="flex items-start justify-center gap-0 w-full max-w-3xl" id="step-indicator">
                <div class="flex flex-col items-center relative z-2 px-1 sm:px-4 md:px-8">
                    <div class="w-8 h-8 md:w-10 md:h-10 rounded-full flex items-center justify-center font-semibold text-sm md:text-base transition-all duration-300 <?php echo e($isClient ? 'bg-[#E6E6E6] text-[#8B8B8B]' : 'bg-[#60E48C] text-white'); ?>"
                        id="step-circle-1">1</div>
                    <span
                        class="text-xs md:text-base <?php echo e($isClient ? 'text-gray-400' : 'text-gray-700'); ?> mt-2.5 font-normal whitespace-normal md:whitespace-nowrap text-center max-w-[70px] sm:max-w-none leading-tight"
                        id="step-label-1" data-i18n="Login"><?php echo e(__('Login')); ?></span>
                </div>
                <div class="w-10 sm:w-16 md:w-[100px] lg:w-[140px] h-0 border-t-2 border-dashed border-[#C0C0C0] self-center shrink-0 relative top-[-15px] sm:top-[-10px] md:top-[-14px]"
                    id="step-line-1"></div>
                <div class="flex flex-col items-center relative z-2 px-1 sm:px-4 md:px-8">
                    <div class="w-8 h-8 md:w-10 md:h-10 rounded-full flex items-center justify-center font-semibold text-sm md:text-base transition-all duration-300 <?php echo e($isClient ? 'bg-[#60E48C] text-white' : 'bg-[#E6E6E6] text-[#8B8B8B]'); ?>"
                        id="step-circle-2">2</div>
                    <span
                        class="text-xs md:text-base <?php echo e($isClient ? 'text-gray-700' : 'text-gray-400'); ?> mt-2.5 font-normal whitespace-normal md:whitespace-nowrap text-center max-w-[70px] sm:max-w-none leading-tight"
                        id="step-label-2" data-i18n="Schedule booking"><?php echo e(__('Schedule booking')); ?></span>
                </div>
                <div class="w-10 sm:w-16 md:w-[100px] lg:w-[140px] h-0 border-t-2 border-dashed border-[#C0C0C0] self-center shrink-0 relative top-[-15px] sm:top-[-10px] md:top-[-14px]"
                    id="step-line-2"></div>
                <div class="flex flex-col items-center relative z-2 px-1 sm:px-4 md:px-8">
                    ...
                    <span
                        ...
                        id="step-label-3" data-i18n="Booking confirmation"><?php echo e(__('Booking confirmation')); ?></span>
                </div>
            </div>
            ...
            <div class="hidden lg:flex absolute right-10 top-1/2 -translate-y-1/2">
                ...
                ?>
                <?php if($available_languages->count() >= 2): ?>
        ...
        <div class="relative <?php echo e($isClient ? 'hidden' : ''); ?>" id="step-1-content">
            <!-- Gradient Background -->
            <div class="relative overflow-hidden h-[calc(100vh-100px)]"
                style="background-image: url('<?php echo e(asset('frontend/assets/book-session-bg.jpg')); ?>'); background-size: cover; background-position: center; background-repeat: no-repeat;">
                <!-- Decorative Images - Left: Aloe Vera with water splash -->
                <img src="<?php echo e(asset('frontend/assets/aloevera-leaves.png')); ?>" alt="Aloe Vera Leaves"
                ...
                <img src="<?php echo e(asset('frontend/assets/water-splash.png')); ?>" alt="Water Splash"
                ...
                <div
                    ...
                    <h1 class="text-3xl md:text-4xl lg:text-5xl font-sans! font-medium text-gray-900 mb-6" data-i18n="Welcome to ZAYA"><?php echo e(__('Welcome to ZAYA')); ?></h1>
                    <p class="text-gray-600 text-lg md:text-xl mb-12 max-w-lg" data-i18n="Please identify yourself to continue with your booking.">
                        <?php echo e(__('Please identify yourself to continue with your booking.')); ?>

                    </p>
 
                    <!-- Action Buttons -->
                    <div class="flex flex-col sm:flex-row items-center gap-4">
                        <a href="<?php echo e(route('client-register', ['redirect' => request()->fullUrl()])); ?>"
        ...
        <div class="<?php echo e($isClient ? '' : 'hidden'); ?>" id="step-2-content">
            <div class="max-w-4xl mx-auto px-4 py-8">

                <!-- Select Session Mode -->
                <div class="text-center mb-8">
                    <h2 class="text-xl md:text-xl font-sans! font-normal text-[#404040] mb-6" data-i18n="Select Session Mode"><?php echo e(__('Select Session Mode')); ?>
                    ...
                    <div class="inline-flex gap-4">
                        <button type="button"
                            ...
                            data-mode="online" data-i18n="Online"><?php echo e(__('Online')); ?></button>
                        <button type="button"
                            ...
                            data-mode="in-person" data-i18n="In Person"><?php echo e(__('In Person')); ?></button>
                    </div>
                </div>
                ...
                <div
                    ...
                    <div class="flex items-center gap-4">
                        <img src="<?php echo e($practitionerImage); ?>" alt="<?php echo e($practitionerName); ?>"
                        ...
                        <div>
                            <div class="flex items-center gap-4 mb-2">
                                <h3 class="font-medium font-sans! text-gray-900 lg:text-2xl text-xl  leading-none">
                                    <?php echo e($practitionerName); ?>

                                </h3>
                                <div>
                                    <i class="ri-star-fill text-base text-[#29724C] leading-none"></i>
                                    <span
                                        class="text-base leading-none text-[#29724C] align-middle font-medium"><?php echo e($practitionerRating); ?></span>
                                </div>
                            </div>
                            <p class="text-[#252525] text-base"><?php echo e($practitionerRole); ?></p>
                            <p class="text-[#7D7D7D] text-sm flex items-center gap-1 mt-2"><i
                                    class="ri-map-pin-line"></i>
                                <?php echo e($practitionerLocation); ?>
                ...
                <div class="mb-10">
                    <h3 class="text-gray-700 font-normal mb-4 text-lg" data-i18n="Why do you want to meet this counsellor?"><?php echo e(__('Why do you want to meet this counsellor?')); ?>

                    </h3>
                    <input type="text" id="conditions-input" placeholder="<?php echo e(__('Add conditions...')); ?>" readonly 
                    ...
                    <div class="flex flex-wrap gap-2" id="condition-tags-wrapper">
                        <?php $__empty_1 = true; $__currentLoopData = $practitionerConditions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $condition): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <?php $label = is_array($condition) ? ($condition['title'] ?? $condition['name'] ?? '') : $condition; ?>
                            <?php if(!empty($label)): ?>
                            <label
                                ...
                                <input type="checkbox" name="conditions[]" value="<?php echo e($label); ?>" class="sr-only">
                                <span><?php echo e($label); ?></span>
                            </label>
                            <?php endif; ?>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                            <p class="text-sm text-gray-500"><?php echo e(__('This counsellor has not listed specific conditions.')); ?></p>
                        <?php endif; ?>
                    </div>
                </div>
                ...
                <div class="mb-10">
                    <h3 class="text-gray-700 font-normal mb-4 text-lg" data-i18n="Do you want to explain your situation?">
                        <?php echo e(__('Do you want to explain your situation?')); ?>

                        <span class="italic" data-i18n="(Optional)">(<?php echo e(__('Optional')); ?>)</span>
                    </h3>
                    <textarea placeholder="<?php echo e(__('Write here...')); ?>"
                ...
                <div class="mb-10" id="service-search-container">
                    ...
                    <div class="flex flex-wrap gap-3" id="available-services-container">
                        ...
                        <label class="service-tag-label inline-block cursor-pointer select-none" data-service-name="<?php echo e(strtolower($service->title)); ?>" data-service-id="<?php echo e($service->id); ?>">
                            <input type="checkbox" class="peer hidden" value="<?php echo e($service->title); ?>" 
                                <?php echo e((isset($prefilledService) && $prefilledService->id == $service->id) || (!isset($prefilledService) && $loop->first) ? 'checked' : ''); ?>>
                            <div
                ...
                <div class="grid grid-cols-1 gap-6 mb-8 hidden" id="service-schedule-container">
                    <?php $__empty_1 = true; $__currentLoopData = $services; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $service): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <div class="service-schedule-item" data-service-name="<?php echo e(strtolower($service->title)); ?>" data-service-id="<?php echo e($service->id); ?>">
                        <h4 class="font-normal text-gray-400 mb-4">Service <span class="service-index"><?php echo e($loop->iteration); ?></span></h4>
                        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
                            <div class="relative flex-1">
                                <input type="text" value="<?php echo e($service->title); ?>" disabled
                                ...
                                <input type="hidden" name="services[<?php echo e($service->id); ?>][title]" value="<?php echo e($service->title); ?>">
                            </div>
                            <div class="relative flex-1">
                                <?php
                                ...
                                <div class="duration-picker-trigger h-full py-2 px-4 bg-[#F5F5F5] rounded-full flex items-center justify-between cursor-pointer hover:bg-[#EEEEEE] transition-colors"
                                    ...
                                    <span class="text-sm text-[#252525] font-medium duration-label">
                                       <?php echo e($defaultDurationLabel); ?>

                                    </span>
                                    <i class="ri-arrow-down-s-line text-gray-700 text-lg"></i>
                                    </div>
                                    <input type="hidden" name="services[<?php echo e($service->id); ?>][duration]" class="duration-value" 
                                    value="<?php echo e($defaultRate ? ($defaultRate->duration . ' Min') : ''); ?>">
                                <!-- Dropdown Menu -->
                                <div
                                    ...
                                    <div class="p-2">
                                        <?php $__empty_2 = true; $__currentLoopData = $rates; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $idx => $rate): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_2 = false; ?>
                                        <?php
                                        ...
                                        <label
                                            ...
                                            <div class="flex items-center gap-3">
                                                <input type="radio" name="temp_duration_<?php echo e($service->id); ?>" value="<?php echo e($label); ?>"
                                                    class="peer hidden" <?php echo e($idx === 0 ? 'checked' : ''); ?>>
                                                <div
                                                ...
                                                <span class="text-[15px] text-[#404040]"><?php echo e($label); ?></span>
                                            </div>
                                            <?php $symbol = $symbols[$rate->currency ?? $defaultCurrency] ?? ($rate->currency ?? $defaultCurrency); ?>
                                            <span class="text-[15px] font-medium text-[#29724C]" data-currency="<?php echo e($rate->currency ?? $defaultCurrency); ?>" data-symbol="<?php echo e($symbol); ?>"><?php echo e($symbol); ?> <?php echo e(number_format($price, 2)); ?></span>
                                        </label>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_2): ?>
                                        <div class="px-4 py-3 text-sm text-gray-500">
                                            <?php echo e(__('No durations set by this practitioner for this service.')); ?>
                            ...
                            <div class="relative flex-1">
                                ...
                                <input type="hidden" name="services[<?php echo e($service->id); ?>][day]" class="day-value">
                            ...
                            <div class="relative flex-1">
                                ...
                                <input type="hidden" name="services[<?php echo e($service->id); ?>][time]" class="time-value">
        ...
        <div class="max-w-4xl mx-auto px-4 py-8">
            ...
            <div
                ...
                <div class="flex items-center gap-4">
                    ...
                    <div>
                        <div class="flex items-center gap-4 mb-2">
                            <h3 class="font-medium font-sans! text-gray-900 lg:text-2xl text-xl leading-none"><?php echo e($practitionerName); ?>
                            ...
                            <div class="py-2">
                                <?php $__empty_1 = true; $__currentLoopData = $languages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $language): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                    <div class="dropdown-item px-6 py-3 text-base text-gray-700 cursor-pointer hover:bg-[#F9F9F9] transition-colors"
                                        data-value="<?php echo e($language->name); ?>"><?php echo e($language->name); ?></div>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
            ...
            <div class="text-center py-8 mb-8"
                ...
                <div class="text-4xl font-medium text-gray-900 flex items-center justify-center gap-2" id="step-3-total-amount">
                    <?php echo e($defaultCurrencySymbol); ?> 0.00 <span class="text-xl text-gray-400 font-normal">/ <?php echo e($defaultCurrencyBooking); ?></span>
                </div>
            </div>
            ...
            <div class="flex justify-center items-center gap-6 mb-12">
                <button type="button"
                    ...
                    onclick="previousStep()" data-i18n="Back"><?php echo e(__('Back')); ?></button>
    ...
    <script>
        ...
        async function submitBooking(btn) {
            ...
            const practitionerId = document.getElementById('selected-practitioner-id')?.value || <?php echo json_encode($activePractitioner ? $activePractitioner->id : null, 15, 512) ?>;
            ...
            try {
                const response = await fetch('<?php echo e(route('bookings.store')); ?>', {
                        method: 'POST',
                        headers: {
                            'X-CSRF-TOKEN': document.querySelector('meta[name="csrf-token"]').getAttribute('content'),
                            'Content-Type': 'application/json',
    ...
    <script>
        const isClient = <?php echo json_encode($isClient, 15, 512) ?>;
    ...
    <script>
        ...
        // ===== Time Picker Logic =====
        let PRACTITIONER_ID = <?php echo e($activePractitioner->id ?? 'null'); ?>;
        let AVAILABLE_SLOTS = [];
        ...
        async function fetchOffDays() {
            ...
            try {
                const res = await fetch(`<?php echo e(url('/api/off-days')); ?>/${PRACTITIONER_ID}`);
        ...
        async function fetchBookedSlotsForDate(dateStr) {
            ...
            try {
                const res = await fetch(`<?php echo e(url('/api/booked-slots')); ?>/${PRACTITIONER_ID}/${dateStr}`);
                const data = await res.json();
        ...
        const DEFAULT_CURRENCY = "<?php echo e($defaultCurrencyBooking); ?>";
        const CURRENCY_SYMBOLS = <?php echo json_encode(config('currencies.symbols', [])); ?>;
        ...
        async function loadSlotsForDate(dateStr) {
            ...
            if (!PRACTITIONER_ID || !dateStr) return [];
            try {
                const url = `<?php echo e(url('/api/available-slots')); ?>/${PRACTITIONER_ID}/${dateStr}`;
        ...
        <div class="bg-white rounded-[24px] w-full max-w-[800px] relative z-10 scale-95 opacity-0 transition-all duration-300 popup-content"
            ...
            <div>
                        ...
                        <div class="swiper-wrapper">
                            ...
                            <div class="swiper-slide !w-[140px]">
                                <div class="flex flex-col items-center group cursor-pointer text-center practitioner-select-card"
                                    data-id="<?php echo e($practitioner->id); ?>"
                                    data-slug="<?php echo e($practitioner->slug); ?>"
                                    data-name="<?php echo e($pName); ?>"
                                    data-image="<?php echo e($pImage); ?>"
                                    data-role="<?php echo e($pRole); ?>"
                                    data-rating="<?php echo e(number_format($practitioner->average_rating, 1)); ?>"
                                    data-location="<?php echo e($practitioner->city_state); ?>">
                                    <div class="w-[124px] h-[124px] rounded-full overflow-hidden mb-4 relative">
                                        <img src="<?php echo e($pImage); ?>" alt="<?php echo e($pName); ?>"
                                            class="w-full h-full object-cover transition-all duration-300 group-hover:grayscale">
                                    </div>
                                    <h3 class="text-lg font-medium text-[#252525] leading-tight mb-1"><?php echo e($pName); ?></h3>
                                    <p class="text-sm text-[#8B8B8B] font-normal mb-3"><?php echo e($pRole); ?></p>
                                    <a href="<?php echo e($practitioner->slug ? route('practitioner-detail', $practitioner->slug) : '#'); ?>"
                ...
                <div class="border-t border-[#EAEAEA] px-8 py-6 flex justify-end gap-3 mt-4">
                    <button type="button" onclick="closePractitionerModal()"
                        class="px-7 py-2.5 rounded-full border border-transparent bg-white text-gray-700 text-base font-normal hover:bg-gray-50 transition-colors cursor-pointer" data-i18n="Cancel"><?php echo e(__('Cancel')); ?></button>
                    <button type="button" onclick="closePractitionerModal()"
                        class="px-10 py-2.5 rounded-full bg-[#FABD4D] text-[#423131] text-base font-normal hover:bg-[#F5A623] transition-colors border border-transparent cursor-pointer" data-i18n="Save"><?php echo e(__('Save')); ?></button>
                </div>
            </div>
        </div>
    </div>
    ...
    <script src="<?php echo e(asset('frontend/script.js')); ?>"></script>
</body>

</html>
<?php /**PATH C:\wamp64\www\zaya\resources\views\book-session.blade.php ENDPATH**/ ?>