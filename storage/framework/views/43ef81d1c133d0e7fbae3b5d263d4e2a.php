<?php $__env->startSection('title', 'Practitioner Registration'); ?>
                        ...
                        <div class="col-xl-10 col-lg-11">
                            <div class="card shadow-lg border-0 rounded-4">
                                <div class="card-body p-4 p-md-5">
                                    ...
                                    <form method="POST" action="<?php echo e(route('register')); ?>" enctype="multipart/form-data" id="practitionerRegForm" class="theme-form">
                                        <?php echo csrf_field(); ?>
                                                ...
                                                <div class="col-12">
                                                    ...
                                                    <div class="row mb-4">
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="form-check checkbox-primary">
                                                                <input class="form-check-input" type="checkbox" name="consultations[]" value="<?php echo e($item->name); ?>" id="cons_<?php echo e($item->id); ?>">
                                                                <label class="form-check-label" for="cons_<?php echo e($item->id); ?>"><?php echo e($item->name); ?></label>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <div class="col-12 mt-3">
                                                        ...
                                                        <div class="row g-2 mb-4">
                                                            ...
                                                            <div class="col-md-4">
                                                                <div class="form-check checkbox-primary">
                                                                    <input class="form-check-input" type="checkbox" name="body_therapies[]" value="<?php echo e($item->name); ?>" id="bt_<?php echo e($item->id); ?>">
                                                                    <label class="form-check-label" for="bt_<?php echo e($item->id); ?>"><?php echo e($item->name); ?></label>
                                                                </div>
                                                            </div>
                                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                        </div>
                                                        ...
                                                        <div class="col-12 mt-3">
                                                            ...
                                                            <div class="row g-2 mb-4">
                                                                ...
                                                                <div class="col-md-4">
                                                                    <div class="form-check checkbox-primary">
                                                                        <input class="form-check-input" type="checkbox" name="other_modalities[]" value="<?php echo e($item->name); ?>" id="om_<?php echo e($item->id); ?>">
                                                                        <label class="form-check-label" for="om_<?php echo e($item->id); ?>"><?php echo e($item->name); ?></label>
                                                                    </div>
                                                                </div>
                                                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                            </div>
                                                                        ...
                                                                        <div class="language-item mb-2">
                                                                            <div class="input-group">
                                                                                ...
                                                                                <select class="form-select border-end-0" name="languages[]">
                                                                                    ...
                                                                                    <option value="<?php echo e($lang->name); ?>"><?php echo e($lang->flag); ?> <?php echo e($lang->name); ?> (<?php echo e($lang->native_name); ?>)</option>
                                                                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                                                </select>
                                                                                <span class="input-group-text bg-white border-start-0">
                                                                                </span>
...
<script>
    $(document).ready(function() {
        ...
        $(document).on('click', '.add-master-data-btn', function() {
            ...
            let url = "<?php echo e(route('master-data.quick-add', ':type')); ?>";
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.auth', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\wamp64\www\zaya\resources\views\auth\register_practitioner.blade.php ENDPATH**/ ?>