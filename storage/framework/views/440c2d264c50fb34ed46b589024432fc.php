    ...
    <div class="swiper-slide h-auto">
        <div class="group relative">
            ...
            <div class="relative h-[280px] md:h-[360px] xl:h-[400px] overflow-hidden mb-6">
                <img src="<?php echo e($image); ?>" alt="<?php echo e($name); ?>" class="w-full h-full object-cover">
                ...
                <div
                    ...
                    <span
                        class="text-secondary text-sm leading-none font-bold"><?php echo e(number_format($details->average_rating, 1)); ?></span>
                </div>

                <!-- Book Now Button -->
                <div class="absolute bottom-6 left-1/2 -translate-x-1/2 w-max z-10">
                    <a href="<?php echo e(route('book-session', ['practitioner' => $details->slug])); ?>"
                       class="bg-white text-primary px-8 py-2.5 rounded-full font-medium shadow-lg hover:bg-primary hover:text-white transition-all text-sm block">
                        <?php echo e($settings['practitioners_button_text'] ?? 'Book Now'); ?>

                    </a>
                </div>

                <!-- Clickable Overlay for Image -->
                <a href="<?php echo e($details->slug ? route('practitioner-detail', ['slug' => $details->slug]) : '#'); ?>" class="absolute inset-0 z-0"></a>
            </div>

            <!-- Info Section -->
            <div class="text-center">
                <h3 class="text-2xl font-serif font-medium text-primary mb-3 leading-none">
                    <a href="<?php echo e($details->slug ? route('practitioner-detail', ['slug' => $details->slug]) : '#'); ?>" class="hover:text-secondary transition-colors">
                        <?php echo e($name); ?>
                ...
                <div
                    ...
                    <span><?php echo e($details->city ?? 'Zaya'); ?></span>
                </div>
            </div>
        </div>
    </div>
<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
<?php /**PATH C:\wamp64\www\zaya\resources\views/partials/frontend/practitioner-slides.blade.php ENDPATH**/ ?>