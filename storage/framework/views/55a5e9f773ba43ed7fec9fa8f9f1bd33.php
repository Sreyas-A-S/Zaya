<?php $__env->startSection('title', 'Financial Transactions'); ?>
                ...
                <div class="bg-primary b-r-4 card-body">
                    <div class="media static-top-widget">
                        ...
                        <div class="media-body">
                            <span class="m-0">Total Revenue (<?php echo e($balance->currency); ?>)</span>
                            <h4 class="mb-0 counter"><?php echo e(number_format($balance->total_revenue, 2)); ?></h4>
                ...
                <div class="bg-secondary b-r-4 card-body">
                    <div class="media static-top-widget">
                        ...
                        <div class="media-body">
                            ...
                            <h4 class="mb-0 counter"><?php echo e(number_format($balance->total_company, 2)); ?></h4>
                ...
                <div class="bg-success b-r-4 card-body">
                    <div class="media static-top-widget">
                        ...
                        <div class="media-body">
                            ...
                            <h4 class="mb-0 counter"><?php echo e(number_format($balance->total_practitioners, 2)); ?></h4>
                ...
                <div class="bg-warning b-r-4 card-body">
                    <div class="media static-top-widget">
                        ...
                        <div class="media-body">
                            ...
                            <h4 class="mb-0 counter"><?php echo e(number_format($balance->total_referrers, 2)); ?></h4>
...
<script>
    $(document).ready(function() {
        $('#transactions-table').DataTable({
            processing: true,
            serverSide: true,
            ajax: "<?php echo e(route('admin.financial.index')); ?>",
            columns: [
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\wamp64\www\zaya\resources\views\admin\financial\index.blade.php ENDPATH**/ ?>