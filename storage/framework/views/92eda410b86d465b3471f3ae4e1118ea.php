...
<body class="bg-white text-gray-800 antialiased selection:bg-primary selection:text-white">
    ...
    <?php echo $__env->make('partials.frontend.success-popup', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
    ...
    <script src="<?php echo e(asset('frontend/script.js')); ?>?v=<?php echo e(filemtime(public_path('frontend/script.js'))); ?>"></script>
...
<?php /**PATH C:\wamp64\www\zaya\resources\views\layouts\app.blade.php ENDPATH**/ ?>