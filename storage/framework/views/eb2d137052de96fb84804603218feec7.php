...
<div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-10">
    ...
    <div class="md:col-span-2">
        ...
        <textarea name="additional_certifications" rows="3"
            class="w-full py-4 px-6 bg-white rounded-3xl border border-[#D1D5DB] outline-none text-[0.95rem] text-gray-700"><?php echo e(old('additional_certifications')); ?></textarea>
    </div>
</div>
...
<div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-12">
    ...
    <div class="md:col-span-2">
        ...
        <textarea name="coaching_style" rows="3"
            class="w-full py-4 px-6 bg-white rounded-3xl border border-[#D1D5DB] outline-none text-[0.95rem] text-gray-700"><?php echo e(old('coaching_style')); ?></textarea>
    </div>
    <div class="md:col-span-2">
        ...
        <textarea name="target_audience" rows="3"
            class="w-full py-4 px-6 bg-white rounded-3xl border border-[#D1D5DB] outline-none text-[0.95rem] text-gray-700"><?php echo e(old('target_audience')); ?></textarea>
    </div>
</div>
...
<?php /**PATH C:\wamp64\www\zaya\resources\views/team-register/roles/mindfulness.blade.php ENDPATH**/ ?>