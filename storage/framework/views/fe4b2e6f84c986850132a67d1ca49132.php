        ...
        <div class="container mx-auto px-4 py-10 md:py-14">
            <div class="text-center mb-10">
                <div class="flex justify-center mb-6">
                    <a href="<?php echo e(route('index')); ?>" aria-label="Zaya Wellness">
                        <img src="<?php echo e(asset('frontend/assets/zaya-logo.svg')); ?>" alt="Zaya Wellness" class="h-12 md:h-14 w-auto">
                    </a>
                </div>
            ...
            <form action="<?php echo e(route('register')); ?>" method="POST" enctype="multipart/form-data" class="max-w-5xl mx-auto">
                ...
                <?php if(isset($openRegisterToken)): ?>
                    <input type="hidden" name="open_register_token" value="<?php echo e($openRegisterToken); ?>">
                <?php endif; ?>
                ...
                <div class="bg-white rounded-[24px] p-8 md:p-12 border border-gray-100 shadow-sm">
                    ...
                    <div class="flex flex-col md:flex-row mb-10 border-b border-gray-200" id="form-tabs">
                        <button type="button" class="tab-btn active md:w-1/3 py-4 text-center font-medium text-lg text-[#97563D] border-b-2 border-[#97563D]" data-target="tab-personal">1. <?php echo e(__('Personal Details')); ?></button>
                        <button type="button" class="tab-btn md:w-1/3 py-4 text-center font-medium text-lg text-gray-400 hover:text-gray-600 border-b-2 border-transparent transition-colors" data-target="tab-professional">2. <?php echo e(__('Professional Details')); ?></button>
                        <button type="button" class="tab-btn md:w-1/3 py-4 text-center font-medium text-lg text-gray-400 hover:text-gray-600 border-b-2 border-transparent transition-colors" data-target="tab-security">3. <?php echo e(__('Account Security')); ?></button>
                    </div>

                    <!-- Step 1: Personal Details -->
                    <div id="tab-personal" class="tab-content block" style="display: block;">
                        <h2 class="text-xl md:text-2xl font-sans! font-medium text-gray-900 mb-8"><?php echo e(__('Personal Information')); ?></h2>
                        
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
                            <div>
                                <label class="block text-gray-700 font-normal mb-4 text-lg"><?php echo e(__('First Name')); ?> <span class="text-red-500">*</span></label>
                            ...
                            <div>
                                <label class="block text-gray-700 font-normal mb-4 text-lg"><?php echo e(__('Last Name')); ?> <span class="text-red-500">*</span></label>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
                            <div>
                                <label class="block text-gray-700 font-normal mb-4 text-lg"><?php echo e(__('Email')); ?> <span class="text-red-500">*</span></label>
                            ...
                            <div>
                                <?php if(($joinRole ?? '') === 'doctor'): ?>
                                    <label class="block text-gray-700 font-normal mb-4 text-lg"><?php echo e(__('Mobile Number')); ?> <span class="text-red-500">*</span></label>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
                            <div>
                                <label class="block text-gray-700 font-normal mb-4 text-lg"><?php echo e(__('Address Line 1')); ?> <span class="text-red-500">*</span></label>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-12">
                            <div>
                                <label class="block text-gray-700 font-normal mb-4 text-lg"><?php echo e(__('City')); ?> <span class="text-red-500">*</span></label>
                            ...
                            <div>
                                <label class="block text-gray-700 font-normal mb-4 text-lg"><?php echo e(__('State')); ?> <span class="text-red-500">*</span></label>
                            ...
                            <div>
                                <label class="block text-gray-700 font-normal mb-4 text-lg"><?php echo e(__('Zip Code')); ?> <span class="text-red-500">*</span></label>
                            ...
                            <div>
                                <label class="block text-gray-700 font-normal mb-4 text-lg"><?php echo e(__('Country')); ?> <span class="text-red-500">*</span></label>
                            ...
                            <div class="md:col-span-2">
                                <label class="block text-gray-700 font-normal mb-4 text-lg"><?php echo e(__('Payout Currency')); ?> <span class="text-red-500">*</span></label>
                                <?php
                                ...
                                <select name="payout_currency" required
                                    ...
                                    <?php $__currentLoopData = $currencies; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $code => $symbol): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($code); ?>" <?php if(old('payout_currency', 'USD') === $code): echo 'selected'; endif; ?>><?php echo e($code); ?> (<?php echo e($symbol); ?>)</option>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="flex justify-end mt-8 border-t border-gray-100 pt-8">
                            <button type="button" class="next-tab-btn bg-[#FABC41] text-[#423131] py-3.5 px-10 rounded-full font-semibold text-lg transition-all hover:bg-[#E8AA32] shadow-md shadow-[#FABC41]/20"><?php echo e(__('Next Step')); ?> <i class="ri-arrow-right-line ml-2 align-middle"></i></button>
                        </div>
                    </div>
                    ...
                    <div id="tab-professional" class="tab-content hidden" style="display: none;">
                        ...
                        <div class="flex flex-col sm:flex-row justify-between items-center gap-4 mt-8 border-t border-gray-100 pt-8">
                            <button type="button" class="prev-tab-btn w-full sm:w-auto border border-[#D1D5DB] text-gray-700 py-3.5 px-8 rounded-full font-semibold text-lg transition-all hover:bg-gray-50"><i class="ri-arrow-left-line mr-2 align-middle"></i> <?php echo e(__('Previous')); ?></button>
                            <button type="button" class="next-tab-btn w-full sm:w-auto bg-[#FABC41] text-[#423131] py-3.5 px-10 rounded-full font-semibold text-lg transition-all hover:bg-[#E8AA32] shadow-md shadow-[#FABC41]/20"><?php echo e(__('Next Step')); ?> <i class="ri-arrow-right-line ml-2 align-middle"></i></button>
                        </div>
                    </div>
                    ...
                    <div id="tab-security" class="tab-content hidden" style="display: none;">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
                            <div>
                                <label class="block text-gray-700 font-normal mb-4 text-lg"><?php echo e(__('Password')); ?> <span class="text-red-500">*</span></label>
                                <div class="relative">
                            ...
                            <div>
                                <label class="block text-gray-700 font-normal mb-4 text-lg"><?php echo e(__('Confirm Password')); ?> <span class="text-red-500">*</span></label>
                                <div class="relative">
                        ...
                        <?php if(($joinRole ?? '') === 'yoga_therapist'): ?>
                            <div class="mb-10">
                                <label class="block text-gray-800 text-lg font-medium mb-4"><?php echo e(__('Promo Code (Optional)')); ?></label>
                                <input type="text" name="promo_code" value="<?php echo e(old('promo_code')); ?>"
                                    placeholder="<?php echo e(__('Enter promo code')); ?>"
                                    class="reg-input">
                                <p class="text-gray-500 text-sm mt-2"><?php echo e(__('If applicable, this will be applied to your registration fee payment link.')); ?></p>
                            </div>
                        <?php endif; ?>

                        <div class="mb-10">
                            <label class="block text-gray-800 text-lg font-medium mb-4"><?php echo e(__('Captcha Verification')); ?> <span class="text-red-500">*</span></label>
                            <div class="flex items-center gap-3">
                                ...
                                <input type="text" name="captcha" placeholder="<?php echo e(__('Enter Code')); ?>" required class="h-[48px] w-[140px] px-4 bg-white rounded-lg border border-[#D1D5DB] outline-none text-[0.95rem] text-gray-700 focus:border-[#1B5CB8] transition-colors">
                            </div>
                        </div>
                        ...
                        <div class="flex flex-col sm:flex-row justify-between items-center gap-6 mt-8 border-t border-gray-100 pt-8">
                            ...
                            <div class="flex gap-4 items-center w-full sm:w-auto justify-end">
                                <a href="<?php echo e(route('index')); ?>" class="text-gray-500 hover:text-gray-700 font-medium transition-colors hidden sm:block"><?php echo e(__('Cancel')); ?></a>
                                <button type="submit" class="w-full sm:w-auto bg-[#FABC41] text-[#423131] py-4 px-10 rounded-full font-semibold text-lg transition-all hover:bg-[#E8AA32] hover:-translate-y-0.5 shadow-lg shadow-[#FABC41]/20"><?php echo e(__('Complete Application')); ?></button>
                            </div>
                        </div>
                    </div>
            </form>
            ...
            if (phoneInput && window.intlTelInput) {
                const iti = window.intlTelInput(phoneInput, {
                    ...
                    geoIpLookup: function(callback) {
                        fetch("<?php echo e(route('geoip.country')); ?>", { headers: { 'Accept': 'application/json' } })
                            .then(res => res.json())
