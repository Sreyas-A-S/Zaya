...
<div class="container-fluid">
    ...
    <div class="alert alert-success alert-dismissible fade show border-0 shadow-sm" role="alert">
        <i class="fa fa-check-circle me-2"></i> <?php echo e(session('status')); ?>
            ...
            <div class="card h-100 border-0 shadow-sm">
                <div class="card-body text-center p-4">
                    <div class="mb-3 text-center d-flex justify-content-center">
                        <img class="rounded-circle border p-1" src="<?php echo e($user->profile_pic ? '/storage/' . $user->profile_pic : asset('admiro/assets/images/user/user.png')); ?>" alt="profile" style="width: 120px; height: 120px; object-fit: cover;">
                    </div>
                    <h4 class="mb-1 f-w-600"><?php echo e($user->first_name); ?> <?php echo e($user->last_name); ?></h4>
                    <p class="text-muted text-capitalize mb-4"><?php echo e($user->role); ?></p>
                    ...
                    <div class="row g-4">
                        <div class="col-md-6">
                            ...
                            <div class="d-flex align-items-center">
                                ...
                                <span class="f-w-500"><?php echo e($user->email); ?></span>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="d-flex align-items-center">
                                ...
                                <span class="f-w-500"><?php echo e($user->phone ?? 'Not specified'); ?></span>
                            </div>
                        </div>
                        ...
                        <div class="col-12 mt-4">
                            ...
                            <div class="d-flex flex-wrap gap-2">
                                ...
                                <span class="badge badge-light-primary border text-primary px-3 py-2"><?php echo e($lang->name); ?></span>
                                ...
                                <span class="badge border px-3 py-2" style="background-color: #E6F7F2 !important; color: #158763 !important; border-color: #B5E4D4 !important; cursor: default; pointer-events: none; opacity: 1;">All Languages</span>
                                <?php endif; ?>
                            </div>
                        </div>
                    </div>
...
<div class="modal fade" id="editProfileModal" tabindex="-1" aria-labelledby="editProfileModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-lg">
        <div class="modal-content border-0 shadow-lg">
            ...
            <form action="<?php echo e(route('admin.profile.update')); ?>" method="POST" enctype="multipart/form-data" class="needs-validation" id="editProfileForm" novalidate>
                <?php echo csrf_field(); ?>
                        ...
                        <div class="col-md-4 text-center">
                            <div class="avatar-upload">
                                ...
                                <div class="avatar-preview">
                                    <div id="imagePreview" style="background-image: url('<?php echo e($user->profile_pic ? '/storage/' . $user->profile_pic : asset('admiro/assets/images/user/user.png')); ?>');">
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="col-md-8 px-lg-4">
                            <div class="row g-3">
                                <div class="col-md-6">
                                    ...
                                    <input type="text" name="first_name" class="form-control" value="<?php echo e(old('first_name', $user->first_name)); ?>" minlength="1" maxlength="50" required>
                                    <div class="invalid-feedback">Please enter a valid first name (1-50 characters).</div>
                                </div>
                                <div class="col-md-6">
                                    <label class="form-label">Last Name</label>
                                    <input type="text" name="last_name" class="form-control" value="<?php echo e(old('last_name', $user->last_name)); ?>" minlength="1" maxlength="50" required>
                                ...
                                <div class="col-md-12">
                                    ...
                                    <input type="text" name="phone" id="phone" class="form-control" value="<?php echo e(old('phone', $user->phone)); ?>" required data-initial-value="<?php echo e(old('phone', $user->phone)); ?>" inputmode="numeric">
...
<div class="modal fade" id="changePasswordModal" tabindex="-1" aria-labelledby="changePasswordModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content border-0 shadow-lg">
            ...
            <form action="<?php echo e(route('admin.profile.password.update')); ?>" method="POST" class="needs-validation" id="changePasswordForm" novalidate>
                <?php echo csrf_field(); ?>
...
<script>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        <?php if($errors->hasAny(['first_name', 'last_name', 'email', 'phone', 'profile_pic', 'national_id', 'cropped_image'])): ?>
        setTimeout(() => {
            var editProfileModal = new bootstrap.Modal(document.getElementById('editProfileModal'));
            editProfileModal.show();
        }, 500);
        <?php elseif($errors->hasAny(['current_password', 'password', 'password_confirmation'])): ?>
        setTimeout(() => {
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\wamp64\www\zaya\resources\views\admin\profile.blade.php ENDPATH**/ ?>